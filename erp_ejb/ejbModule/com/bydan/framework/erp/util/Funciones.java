...
public class Funciones {	
	...
	public static Hashtable getHashtableEnv() {
		...
		if(Constantes.SVERSION_JBOSS.equals("8.1")) {				     			 	
			hashtableEnv.put(Context.URL_PKG_PREFIXES, "org.jboss.ejb.client.naming");
			hashtableEnv.put("jboss.naming.client.ejb.context", true);
		        			 
		} else if (Constantes.SVERSION_JBOSS.equals("5.1")){
	...
	public static Object validarCampoJson(Object objCampoJson,String strTableName) {
	     ...
	     if(objCampoJson.getClass()==String.class) {
