...
public class Mensaje {
	...
	public static String getMensajeJsonGeneralNoExisteBusqueda(String nombreClase) {
		String jsonMensaje="";
		
		Mensaje mensaje=new Mensaje("noexistencia","Busqueda de "+nombreClase+"s","No existen "+nombreClase+"s en esta busqueda","NONE",MensajeGrupo.APLICACION,MensajeTipo.INFORMACION,true);	
		jsonMensaje=FuncionesJsp.getJsonYahooSimpleMensaje(null, mensaje.getSTitulo(), nombreClase+":"+mensaje.getSMensajeUsuario()+mensaje.getSMensajeTecnico(), true, false, "BLOCK", "OK");
	...
	public static String getMensajeGeneralActualizar(String nombreClase) {
		...
		return mensaje.toNewJsonJmakiMensaje(nombreClase);
	}
	...
	public String toNewJsonJmakiMensaje(){
		String  jsonMensaje = "";
		/*		  
	  	xml.append(mensajeGrupo);		
		xml.append(mensajeTipo);		
		...
		*/
		...
		jsonMensaje=FuncionesJsp.getJsonYahooSimpleMensaje(null, sTitulo, sMensajeUsuario+sMensajeTecnico, true, false, "BLOCK", "OK");
	      
		return jsonMensaje;
	}
	
	public String toNewJsonJmakiMensaje(String strClase){
		String  jsonMensaje = "";
		/*		  
	  	xml.append(mensajeGrupo);		
		xml.append(mensajeTipo);		
		...
		*/
		...
		jsonMensaje=FuncionesJsp.getJsonYahooSimpleMensaje(null, sTitulo, strClase+":"+sMensajeUsuario+sMensajeTecnico, true, false, "BLOCK", "OK");
