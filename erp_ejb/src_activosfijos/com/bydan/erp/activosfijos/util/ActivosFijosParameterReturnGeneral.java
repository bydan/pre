...
public class ActivosFijosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ActivosFijosParameterReturnGeneral () throws Exception {						
		super();
