...
final public class ActivosFijosSqlReporte {	
	public  ActivosFijosSqlReporte()throws Exception {
		...
		if(connexionType.equals(ConnexionType.HIBERNATE)) {
			...
			if(parameterDbType.equals(ParameterDbType.MYSQL)) {
				...
				if(id_tipo_ramo_activo_fijo!= null) {
					...
					sSqlWhere+=" a.id_tipo_ramo_activo_fijo = "+id_tipo_ramo_activo_fijo;
					existeWhere=true;
				}
		...
		if(connexionType.equals(ConnexionType.HIBERNATE)) {
			...
			if(parameterDbType.equals(ParameterDbType.MYSQL)) {
				...
				if(id_anio_inicio!= null) {
					if(existeWhere) {sSqlWhere+=" and ";}
					sSqlWhere+=" d.id_anio between "+id_anio_inicio;
					existeWhere=true;
				}

				if(id_anio_fin!= null) {
					if(existeWhere) {sSqlWhere+=" and ";}
					sSqlWhere+=id_anio_fin;
					existeWhere=true;
				}

				if(id_mes_inicio!= null) {
					if(existeWhere) {sSqlWhere+=" and ";}
					sSqlWhere+=" d.id_mes between "+id_mes_inicio;
					existeWhere=true;
				}

				if(id_mes_fin!= null) {
					if(existeWhere) {sSqlWhere+=" and ";}
					sSqlWhere+=id_mes_fin;
					existeWhere=true;
				}
