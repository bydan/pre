...
public class GastoDepreciacionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public GastoDepreciacionParameterReturnGeneral () throws Exception {						
		super();
