...
public class TipoCalculoDepreciacionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoCalculoDepreciacionParameterReturnGeneral () throws Exception {						
		super();
