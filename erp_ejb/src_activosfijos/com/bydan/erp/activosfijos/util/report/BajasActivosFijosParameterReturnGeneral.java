...
public class BajasActivosFijosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public BajasActivosFijosParameterReturnGeneral () throws Exception {						
		super();
