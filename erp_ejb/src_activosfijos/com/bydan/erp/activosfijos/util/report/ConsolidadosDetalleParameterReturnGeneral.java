...
public class ConsolidadosDetalleParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ConsolidadosDetalleParameterReturnGeneral () throws Exception {						
		super();
