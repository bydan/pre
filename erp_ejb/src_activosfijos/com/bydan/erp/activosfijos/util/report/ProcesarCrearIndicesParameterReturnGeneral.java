...
public class ProcesarCrearIndicesParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProcesarCrearIndicesParameterReturnGeneral () throws Exception {						
		super();
