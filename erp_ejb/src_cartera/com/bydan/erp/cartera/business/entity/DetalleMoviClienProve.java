...
public class DetalleMoviClienProve extends DetalleMoviClienProveAdditional implements Serializable ,Cloneable {//DetalleMoviClienProveAdditional,GeneralEntity
	...
	private DetalleMoviClienProve detallemoviclienproveOriginal;
	
	private Map<String, Object> mapDetalleMoviClienProve;
			
	public Map<String, Object> getMapDetalleMoviClienProve() {
		return mapDetalleMoviClienProve;
	}

	public void setMapDetalleMoviClienProve(Map<String, Object> mapDetalleMoviClienProve) {
		this.mapDetalleMoviClienProve = mapDetalleMoviClienProve;
	}
	
	public void inicializarMapDetalleMoviClienProve() {
		this.mapDetalleMoviClienProve = new HashMap<String,Object>();
	}
	
	public void setMapDetalleMoviClienProveValue(String sKey,Object oValue) {
		this.mapDetalleMoviClienProve.put(sKey, oValue);
	}
	
	public Object getMapDetalleMoviClienProveValue(String sKey) {
		return this.mapDetalleMoviClienProve.get(sKey);
	}
	...
	@Pattern(regex=DetalleMoviClienProveConstantesFunciones.SREGEXNUMERO_FACTURA,message=DetalleMoviClienProveConstantesFunciones.SMENSAJEREGEXNUMERO_FACTURA)
	...
	@Pattern(regex=DetalleMoviClienProveConstantesFunciones.SREGEXDESCRIPCION,message=DetalleMoviClienProveConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	@Pattern(regex=DetalleMoviClienProveConstantesFunciones.SREGEXNUMERO_COMPROBANTE,message=DetalleMoviClienProveConstantesFunciones.SMENSAJEREGEXNUMERO_COMPROBANTE)
	...
	public DetalleMoviClienProve () throws Exception {
		super();		
		...
		this.detallemoviclienproveOriginal=this;
    ...
    //PARA REPORTES
	public DetalleMoviClienProve (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_modulo,Long id_asiento_contable,Date fecha_vence,Long id_cliente,Long id_factura,String numero_factura,Long id_transaccion,Double debito_mone_local,Double credito_mone_local,Double debito_mone_extra,Double credito_mone_extra,Long id_moneda,Double cotizacion,String descripcion,Long id_sucursal_movimiento,Long id_tipo_transaccion_modulo,Long id_estado_detalle_cliente,Date fecha_emision,Double monto_mone_local,Double monto_mone_extra,String numero_comprobante) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public DetalleMoviClienProve (Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_modulo,Long id_asiento_contable,Date fecha_vence,Long id_cliente,Long id_factura,String numero_factura,Long id_transaccion,Double debito_mone_local,Double credito_mone_local,Double debito_mone_extra,Double credito_mone_extra,Long id_moneda,Double cotizacion,String descripcion,Long id_sucursal_movimiento,Long id_tipo_transaccion_modulo,Long id_estado_detalle_cliente,Date fecha_emision,Double monto_mone_local,Double monto_mone_extra,String numero_comprobante) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			detallemoviclienproveLocal=(DetalleMoviClienProve)object;
			
			if(detallemoviclienproveLocal!=null) {
				if(this.getId()!=null && detallemoviclienproveLocal.getId()!=null) {
					if(this.getId().equals(detallemoviclienproveLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!DetalleMoviClienProveConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=DetalleMoviClienProveConstantesFunciones.getDetalleMoviClienProveDescripcion(this);
		} else {
			sDetalle=DetalleMoviClienProveConstantesFunciones.getDetalleMoviClienProveDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public DetalleMoviClienProve getDetalleMoviClienProveOriginal() {
		return this.detallemoviclienproveOriginal;
	}
	
	public void setDetalleMoviClienProveOriginal(DetalleMoviClienProve detallemoviclienprove) {
		try {
			this.detallemoviclienproveOriginal=detallemoviclienprove;
		} catch(Exception e) {
			;
		}
	}
	...
	protected DetalleMoviClienProveAdditional detallemoviclienproveAdditional=null;
	
	public DetalleMoviClienProveAdditional getDetalleMoviClienProveAdditional() {
		return this.detallemoviclienproveAdditional;
	}
	
	public void setDetalleMoviClienProveAdditional(DetalleMoviClienProveAdditional detallemoviclienproveAdditional) {
		try {
			this.detallemoviclienproveAdditional=detallemoviclienproveAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_ejercicio!=newid_ejercicio) {
				if(newid_ejercicio==null) {
					//newid_ejercicio=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_ejercicio");
					}
				}
		...
		try {
			if(this.id_periodo!=newid_periodo) {
				if(newid_periodo==null) {
					//newid_periodo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_periodo");
					}
				}
		...
		try {
			if(this.id_modulo!=newid_modulo) {
				if(newid_modulo==null) {
					//newid_modulo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_modulo");
					}
				}
		...
		try {
			if(this.id_asiento_contable!=newid_asiento_contable) {
				if(newid_asiento_contable==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_asiento_contable");
					}
				}
		...
		try {
			if(this.fecha_vence!=newfecha_vence) {
				if(newfecha_vence==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna fecha_vence");
					}
				}
		...
		try {
			if(this.id_cliente!=newid_cliente) {
				if(newid_cliente==null) {
					//newid_cliente=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_cliente");
					}
				}
		...
		try {
			if(this.numero_factura!=newnumero_factura) {
				if(newnumero_factura==null) {
					//newnumero_factura="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna numero_factura");
					}
				}

				if(newnumero_factura!=null&&newnumero_factura.length()>50) {
					newnumero_factura=newnumero_factura.substring(0,48);
					System.out.println("DetalleMoviClienProve:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_factura");
				}
		...
		try {
			if(this.id_transaccion!=newid_transaccion) {
				if(newid_transaccion==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_transaccion");
					}
				}
		...
		try {
			if(this.debito_mone_local!=newdebito_mone_local) {
				if(newdebito_mone_local==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna debito_mone_local");
					}
				}
		...
		try {
			if(this.credito_mone_local!=newcredito_mone_local) {
				if(newcredito_mone_local==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna credito_mone_local");
					}
				}
		...
		try {
			if(this.debito_mone_extra!=newdebito_mone_extra) {
				if(newdebito_mone_extra==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna debito_mone_extra");
					}
				}
		...
		try {
			if(this.credito_mone_extra!=newcredito_mone_extra) {
				if(newcredito_mone_extra==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna credito_mone_extra");
					}
				}
		...
		try {
			if(this.id_moneda!=newid_moneda) {
				if(newid_moneda==null) {
					//newid_moneda=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_moneda");
					}
				}
		...
		try {
			if(this.cotizacion!=newcotizacion) {
				if(newcotizacion==null) {
					//newcotizacion=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna cotizacion");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>200) {
					newdescripcion=newdescripcion.substring(0,198);
					System.out.println("DetalleMoviClienProve:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=200 en columna descripcion");
				}
		...
		try {
			if(this.id_sucursal_movimiento!=newid_sucursal_movimiento) {
				if(newid_sucursal_movimiento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_sucursal_movimiento");
					}
				}
		...
		try {
			if(this.id_estado_detalle_cliente!=newid_estado_detalle_cliente) {
				if(newid_estado_detalle_cliente==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna id_estado_detalle_cliente");
					}
				}
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.monto_mone_local!=newmonto_mone_local) {
				if(newmonto_mone_local==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna monto_mone_local");
					}
				}
		...
		try {
			if(this.monto_mone_extra!=newmonto_mone_extra) {
				if(newmonto_mone_extra==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna monto_mone_extra");
					}
				}
		...
		try {
			if(this.numero_comprobante!=newnumero_comprobante) {
				if(newnumero_comprobante==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleMoviClienProve:Valor nulo no permitido en columna numero_comprobante");
					}
				}

				if(newnumero_comprobante!=null&&newnumero_comprobante.length()>50) {
					newnumero_comprobante=newnumero_comprobante.substring(0,48);
					System.out.println("DetalleMoviClienProve:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_comprobante");
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_sucursal_descripcion="";String id_ejercicio_descripcion="";String id_periodo_descripcion="";String id_anio_descripcion="";String id_mes_descripcion="";String id_modulo_descripcion="";String id_asiento_contable_descripcion="";String id_cliente_descripcion="";String id_factura_descripcion="";String id_transaccion_descripcion="";String id_moneda_descripcion="";String id_sucursal_movimiento_descripcion="";String id_tipo_transaccion_modulo_descripcion="";String id_estado_detalle_cliente_descripcion="";
