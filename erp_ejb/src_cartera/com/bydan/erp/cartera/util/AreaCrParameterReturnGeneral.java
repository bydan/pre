...
public class AreaCrParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public AreaCrParameterReturnGeneral () throws Exception {						
		super();
