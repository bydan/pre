...
public class BalanceGeneralClienteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public BalanceGeneralClienteParameterReturnGeneral () throws Exception {						
		super();
