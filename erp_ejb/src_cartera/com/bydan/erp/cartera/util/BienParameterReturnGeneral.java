...
public class BienParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public BienParameterReturnGeneral () throws Exception {						
		super();
	...
	public List<TipoBien> gettipobiensForeignKey() {
		return this.tipobiensForeignKey;
	}
