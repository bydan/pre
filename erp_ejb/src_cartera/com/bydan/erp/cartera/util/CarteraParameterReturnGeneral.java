...
public class CarteraParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CarteraParameterReturnGeneral () throws Exception {						
		super();
