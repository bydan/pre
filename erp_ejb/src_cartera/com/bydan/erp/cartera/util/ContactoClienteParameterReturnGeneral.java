...
public class ContactoClienteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ContactoClienteParameterReturnGeneral () throws Exception {						
		super();
