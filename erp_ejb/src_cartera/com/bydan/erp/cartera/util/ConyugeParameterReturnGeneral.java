...
public class ConyugeParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ConyugeParameterReturnGeneral () throws Exception {						
		super();
