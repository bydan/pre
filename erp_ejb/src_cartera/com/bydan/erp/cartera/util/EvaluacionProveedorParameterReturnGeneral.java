...
public class EvaluacionProveedorParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EvaluacionProveedorParameterReturnGeneral () throws Exception {						
		super();
