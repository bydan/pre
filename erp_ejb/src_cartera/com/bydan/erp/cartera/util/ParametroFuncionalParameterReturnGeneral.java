...
public class ParametroFuncionalParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ParametroFuncionalParameterReturnGeneral () throws Exception {						
		super();
