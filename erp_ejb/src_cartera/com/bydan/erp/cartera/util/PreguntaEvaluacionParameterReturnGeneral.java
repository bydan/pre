...
public class PreguntaEvaluacionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PreguntaEvaluacionParameterReturnGeneral () throws Exception {						
		super();
