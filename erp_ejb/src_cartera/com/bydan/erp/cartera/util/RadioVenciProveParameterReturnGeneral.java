...
public class RadioVenciProveParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public RadioVenciProveParameterReturnGeneral () throws Exception {						
		super();
