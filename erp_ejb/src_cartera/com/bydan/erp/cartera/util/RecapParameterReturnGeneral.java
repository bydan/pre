...
public class RecapParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public RecapParameterReturnGeneral () throws Exception {						
		super();
