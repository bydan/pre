...
public class RutaTransporteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public RutaTransporteParameterReturnGeneral () throws Exception {						
		super();
