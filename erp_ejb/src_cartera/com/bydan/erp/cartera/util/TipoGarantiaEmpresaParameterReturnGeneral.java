...
public class TipoGarantiaEmpresaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoGarantiaEmpresaParameterReturnGeneral () throws Exception {						
		super();
