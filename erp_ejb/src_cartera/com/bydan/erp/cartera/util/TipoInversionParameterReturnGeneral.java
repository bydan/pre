...
public class TipoInversionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoInversionParameterReturnGeneral () throws Exception {						
		super();
