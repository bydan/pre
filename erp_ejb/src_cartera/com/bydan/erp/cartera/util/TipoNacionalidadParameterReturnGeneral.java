...
public class TipoNacionalidadParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoNacionalidadParameterReturnGeneral () throws Exception {						
		super();
