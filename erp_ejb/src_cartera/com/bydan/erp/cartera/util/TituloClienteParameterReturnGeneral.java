...
public class TituloClienteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TituloClienteParameterReturnGeneral () throws Exception {						
		super();
