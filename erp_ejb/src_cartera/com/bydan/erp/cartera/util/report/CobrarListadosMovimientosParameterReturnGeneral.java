...
public class CobrarListadosMovimientosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CobrarListadosMovimientosParameterReturnGeneral () throws Exception {						
		super();
