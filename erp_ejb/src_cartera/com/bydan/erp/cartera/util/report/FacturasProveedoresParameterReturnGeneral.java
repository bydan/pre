...
public class FacturasProveedoresParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public FacturasProveedoresParameterReturnGeneral () throws Exception {						
		super();
