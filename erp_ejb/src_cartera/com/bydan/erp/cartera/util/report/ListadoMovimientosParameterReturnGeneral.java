...
public class ListadoMovimientosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ListadoMovimientosParameterReturnGeneral () throws Exception {						
		super();
