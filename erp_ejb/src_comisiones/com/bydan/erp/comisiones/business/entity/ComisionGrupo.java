...
public class ComisionGrupo extends ComisionGrupoAdditional implements Serializable ,Cloneable {//ComisionGrupoAdditional,GeneralEntity
	...
	private ComisionGrupo comisiongrupoOriginal;
	
	private Map<String, Object> mapComisionGrupo;
			
	public Map<String, Object> getMapComisionGrupo() {
		return mapComisionGrupo;
	}

	public void setMapComisionGrupo(Map<String, Object> mapComisionGrupo) {
		this.mapComisionGrupo = mapComisionGrupo;
	}
	
	public void inicializarMapComisionGrupo() {
		this.mapComisionGrupo = new HashMap<String,Object>();
	}
	
	public void setMapComisionGrupoValue(String sKey,Object oValue) {
		this.mapComisionGrupo.put(sKey, oValue);
	}
	
	public Object getMapComisionGrupoValue(String sKey) {
		return this.mapComisionGrupo.get(sKey);
	}
	...
	@Pattern(regex=ComisionGrupoConstantesFunciones.SREGEXDESCRIPCION,message=ComisionGrupoConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	public ComisionGrupo () throws Exception {
		super();		
		...
		this.comisiongrupoOriginal=this;
    ...
    //PARA REPORTES
	public ComisionGrupo (Long id,Date versionRow,Long id_empresa,Long id_comision_config,Long id_vendedor,Long id_linea,Long id_linea_grupo,Long id_estado_comision,Double porcentaje,String descripcion) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ComisionGrupo (Long id_empresa,Long id_comision_config,Long id_vendedor,Long id_linea,Long id_linea_grupo,Long id_estado_comision,Double porcentaje,String descripcion) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			comisiongrupoLocal=(ComisionGrupo)object;
			
			if(comisiongrupoLocal!=null) {
				if(this.getId()!=null && comisiongrupoLocal.getId()!=null) {
					if(this.getId().equals(comisiongrupoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!ComisionGrupoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=ComisionGrupoConstantesFunciones.getComisionGrupoDescripcion(this);
		} else {
			sDetalle=ComisionGrupoConstantesFunciones.getComisionGrupoDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public ComisionGrupo getComisionGrupoOriginal() {
		return this.comisiongrupoOriginal;
	}
	
	public void setComisionGrupoOriginal(ComisionGrupo comisiongrupo) {
		try {
			this.comisiongrupoOriginal=comisiongrupo;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ComisionGrupoAdditional comisiongrupoAdditional=null;
	
	public ComisionGrupoAdditional getComisionGrupoAdditional() {
		return this.comisiongrupoAdditional;
	}
	
	public void setComisionGrupoAdditional(ComisionGrupoAdditional comisiongrupoAdditional) {
		try {
			this.comisiongrupoAdditional=comisiongrupoAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_comision_config!=newid_comision_config) {
				if(newid_comision_config==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id_comision_config");
					}
				}
		...
		try {
			if(this.id_vendedor!=newid_vendedor) {
				if(newid_vendedor==null) {
					//newid_vendedor=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id_vendedor");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_estado_comision!=newid_estado_comision) {
				if(newid_estado_comision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna id_estado_comision");
					}
				}
		...
		try {
			if(this.porcentaje!=newporcentaje) {
				if(newporcentaje==null) {
					//newporcentaje=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna porcentaje");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionGrupo:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>100) {
					newdescripcion=newdescripcion.substring(0,98);
					System.out.println("ComisionGrupo:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna descripcion");
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_comision_config_descripcion="";String id_vendedor_descripcion="";String id_linea_descripcion="";String id_linea_grupo_descripcion="";String id_estado_comision_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_comision_config_descripcion="";this.id_vendedor_descripcion="";this.id_linea_descripcion="";this.id_linea_grupo_descripcion="";this.id_estado_comision_descripcion="";
	}
