...
public class ComisionMarca extends ComisionMarcaAdditional implements Serializable ,Cloneable {//ComisionMarcaAdditional,GeneralEntity
	...
	private ComisionMarca comisionmarcaOriginal;
	
	private Map<String, Object> mapComisionMarca;
			
	public Map<String, Object> getMapComisionMarca() {
		return mapComisionMarca;
	}

	public void setMapComisionMarca(Map<String, Object> mapComisionMarca) {
		this.mapComisionMarca = mapComisionMarca;
	}
	
	public void inicializarMapComisionMarca() {
		this.mapComisionMarca = new HashMap<String,Object>();
	}
	
	public void setMapComisionMarcaValue(String sKey,Object oValue) {
		this.mapComisionMarca.put(sKey, oValue);
	}
	
	public Object getMapComisionMarcaValue(String sKey) {
		return this.mapComisionMarca.get(sKey);
	}
	...
	@Pattern(regex=ComisionMarcaConstantesFunciones.SREGEXDESCRIPCION,message=ComisionMarcaConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	public ComisionMarca () throws Exception {
		super();		
		...
		this.comisionmarcaOriginal=this;
    ...
    //PARA REPORTES
	public ComisionMarca (Long id,Date versionRow,Long id_empresa,Long id_comision_config,Long id_vendedor,Long id_linea,Long id_linea_grupo,Long id_linea_categoria,Long id_linea_marca,Long id_estado_comision,Double porcentaje,String descripcion) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ComisionMarca (Long id_empresa,Long id_comision_config,Long id_vendedor,Long id_linea,Long id_linea_grupo,Long id_linea_categoria,Long id_linea_marca,Long id_estado_comision,Double porcentaje,String descripcion) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			comisionmarcaLocal=(ComisionMarca)object;
			
			if(comisionmarcaLocal!=null) {
				if(this.getId()!=null && comisionmarcaLocal.getId()!=null) {
					if(this.getId().equals(comisionmarcaLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!ComisionMarcaConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=ComisionMarcaConstantesFunciones.getComisionMarcaDescripcion(this);
		} else {
			sDetalle=ComisionMarcaConstantesFunciones.getComisionMarcaDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public ComisionMarca getComisionMarcaOriginal() {
		return this.comisionmarcaOriginal;
	}
	
	public void setComisionMarcaOriginal(ComisionMarca comisionmarca) {
		try {
			this.comisionmarcaOriginal=comisionmarca;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ComisionMarcaAdditional comisionmarcaAdditional=null;
	
	public ComisionMarcaAdditional getComisionMarcaAdditional() {
		return this.comisionmarcaAdditional;
	}
	
	public void setComisionMarcaAdditional(ComisionMarcaAdditional comisionmarcaAdditional) {
		try {
			this.comisionmarcaAdditional=comisionmarcaAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.porcentaje!=newporcentaje) {
				if(newporcentaje==null) {
					//newporcentaje=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionMarca:Valor nulo no permitido en columna porcentaje");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ComisionMarca:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>100) {
					newdescripcion=newdescripcion.substring(0,98);
					System.out.println("ComisionMarca:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna descripcion");
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_comision_config_descripcion="";String id_vendedor_descripcion="";String id_linea_descripcion="";String id_linea_grupo_descripcion="";String id_linea_categoria_descripcion="";String id_linea_marca_descripcion="";String id_estado_comision_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_comision_config_descripcion="";this.id_vendedor_descripcion="";this.id_linea_descripcion="";this.id_linea_grupo_descripcion="";this.id_linea_categoria_descripcion="";this.id_linea_marca_descripcion="";this.id_estado_comision_descripcion="";
	}
