...
public class ComisionConfigParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ComisionConfigParameterReturnGeneral () throws Exception {						
		super();
	...
	public List<TipoComisionConfig> gettipocomisionconfigsForeignKey() {
		return this.tipocomisionconfigsForeignKey;
	}
