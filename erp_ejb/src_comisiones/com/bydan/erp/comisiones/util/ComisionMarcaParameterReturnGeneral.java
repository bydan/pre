...
public class ComisionMarcaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ComisionMarcaParameterReturnGeneral () throws Exception {						
		super();
