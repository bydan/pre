...
public class EstadoComisionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoComisionParameterReturnGeneral () throws Exception {						
		super();
