...
public class ReporteTest extends ReporteTestAdditional implements Serializable ,Cloneable {//ReporteTestAdditional,GeneralEntity
	...
	private ReporteTest reportetestOriginal;
	
	private Map<String, Object> mapReporteTest;
			
	public Map<String, Object> getMapReporteTest() {
		return mapReporteTest;
	}

	public void setMapReporteTest(Map<String, Object> mapReporteTest) {
		this.mapReporteTest = mapReporteTest;
	}
	
	public void inicializarMapReporteTest() {
		this.mapReporteTest = new HashMap<String,Object>();
	}
	
	public void setMapReporteTestValue(String sKey,Object oValue) {
		this.mapReporteTest.put(sKey, oValue);
	}
	
	public Object getMapReporteTestValue(String sKey) {
		return this.mapReporteTest.get(sKey);
	}
	...
	//@Pattern(regex=ReporteTestConstantesFunciones.SREGEXNOMBRE,message=ReporteTestConstantesFunciones.SMENSAJEREGEXNOMBRE)
	private String nombre;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=100,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ReporteTestConstantesFunciones.SREGEXUBICACION,message=ReporteTestConstantesFunciones.SMENSAJEREGEXUBICACION)
	...
	public ReporteTest () throws Exception {
		super();		
    ...
    //PARA REPORTES
	public ReporteTest (Long id,Date versionRow,Long id_tipo_movimiento,String nombre,String ubicacion) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ReporteTest (Long id_tipo_movimiento,String nombre,String ubicacion) throws Exception {
		super();		
	...
	public ReporteTest getReporteTestOriginal() {
		return this.reportetestOriginal;
	}
	
	public void setReporteTestOriginal(ReporteTest reportetest) {
		try {
			this.reportetestOriginal=reportetest;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ReporteTestAdditional reportetestAdditional=null;
	
	public ReporteTestAdditional getReporteTestAdditional() {
		return this.reportetestAdditional;
	}
	
	public void setReporteTestAdditional(ReporteTestAdditional reportetestAdditional) {
		try {
			this.reportetestAdditional=reportetestAdditional;
		} catch(Exception e) {
			;
		}
	}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_modulo_descripcion="";String id_tipo_movimiento_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_modulo_descripcion="";this.id_tipo_movimiento_descripcion="";
	}
