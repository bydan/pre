...
public class ContabilidadParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ContabilidadParameterReturnGeneral () throws Exception {						
		super();
