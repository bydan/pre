...
public class DetalleFacturaProveedorParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public DetalleFacturaProveedorParameterReturnGeneral () throws Exception {						
		super();
