...
public class EjercicioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EjercicioParameterReturnGeneral () throws Exception {						
		super();
