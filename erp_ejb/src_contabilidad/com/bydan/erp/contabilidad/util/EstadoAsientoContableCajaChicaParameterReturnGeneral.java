...
public class EstadoAsientoContableCajaChicaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoAsientoContableCajaChicaParameterReturnGeneral () throws Exception {						
		super();
