...
public class MonedaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public MonedaParameterReturnGeneral () throws Exception {						
		super();
