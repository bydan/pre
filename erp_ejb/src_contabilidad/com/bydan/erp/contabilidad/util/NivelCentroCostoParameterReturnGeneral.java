...
public class NivelCentroCostoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public NivelCentroCostoParameterReturnGeneral () throws Exception {						
		super();
