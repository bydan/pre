...
public class NivelCuentaContableParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public NivelCuentaContableParameterReturnGeneral () throws Exception {						
		super();
