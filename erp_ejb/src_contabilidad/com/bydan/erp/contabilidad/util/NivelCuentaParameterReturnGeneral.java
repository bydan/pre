...
public class NivelCuentaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public NivelCuentaParameterReturnGeneral () throws Exception {						
		super();
