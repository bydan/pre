...
public class ResponsableFondoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ResponsableFondoParameterReturnGeneral () throws Exception {						
		super();
