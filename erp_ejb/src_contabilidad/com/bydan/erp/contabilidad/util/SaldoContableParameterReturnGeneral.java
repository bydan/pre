...
public class SaldoContableParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public SaldoContableParameterReturnGeneral () throws Exception {						
		super();
