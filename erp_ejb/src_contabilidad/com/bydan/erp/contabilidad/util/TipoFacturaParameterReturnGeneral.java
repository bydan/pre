...
public class TipoFacturaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoFacturaParameterReturnGeneral () throws Exception {						
		super();
