...
public class TipoParametroFormularioIvaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoParametroFormularioIvaParameterReturnGeneral () throws Exception {						
		super();
