...
public class TipoRetencionIvaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoRetencionIvaParameterReturnGeneral () throws Exception {						
		super();
