...
public class TransaccionContaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TransaccionContaParameterReturnGeneral () throws Exception {						
		super();
