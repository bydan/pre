...
public class DetalleConsignacion extends DetalleConsignacionAdditional implements Serializable ,Cloneable {//DetalleConsignacionAdditional,GeneralEntity
	...
	private DetalleConsignacion detalleconsignacionOriginal;
	
	private Map<String, Object> mapDetalleConsignacion;
			
	public Map<String, Object> getMapDetalleConsignacion() {
		return mapDetalleConsignacion;
	}

	public void setMapDetalleConsignacion(Map<String, Object> mapDetalleConsignacion) {
		this.mapDetalleConsignacion = mapDetalleConsignacion;
	}
	
	public void inicializarMapDetalleConsignacion() {
		this.mapDetalleConsignacion = new HashMap<String,Object>();
	}
	
	public void setMapDetalleConsignacionValue(String sKey,Object oValue) {
		this.mapDetalleConsignacion.put(sKey, oValue);
	}
	
	public Object getMapDetalleConsignacionValue(String sKey) {
		return this.mapDetalleConsignacion.get(sKey);
	}
	...
	private String consignacion_descripcion;
	...
	public DetalleConsignacion () throws Exception {
		super();		
		...
		this.detalleconsignacionOriginal=this;
    ...
    //PARA REPORTES
	public DetalleConsignacion (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_consignacion,Long id_producto,Long id_bodega,Long id_unidad,Long id_estado_detalle_pedido,Integer cantidad,Double precio,Double descuento_porcentaje,Double descuento_valor,Double iva,Double total,Double ice,Double costo,Double utilidad) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public DetalleConsignacion (Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_consignacion,Long id_producto,Long id_bodega,Long id_unidad,Long id_estado_detalle_pedido,Integer cantidad,Double precio,Double descuento_porcentaje,Double descuento_valor,Double iva,Double total,Double ice,Double costo,Double utilidad) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			detalleconsignacionLocal=(DetalleConsignacion)object;
			
			if(detalleconsignacionLocal!=null) {
				if(this.getId()!=null && detalleconsignacionLocal.getId()!=null) {
					if(this.getId().equals(detalleconsignacionLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!DetalleConsignacionConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=DetalleConsignacionConstantesFunciones.getDetalleConsignacionDescripcion(this);
		} else {
			sDetalle=DetalleConsignacionConstantesFunciones.getDetalleConsignacionDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public DetalleConsignacion getDetalleConsignacionOriginal() {
		return this.detalleconsignacionOriginal;
	}
	
	public void setDetalleConsignacionOriginal(DetalleConsignacion detalleconsignacion) {
		try {
			this.detalleconsignacionOriginal=detalleconsignacion;
		} catch(Exception e) {
			;
		}
	}
	...
	protected DetalleConsignacionAdditional detalleconsignacionAdditional=null;
	
	public DetalleConsignacionAdditional getDetalleConsignacionAdditional() {
		return this.detalleconsignacionAdditional;
	}
	
	public void setDetalleConsignacionAdditional(DetalleConsignacionAdditional detalleconsignacionAdditional) {
		try {
			this.detalleconsignacionAdditional=detalleconsignacionAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.cantidad!=newcantidad) {
				if(newcantidad==null) {
					//newcantidad=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna cantidad");
					}
				}
		...
		try {
			if(this.precio!=newprecio) {
				if(newprecio==null) {
					//newprecio=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna precio");
					}
				}
		...
		try {
			if(this.descuento_porcentaje!=newdescuento_porcentaje) {
				if(newdescuento_porcentaje==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna descuento_porcentaje");
					}
				}
		...
		try {
			if(this.descuento_valor!=newdescuento_valor) {
				if(newdescuento_valor==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna descuento_valor");
					}
				}
		...
		try {
			if(this.iva!=newiva) {
				if(newiva==null) {
					//newiva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna iva");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna total");
					}
				}
		...
		try {
			if(this.ice!=newice) {
				if(newice==null) {
					//newice=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna ice");
					}
				}
		...
		try {
			if(this.costo!=newcosto) {
				if(newcosto==null) {
					//newcosto=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna costo");
					}
				}
		...
		try {
			if(this.utilidad!=newutilidad) {
				if(newutilidad==null) {
					//newutilidad=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleConsignacion:Valor nulo no permitido en columna utilidad");
					}
				}
	...
	public String getconsignacion_descripcion() {
		return this.consignacion_descripcion;
	}
	...
	public  void  setconsignacion_descripcion(String consignacion_descripcion) {
		try {
			this.consignacion_descripcion=consignacion_descripcion;
		} catch(Exception e) {
			;
		}
	}
	...
	public String getid_consignacion_descripcion() {
		return id_consignacion_descripcion;
	}
	...
	public void setid_consignacion_descripcion(String newid_consignacion_descripcion)throws Exception {
		try {
