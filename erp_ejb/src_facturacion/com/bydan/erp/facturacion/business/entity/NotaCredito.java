...
public class NotaCredito extends NotaCreditoAdditional implements Serializable ,Cloneable {//NotaCreditoAdditional,GeneralEntity
	...
	private NotaCredito notacreditoOriginal;
	
	private Map<String, Object> mapNotaCredito;
			
	public Map<String, Object> getMapNotaCredito() {
		return mapNotaCredito;
	}

	public void setMapNotaCredito(Map<String, Object> mapNotaCredito) {
		this.mapNotaCredito = mapNotaCredito;
	}
	
	public void inicializarMapNotaCredito() {
		this.mapNotaCredito = new HashMap<String,Object>();
	}
	
	public void setMapNotaCreditoValue(String sKey,Object oValue) {
		this.mapNotaCredito.put(sKey, oValue);
	}
	
	public Object getMapNotaCreditoValue(String sKey) {
		return this.mapNotaCredito.get(sKey);
	}
	...
	@Pattern(regex=NotaCreditoConstantesFunciones.SREGEXCODIGO,message=NotaCreditoConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=NotaCreditoConstantesFunciones.SREGEXNUMERO,message=NotaCreditoConstantesFunciones.SMENSAJEREGEXNUMERO)
	...
	@Pattern(regex=NotaCreditoConstantesFunciones.SREGEXDIRECCION,message=NotaCreditoConstantesFunciones.SMENSAJEREGEXDIRECCION)
	private String direccion;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=NotaCreditoConstantesFunciones.SREGEXTELEFONO,message=NotaCreditoConstantesFunciones.SMENSAJEREGEXTELEFONO)
	private String telefono;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=20,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=NotaCreditoConstantesFunciones.SREGEXRUC,message=NotaCreditoConstantesFunciones.SMENSAJEREGEXRUC)
	private String ruc;
	...
	@Pattern(regex=NotaCreditoConstantesFunciones.SREGEXDESCRIPCION,message=NotaCreditoConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	private String estadonotacredito_descripcion;
	...
	public NotaCredito () throws Exception {
		super();		
		...
		this.estadonotacredito_descripcion="";
    ...
    //PARA REPORTES
	public NotaCredito (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_usuario,String codigo,String numero,Date fecha_emision,Integer numero_dias,Date fecha_vencimiento,Long id_moneda,Double cotizacion,Long id_empleado,Long id_formato,Long id_tipo_precio,Long id_cliente,Long id_factura,String direccion,String telefono,String ruc,Long id_vendedor,Long id_responsable,Long id_estado_nota_credito,String descripcion,Double descuento_porcentaje,Double total_iva,Double suman,Double descuento_valor,Double total_sin_iva,Double total_descuento,Double flete,Double total,Double sub_total,Double otro,Double iva,Double financiamiento,Double ice,Double otro_valor,Double retencion,Date fecha,Boolean es_cliente,Long id_centro_costo,Long id_tipo_cambio,Long id_transporte,Long id_transportista,Date fecha_cliente,Date fecha_autorizacion) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public NotaCredito (Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_usuario,String codigo,String numero,Date fecha_emision,Integer numero_dias,Date fecha_vencimiento,Long id_moneda,Double cotizacion,Long id_empleado,Long id_formato,Long id_tipo_precio,Long id_cliente,Long id_factura,String direccion,String telefono,String ruc,Long id_vendedor,Long id_responsable,Long id_estado_nota_credito,String descripcion,Double descuento_porcentaje,Double total_iva,Double suman,Double descuento_valor,Double total_sin_iva,Double total_descuento,Double flete,Double total,Double sub_total,Double otro,Double iva,Double financiamiento,Double ice,Double otro_valor,Double retencion,Date fecha,Boolean es_cliente,Long id_centro_costo,Long id_tipo_cambio,Long id_transporte,Long id_transportista,Date fecha_cliente,Date fecha_autorizacion) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			notacreditoLocal=(NotaCredito)object;
			
			if(notacreditoLocal!=null) {
				if(this.getId()!=null && notacreditoLocal.getId()!=null) {
					if(this.getId().equals(notacreditoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!NotaCreditoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=NotaCreditoConstantesFunciones.getNotaCreditoDescripcion(this);
		} else {
			sDetalle=NotaCreditoConstantesFunciones.getNotaCreditoDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public NotaCredito getNotaCreditoOriginal() {
		return this.notacreditoOriginal;
	}
	
	public void setNotaCreditoOriginal(NotaCredito notacredito) {
		try {
			this.notacreditoOriginal=notacredito;
		} catch(Exception e) {
			;
		}
	}
	...
	protected NotaCreditoAdditional notacreditoAdditional=null;
	
	public NotaCreditoAdditional getNotaCreditoAdditional() {
		return this.notacreditoAdditional;
	}
	
	public void setNotaCreditoAdditional(NotaCreditoAdditional notacreditoAdditional) {
		try {
			this.notacreditoAdditional=notacreditoAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_ejercicio!=newid_ejercicio) {
				if(newid_ejercicio==null) {
					//newid_ejercicio=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_ejercicio");
					}
				}
		...
		try {
			if(this.id_periodo!=newid_periodo) {
				if(newid_periodo==null) {
					//newid_periodo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_periodo");
					}
				}
		...
		try {
			if(this.id_usuario!=newid_usuario) {
				if(newid_usuario==null) {
					//newid_usuario=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_usuario");
					}
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("NotaCredito:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
		...
		try {
			if(this.numero!=newnumero) {
				if(newnumero==null) {
					//newnumero="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna numero");
					}
				}

				if(newnumero!=null&&newnumero.length()>50) {
					newnumero=newnumero.substring(0,48);
					System.out.println("NotaCredito:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero");
				}
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.numero_dias!=newnumero_dias) {
				if(newnumero_dias==null) {
					//newnumero_dias=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna numero_dias");
					}
				}
		...
		try {
			if(this.fecha_vencimiento!=newfecha_vencimiento) {
				if(newfecha_vencimiento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna fecha_vencimiento");
					}
				}
		...
		try {
			if(this.id_moneda!=newid_moneda) {
				if(newid_moneda==null) {
					//newid_moneda=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_moneda");
					}
				}
		...
		try {
			if(this.cotizacion!=newcotizacion) {
				if(newcotizacion==null) {
					//newcotizacion=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna cotizacion");
					}
				}
		...
		try {
			if(this.id_empleado!=newid_empleado) {
				if(newid_empleado==null) {
					//newid_empleado=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_empleado");
					}
				}
		...
		try {
			if(this.id_tipo_precio!=newid_tipo_precio) {
				if(newid_tipo_precio==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_tipo_precio");
					}
				}
		...
		try {
			if(this.id_cliente!=newid_cliente) {
				if(newid_cliente==null) {
					//newid_cliente=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_cliente");
					}
				}
		...
		try {
			if(this.id_factura!=newid_factura) {
				if(newid_factura==null) {
					//newid_factura=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_factura");
					}
				}
		...
		try {
			if(this.direccion!=newdireccion) {
				if(newdireccion==null) {
					//newdireccion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna direccion");
					}
				}

				if(newdireccion!=null&&newdireccion.length()>150) {
					newdireccion=newdireccion.substring(0,148);
					System.out.println("NotaCredito:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna direccion");
				}
		...
		try {
			if(this.telefono!=newtelefono) {
				if(newtelefono==null) {
					//newtelefono="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna telefono");
					}
				}

				if(newtelefono!=null&&newtelefono.length()>50) {
					newtelefono=newtelefono.substring(0,48);
					System.out.println("NotaCredito:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna telefono");
				}
		...
		try {
			if(this.ruc!=newruc) {
				if(newruc==null) {
					//newruc="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna ruc");
					}
				}

				if(newruc!=null&&newruc.length()>20) {
					newruc=newruc.substring(0,18);
					System.out.println("NotaCredito:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna ruc");
				}
		...
		try {
			if(this.id_responsable!=newid_responsable) {
				if(newid_responsable==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_responsable");
					}
				}
		...
		try {
			if(this.id_estado_nota_credito!=newid_estado_nota_credito) {
				if(newid_estado_nota_credito==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna id_estado_nota_credito");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>100) {
					newdescripcion=newdescripcion.substring(0,98);
					System.out.println("NotaCredito:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna descripcion");
				}
		...
		try {
			if(this.descuento_porcentaje!=newdescuento_porcentaje) {
				if(newdescuento_porcentaje==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna descuento_porcentaje");
					}
				}
		...
		try {
			if(this.total_iva!=newtotal_iva) {
				if(newtotal_iva==null) {
					//newtotal_iva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna total_iva");
					}
				}
		...
		try {
			if(this.suman!=newsuman) {
				if(newsuman==null) {
					//newsuman=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna suman");
					}
				}
		...
		try {
			if(this.descuento_valor!=newdescuento_valor) {
				if(newdescuento_valor==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna descuento_valor");
					}
				}
		...
		try {
			if(this.total_sin_iva!=newtotal_sin_iva) {
				if(newtotal_sin_iva==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna total_sin_iva");
					}
				}
		...
		try {
			if(this.total_descuento!=newtotal_descuento) {
				if(newtotal_descuento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna total_descuento");
					}
				}
		...
		try {
			if(this.flete!=newflete) {
				if(newflete==null) {
					//newflete=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna flete");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna total");
					}
				}
		...
		try {
			if(this.sub_total!=newsub_total) {
				if(newsub_total==null) {
					//newsub_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna sub_total");
					}
				}
		...
		try {
			if(this.otro!=newotro) {
				if(newotro==null) {
					//newotro=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna otro");
					}
				}
		...
		try {
			if(this.iva!=newiva) {
				if(newiva==null) {
					//newiva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna iva");
					}
				}
		...
		try {
			if(this.financiamiento!=newfinanciamiento) {
				if(newfinanciamiento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna financiamiento");
					}
				}
		...
		try {
			if(this.ice!=newice) {
				if(newice==null) {
					//newice=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna ice");
					}
				}
		...
		try {
			if(this.otro_valor!=newotro_valor) {
				if(newotro_valor==null) {
					//newotro_valor=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna otro_valor");
					}
				}
		...
		try {
			if(this.retencion!=newretencion) {
				if(newretencion==null) {
					//newretencion=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna retencion");
					}
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna fecha");
					}
				}
		...
		try {
			if(this.es_cliente!=newes_cliente) {
				if(newes_cliente==null) {
					//newes_cliente=false;
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna es_cliente");
					}
				}
		...
		try {
			if(this.fecha_cliente!=newfecha_cliente) {
				if(newfecha_cliente==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna fecha_cliente");
					}
				}
		...
		try {
			if(this.fecha_autorizacion!=newfecha_autorizacion) {
				if(newfecha_autorizacion==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("NotaCredito:Valor nulo no permitido en columna fecha_autorizacion");
					}
				}
	...
	public String getestadonotacredito_descripcion() {
		return this.estadonotacredito_descripcion;
	}
	...
	public  void  setestadonotacredito_descripcion(String estadonotacredito_descripcion) {
		try {
			this.estadonotacredito_descripcion=estadonotacredito_descripcion;
		} catch(Exception e) {
			;
		}
	}
