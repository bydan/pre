...
public class Pedido extends PedidoAdditional implements Serializable ,Cloneable {//PedidoAdditional,GeneralEntity
	...
	private Map<String, Object> mapPedido;
			
	public Map<String, Object> getMapPedido() {
		return mapPedido;
	}

	public void setMapPedido(Map<String, Object> mapPedido) {
		this.mapPedido = mapPedido;
	}
	
	public void inicializarMapPedido() {
		this.mapPedido = new HashMap<String,Object>();
	}
	
	public void setMapPedidoValue(String sKey,Object oValue) {
		this.mapPedido.put(sKey, oValue);
	}
	
	public Object getMapPedidoValue(String sKey) {
		return this.mapPedido.get(sKey);
	}
	...
	@Pattern(regex=PedidoConstantesFunciones.SREGEXNUMERO,message=PedidoConstantesFunciones.SMENSAJEREGEXNUMERO)
	private String numero;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoConstantesFunciones.SREGEXPRE_IMPRESO,message=PedidoConstantesFunciones.SMENSAJEREGEXPRE_IMPRESO)
	private String pre_impreso;
	...
	@Pattern(regex=PedidoConstantesFunciones.SREGEXDIRECCION,message=PedidoConstantesFunciones.SMENSAJEREGEXDIRECCION)
	...
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoConstantesFunciones.SREGEXTELEFONO,message=PedidoConstantesFunciones.SMENSAJEREGEXTELEFONO)
	private String telefono;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=20,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoConstantesFunciones.SREGEXRUC,message=PedidoConstantesFunciones.SMENSAJEREGEXRUC)
	private String ruc;
	...
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=20,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoConstantesFunciones.SREGEXORDEN,message=PedidoConstantesFunciones.SMENSAJEREGEXORDEN)
	...
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoConstantesFunciones.SREGEXDESCRIPCION,message=PedidoConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoConstantesFunciones.SREGEXNUMERO_FUE,message=PedidoConstantesFunciones.SMENSAJEREGEXNUMERO_FUE)
    ...
    //PARA REPORTES
	public Pedido (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_usuario,String numero,String pre_impreso,Date fecha_emision,Date fecha_entrega,Long id_moneda,Double cotizacion,Long id_empleado,Long id_tipo_precio,Long id_formato,String direccion,Long id_cliente,String telefono,String ruc,Long id_sub_cliente,Long id_vendedor,Long id_consultor,String orden,Long id_responsable,Long id_estado_pedido,Long id_transporte,Long id_ruta_transporte,Double valor_ruta,Long id_tipo_llamada,Long id_transportista,Time hora_inicio,Time hora_fin,String descripcion,Double cupo,Double saldo,Double pedidos,Double documentos,Double disponible,Double descuento_porcentaje,Double total_con_iva,Double suman,Double descuento_valor,Double total_sin_iva,Double descuento_total,Double flete,Double total,Double subtotal,Double otro,Double ultimo_costo,Double iva,Double financiamiento,Double margen_utilidad,Double otros_valores,Double anticipo,Long id_tipo_cambio,Long id_centro_costo,Long id_zona,Date fecha,String numero_fue,Date fecha_servidor,Double monto_retencion,Double ice) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public Pedido (Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_usuario,String numero,String pre_impreso,Date fecha_emision,Date fecha_entrega,Long id_moneda,Double cotizacion,Long id_empleado,Long id_tipo_precio,Long id_formato,String direccion,Long id_cliente,String telefono,String ruc,Long id_sub_cliente,Long id_vendedor,Long id_consultor,String orden,Long id_responsable,Long id_estado_pedido,Long id_transporte,Long id_ruta_transporte,Double valor_ruta,Long id_tipo_llamada,Long id_transportista,Time hora_inicio,Time hora_fin,String descripcion,Double cupo,Double saldo,Double pedidos,Double documentos,Double disponible,Double descuento_porcentaje,Double total_con_iva,Double suman,Double descuento_valor,Double total_sin_iva,Double descuento_total,Double flete,Double total,Double subtotal,Double otro,Double ultimo_costo,Double iva,Double financiamiento,Double margen_utilidad,Double otros_valores,Double anticipo,Long id_tipo_cambio,Long id_centro_costo,Long id_zona,Date fecha,String numero_fue,Date fecha_servidor,Double monto_retencion,Double ice) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			pedidoLocal=(Pedido)object;
			
			if(pedidoLocal!=null) {
				if(this.getId()!=null && pedidoLocal.getId()!=null) {
					if(this.getId().equals(pedidoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!PedidoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=PedidoConstantesFunciones.getPedidoDescripcion(this);
		} else {
			sDetalle=PedidoConstantesFunciones.getPedidoDescripcionDetallado(this);
		}
	...
	public void setPedidoOriginal(Pedido pedido) {
		try {
	...
	protected PedidoAdditional pedidoAdditional=null;
	
	public PedidoAdditional getPedidoAdditional() {
		return this.pedidoAdditional;
	}
	
	public void setPedidoAdditional(PedidoAdditional pedidoAdditional) {
		try {
			this.pedidoAdditional=pedidoAdditional;
		} catch(Exception e) {
			;
		}
	}
	...
	public String getpre_impreso() {
		return this.pre_impreso;
	}
	...
	public Double getvalor_ruta() {
		return this.valor_ruta;
	}
		...
		try {
			if(this.numero!=newnumero) {
				if(newnumero==null) {
					//newnumero="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna numero");
					}
				}

				if(newnumero!=null&&newnumero.length()>50) {
					newnumero=newnumero.substring(0,48);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero");
				}
	...
	public void setpre_impreso(String newpre_impreso)throws Exception
	{
		try {
			if(this.pre_impreso!=newpre_impreso) {
				if(newpre_impreso==null) {
					//newpre_impreso="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna pre_impreso");
					}
				}

				if(newpre_impreso!=null&&newpre_impreso.length()>50) {
					newpre_impreso=newpre_impreso.substring(0,48);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna pre_impreso");
				}

				this.pre_impreso=newpre_impreso;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.fecha_entrega!=newfecha_entrega) {
				if(newfecha_entrega==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna fecha_entrega");
					}
				}
		...
		try {
			if(this.cotizacion!=newcotizacion) {
				if(newcotizacion==null) {
					//newcotizacion=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna cotizacion");
					}
				}
		...
		try {
			if(this.direccion!=newdireccion) {
				if(newdireccion==null) {
					//newdireccion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna direccion");
					}
				}

				if(newdireccion!=null&&newdireccion.length()>150) {
					newdireccion=newdireccion.substring(0,148);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna direccion");
				}
		...
		try {
			if(this.telefono!=newtelefono) {
				if(newtelefono==null) {
					//newtelefono="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna telefono");
					}
				}

				if(newtelefono!=null&&newtelefono.length()>50) {
					newtelefono=newtelefono.substring(0,48);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna telefono");
				}
		...
		try {
			if(this.ruc!=newruc) {
				if(newruc==null) {
					//newruc="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna ruc");
					}
				}

				if(newruc!=null&&newruc.length()>20) {
					newruc=newruc.substring(0,18);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna ruc");
				}
		...
		try {
			if(this.orden!=neworden) {
				if(neworden==null) {
					//neworden="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna orden");
					}
				}

				if(neworden!=null&&neworden.length()>20) {
					neworden=neworden.substring(0,18);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna orden");
				}
	...
	public void setid_ruta_transporte(Long newid_ruta_transporte) {
		if(this.id_ruta_transporte==null&&newid_ruta_transporte!=null) {
			this.id_ruta_transporte=newid_ruta_transporte;
				this.setIsChanged(true);
		}

		if(this.id_ruta_transporte!=null&&!this.id_ruta_transporte.equals(newid_ruta_transporte)) {
	...
	public void setvalor_ruta(Double newvalor_ruta)throws Exception
	{
		try {
			if(this.valor_ruta!=newvalor_ruta) {
				if(newvalor_ruta==null) {
					//newvalor_ruta=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna valor_ruta");
					}
				}

				this.valor_ruta=newvalor_ruta;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
	...
	public void setid_tipo_llamada(Long newid_tipo_llamada) {
		if(this.id_tipo_llamada==null&&newid_tipo_llamada!=null) {
			this.id_tipo_llamada=newid_tipo_llamada;
				this.setIsChanged(true);
		}

		if(this.id_tipo_llamada!=null&&!this.id_tipo_llamada.equals(newid_tipo_llamada)) {
		...
		try {
			if(this.hora_inicio!=newhora_inicio) {
				if(newhora_inicio==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna hora_inicio");
					}
				}
		...
		try {
			if(this.hora_fin!=newhora_fin) {
				if(newhora_fin==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna hora_fin");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>150) {
					newdescripcion=newdescripcion.substring(0,148);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna descripcion");
				}
		...
		try {
			if(this.cupo!=newcupo) {
				if(newcupo==null) {
					//newcupo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna cupo");
					}
				}
		...
		try {
			if(this.saldo!=newsaldo) {
				if(newsaldo==null) {
					//newsaldo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna saldo");
					}
				}
	...
	public void setpedidos(Double newpedidos)throws Exception
	{
		try {
			if(this.pedidos!=newpedidos) {
				if(newpedidos==null) {
					//newpedidos=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna pedidos");
					}
				}
		...
		try {
			if(this.documentos!=newdocumentos) {
				if(newdocumentos==null) {
					//newdocumentos=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna documentos");
					}
				}
		...
		try {
			if(this.disponible!=newdisponible) {
				if(newdisponible==null) {
					//newdisponible=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna disponible");
					}
				}
		...
		try {
			if(this.descuento_porcentaje!=newdescuento_porcentaje) {
				if(newdescuento_porcentaje==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna descuento_porcentaje");
					}
				}
		...
		try {
			if(this.total_con_iva!=newtotal_con_iva) {
				if(newtotal_con_iva==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna total_con_iva");
					}
				}
		...
		try {
			if(this.suman!=newsuman) {
				if(newsuman==null) {
					//newsuman=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna suman");
					}
				}
		...
		try {
			if(this.descuento_valor!=newdescuento_valor) {
				if(newdescuento_valor==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna descuento_valor");
					}
				}
		...
		try {
			if(this.total_sin_iva!=newtotal_sin_iva) {
				if(newtotal_sin_iva==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna total_sin_iva");
					}
				}
	...
	public void setdescuento_total(Double newdescuento_total)throws Exception
	{
		try {
			if(this.descuento_total!=newdescuento_total) {
				if(newdescuento_total==null) {
					//newdescuento_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna descuento_total");
					}
				}

				this.descuento_total=newdescuento_total;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
		...
		try {
			if(this.flete!=newflete) {
				if(newflete==null) {
					//newflete=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna flete");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna total");
					}
				}
		...
		try {
			if(this.subtotal!=newsubtotal) {
				if(newsubtotal==null) {
					//newsubtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna subtotal");
					}
				}
		...
		try {
			if(this.otro!=newotro) {
				if(newotro==null) {
					//newotro=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna otro");
					}
				}
		...
		try {
			if(this.ultimo_costo!=newultimo_costo) {
				if(newultimo_costo==null) {
					//newultimo_costo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna ultimo_costo");
					}
				}
		...
		try {
			if(this.iva!=newiva) {
				if(newiva==null) {
					//newiva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna iva");
					}
				}
		...
		try {
			if(this.financiamiento!=newfinanciamiento) {
				if(newfinanciamiento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna financiamiento");
					}
				}
		...
		try {
			if(this.margen_utilidad!=newmargen_utilidad) {
				if(newmargen_utilidad==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna margen_utilidad");
					}
				}
		...
		try {
			if(this.otros_valores!=newotros_valores) {
				if(newotros_valores==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna otros_valores");
					}
				}
		...
		try {
			if(this.anticipo!=newanticipo) {
				if(newanticipo==null) {
					//newanticipo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna anticipo");
					}
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna fecha");
					}
				}
		...
		try {
			if(this.numero_fue!=newnumero_fue) {
				if(newnumero_fue==null) {
					//newnumero_fue="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna numero_fue");
					}
				}

				if(newnumero_fue!=null&&newnumero_fue.length()>50) {
					newnumero_fue=newnumero_fue.substring(0,48);
					System.out.println("Pedido:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_fue");
				}
		...
		try {
			if(this.fecha_servidor!=newfecha_servidor) {
				if(newfecha_servidor==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna fecha_servidor");
					}
				}
		...
		try {
			if(this.monto_retencion!=newmonto_retencion) {
				if(newmonto_retencion==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna monto_retencion");
					}
				}
		...
		try {
			if(this.ice!=newice) {
				if(newice==null) {
					//newice=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Pedido:Valor nulo no permitido en columna ice");
					}
				}
	...
	public void setid_ruta_transporte_descripcion(String newid_ruta_transporte_descripcion) {
		this.id_ruta_transporte_descripcion=newid_ruta_transporte_descripcion;
	}
	public void setid_tipo_llamada_descripcion(String newid_tipo_llamada_descripcion) {
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_sucursal_descripcion="";this.id_ejercicio_descripcion="";this.id_periodo_descripcion="";this.id_anio_descripcion="";this.id_mes_descripcion="";this.id_usuario_descripcion="";this.id_moneda_descripcion="";this.id_empleado_descripcion="";this.id_tipo_precio_descripcion="";this.id_formato_descripcion="";this.id_cliente_descripcion="";this.id_sub_cliente_descripcion="";this.id_vendedor_descripcion="";this.id_consultor_descripcion="";this.id_responsable_descripcion="";this.id_estado_pedido_descripcion="";this.id_transporte_descripcion="";this.id_ruta_transporte_descripcion="";this.id_tipo_llamada_descripcion="";this.id_transportista_descripcion="";this.id_tipo_cambio_descripcion="";this.id_centro_costo_descripcion="";this.id_zona_descripcion="";
	}
	
	
	Object contenedorsDescripcionReporte;
	Object facturasDescripcionReporte;
	Object detallepedidosDescripcionReporte;
	
	
	public Object getcontenedorsDescripcionReporte() {
		return contenedorsDescripcionReporte;
	}
	...
	public  void  setcontenedorsDescripcionReporte(Object contenedors) {
		try {
			this.contenedorsDescripcionReporte=contenedors;
		} catch(Exception ex) {
			;
		}
	}
