...
public class TablaAmortiDetalle extends TablaAmortiDetalleAdditional implements Serializable ,Cloneable {//TablaAmortiDetalleAdditional,GeneralEntity
	...
	private TablaAmortiDetalle tablaamortidetalleOriginal;
	
	private Map<String, Object> mapTablaAmortiDetalle;
			
	public Map<String, Object> getMapTablaAmortiDetalle() {
		return mapTablaAmortiDetalle;
	}

	public void setMapTablaAmortiDetalle(Map<String, Object> mapTablaAmortiDetalle) {
		this.mapTablaAmortiDetalle = mapTablaAmortiDetalle;
	}
	
	public void inicializarMapTablaAmortiDetalle() {
		this.mapTablaAmortiDetalle = new HashMap<String,Object>();
	}
	
	public void setMapTablaAmortiDetalleValue(String sKey,Object oValue) {
		this.mapTablaAmortiDetalle.put(sKey, oValue);
	}
	
	public Object getMapTablaAmortiDetalleValue(String sKey) {
		return this.mapTablaAmortiDetalle.get(sKey);
	}
	...
	public TablaAmortiDetalle () throws Exception {
		super();		
		...
		this.tablaamortidetalleOriginal=this;
    ...
    //PARA REPORTES
	public TablaAmortiDetalle (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_tasa,Long id_factura,Long id_tipo_intervalo,Date fecha_emision,Date fecha_vencimiento,Date fecha_inicial,Date fecha_final,Double valor,Double interes,Double capital,Integer numero_cuotas,Long id_anio,Long id_mes) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public TablaAmortiDetalle (Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_tasa,Long id_factura,Long id_tipo_intervalo,Date fecha_emision,Date fecha_vencimiento,Date fecha_inicial,Date fecha_final,Double valor,Double interes,Double capital,Integer numero_cuotas,Long id_anio,Long id_mes) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			tablaamortidetalleLocal=(TablaAmortiDetalle)object;
			
			if(tablaamortidetalleLocal!=null) {
				if(this.getId()!=null && tablaamortidetalleLocal.getId()!=null) {
					if(this.getId().equals(tablaamortidetalleLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!TablaAmortiDetalleConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=TablaAmortiDetalleConstantesFunciones.getTablaAmortiDetalleDescripcion(this);
		} else {
			sDetalle=TablaAmortiDetalleConstantesFunciones.getTablaAmortiDetalleDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public TablaAmortiDetalle getTablaAmortiDetalleOriginal() {
		return this.tablaamortidetalleOriginal;
	}
	
	public void setTablaAmortiDetalleOriginal(TablaAmortiDetalle tablaamortidetalle) {
		try {
			this.tablaamortidetalleOriginal=tablaamortidetalle;
		} catch(Exception e) {
			;
		}
	}
	...
	protected TablaAmortiDetalleAdditional tablaamortidetalleAdditional=null;
	
	public TablaAmortiDetalleAdditional getTablaAmortiDetalleAdditional() {
		return this.tablaamortidetalleAdditional;
	}
	
	public void setTablaAmortiDetalleAdditional(TablaAmortiDetalleAdditional tablaamortidetalleAdditional) {
		try {
			this.tablaamortidetalleAdditional=tablaamortidetalleAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.fecha_vencimiento!=newfecha_vencimiento) {
				if(newfecha_vencimiento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna fecha_vencimiento");
					}
				}
		...
		try {
			if(this.fecha_inicial!=newfecha_inicial) {
				if(newfecha_inicial==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna fecha_inicial");
					}
				}
		...
		try {
			if(this.fecha_final!=newfecha_final) {
				if(newfecha_final==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna fecha_final");
					}
				}
		...
		try {
			if(this.valor!=newvalor) {
				if(newvalor==null) {
					//newvalor=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna valor");
					}
				}
		...
		try {
			if(this.interes!=newinteres) {
				if(newinteres==null) {
					//newinteres=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna interes");
					}
				}
		...
		try {
			if(this.capital!=newcapital) {
				if(newcapital==null) {
					//newcapital=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna capital");
					}
				}
		...
		try {
			if(this.numero_cuotas!=newnumero_cuotas) {
				if(newnumero_cuotas==null) {
					//newnumero_cuotas=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("TablaAmortiDetalle:Valor nulo no permitido en columna numero_cuotas");
					}
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_sucursal_descripcion="";String id_ejercicio_descripcion="";String id_periodo_descripcion="";String id_tasa_descripcion="";String id_factura_descripcion="";String id_tipo_intervalo_descripcion="";String id_anio_descripcion="";String id_mes_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_sucursal_descripcion="";this.id_ejercicio_descripcion="";this.id_periodo_descripcion="";this.id_tasa_descripcion="";this.id_factura_descripcion="";this.id_tipo_intervalo_descripcion="";this.id_anio_descripcion="";this.id_mes_descripcion="";
	}
