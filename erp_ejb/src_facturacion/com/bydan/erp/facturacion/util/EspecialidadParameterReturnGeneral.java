...
public class EspecialidadParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EspecialidadParameterReturnGeneral () throws Exception {						
		super();
