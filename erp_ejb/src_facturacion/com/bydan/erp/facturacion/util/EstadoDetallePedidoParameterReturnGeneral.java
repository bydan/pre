...
public class EstadoDetallePedidoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoDetallePedidoParameterReturnGeneral () throws Exception {						
		super();
