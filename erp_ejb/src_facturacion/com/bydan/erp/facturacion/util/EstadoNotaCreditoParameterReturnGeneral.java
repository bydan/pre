...
public class EstadoNotaCreditoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoNotaCreditoParameterReturnGeneral () throws Exception {						
		super();
