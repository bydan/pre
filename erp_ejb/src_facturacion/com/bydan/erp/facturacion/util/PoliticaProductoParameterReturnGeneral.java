...
public class PoliticaProductoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PoliticaProductoParameterReturnGeneral () throws Exception {						
		super();
