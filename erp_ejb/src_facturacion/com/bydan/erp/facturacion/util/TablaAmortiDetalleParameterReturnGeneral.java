...
public class TablaAmortiDetalleParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TablaAmortiDetalleParameterReturnGeneral () throws Exception {						
		super();
