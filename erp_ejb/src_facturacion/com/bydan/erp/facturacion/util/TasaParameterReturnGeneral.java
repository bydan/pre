...
public class TasaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TasaParameterReturnGeneral () throws Exception {						
		super();
