...
public class TipoDetaNotaCreditoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoDetaNotaCreditoParameterReturnGeneral () throws Exception {						
		super();
