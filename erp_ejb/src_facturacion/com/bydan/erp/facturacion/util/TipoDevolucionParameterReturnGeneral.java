...
public class TipoDevolucionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoDevolucionParameterReturnGeneral () throws Exception {						
		super();
