...
public class TipoEstadoPedidoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoEstadoPedidoParameterReturnGeneral () throws Exception {						
		super();
