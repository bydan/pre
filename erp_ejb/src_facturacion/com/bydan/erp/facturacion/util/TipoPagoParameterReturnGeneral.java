...
public class TipoPagoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoPagoParameterReturnGeneral () throws Exception {						
		super();
