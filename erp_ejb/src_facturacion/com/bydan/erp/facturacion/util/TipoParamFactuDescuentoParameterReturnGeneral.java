...
public class TipoParamFactuDescuentoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoParamFactuDescuentoParameterReturnGeneral () throws Exception {						
		super();
