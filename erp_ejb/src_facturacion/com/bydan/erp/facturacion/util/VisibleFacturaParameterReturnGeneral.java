...
public class VisibleFacturaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public VisibleFacturaParameterReturnGeneral () throws Exception {						
		super();
