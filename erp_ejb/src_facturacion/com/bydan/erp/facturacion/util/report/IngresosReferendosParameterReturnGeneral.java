...
public class IngresosReferendosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public IngresosReferendosParameterReturnGeneral () throws Exception {						
		super();
