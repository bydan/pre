...
public class VentasCajasResumidosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public VentasCajasResumidosParameterReturnGeneral () throws Exception {						
		super();
