...
public class VentasResumidosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public VentasResumidosParameterReturnGeneral () throws Exception {						
		super();
