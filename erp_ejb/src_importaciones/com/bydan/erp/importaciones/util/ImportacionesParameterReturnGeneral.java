...
public class ImportacionesParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ImportacionesParameterReturnGeneral () throws Exception {						
		super();
