...
public class TipoCostoGastoImporParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoCostoGastoImporParameterReturnGeneral () throws Exception {						
		super();
