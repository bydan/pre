...
public class ClaseProducto extends ClaseProductoAdditional implements Serializable ,Cloneable {//ClaseProductoAdditional,GeneralEntity
	...
	private ClaseProducto claseproductoOriginal;
	
	private Map<String, Object> mapClaseProducto;
			
	public Map<String, Object> getMapClaseProducto() {
		return mapClaseProducto;
	}

	public void setMapClaseProducto(Map<String, Object> mapClaseProducto) {
		this.mapClaseProducto = mapClaseProducto;
	}
	
	public void inicializarMapClaseProducto() {
		this.mapClaseProducto = new HashMap<String,Object>();
	}
	
	public void setMapClaseProductoValue(String sKey,Object oValue) {
		this.mapClaseProducto.put(sKey, oValue);
	}
	
	public Object getMapClaseProductoValue(String sKey) {
		return this.mapClaseProducto.get(sKey);
	}
	...
	@Pattern(regex=ClaseProductoConstantesFunciones.SREGEXCODIGO,message=ClaseProductoConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=ClaseProductoConstantesFunciones.SREGEXNOMBRE,message=ClaseProductoConstantesFunciones.SMENSAJEREGEXNOMBRE)
	...
	public ClaseProducto () throws Exception {
		super();		
		...
		this.claseproductoOriginal=this;
    ...
    //PARA REPORTES
	public ClaseProducto (Long id,Date versionRow,Long id_empresa,Long id_tipo_producto,String codigo,String nombre) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ClaseProducto (Long id_empresa,Long id_tipo_producto,String codigo,String nombre) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			claseproductoLocal=(ClaseProducto)object;
			
			if(claseproductoLocal!=null) {
				if(this.getId()!=null && claseproductoLocal.getId()!=null) {
					if(this.getId().equals(claseproductoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!ClaseProductoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=ClaseProductoConstantesFunciones.getClaseProductoDescripcion(this);
		} else {
			sDetalle=ClaseProductoConstantesFunciones.getClaseProductoDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public ClaseProducto getClaseProductoOriginal() {
		return this.claseproductoOriginal;
	}
	
	public void setClaseProductoOriginal(ClaseProducto claseproducto) {
		try {
			this.claseproductoOriginal=claseproducto;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ClaseProductoAdditional claseproductoAdditional=null;
	
	public ClaseProductoAdditional getClaseProductoAdditional() {
		return this.claseproductoAdditional;
	}
	
	public void setClaseProductoAdditional(ClaseProductoAdditional claseproductoAdditional) {
		try {
			this.claseproductoAdditional=claseproductoAdditional;
		} catch(Exception e) {
			;
		}
	}
