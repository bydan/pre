...
public class DetalleCompra extends DetalleCompraAdditional implements Serializable ,Cloneable {//DetalleCompraAdditional,GeneralEntity
	...
	private DetalleCompra detallecompraOriginal;
	
	private Map<String, Object> mapDetalleCompra;
			
	public Map<String, Object> getMapDetalleCompra() {
		return mapDetalleCompra;
	}

	public void setMapDetalleCompra(Map<String, Object> mapDetalleCompra) {
		this.mapDetalleCompra = mapDetalleCompra;
	}
	
	public void inicializarMapDetalleCompra() {
		this.mapDetalleCompra = new HashMap<String,Object>();
	}
	
	public void setMapDetalleCompraValue(String sKey,Object oValue) {
		this.mapDetalleCompra.put(sKey, oValue);
	}
	
	public Object getMapDetalleCompraValue(String sKey) {
		return this.mapDetalleCompra.get(sKey);
	}
	...
	@Pattern(regex=DetalleCompraConstantesFunciones.SREGEXDESCRIPCION,message=DetalleCompraConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	@Pattern(regex=DetalleCompraConstantesFunciones.SREGEXSERIE,message=DetalleCompraConstantesFunciones.SMENSAJEREGEXSERIE)
	private String serie;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=DetalleCompraConstantesFunciones.SREGEXLOTE,message=DetalleCompraConstantesFunciones.SMENSAJEREGEXLOTE)
	private String lote;
	...
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=DetalleCompraConstantesFunciones.SREGEXNUMERO_COMPROBANTE,message=DetalleCompraConstantesFunciones.SMENSAJEREGEXNUMERO_COMPROBANTE)
	private String numero_comprobante;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=DetalleCompraConstantesFunciones.SREGEXLOTE_CLIENTE,message=DetalleCompraConstantesFunciones.SMENSAJEREGEXLOTE_CLIENTE)
	...
	public DetalleCompra () throws Exception {
		super();		
		...
		this.detallecompraOriginal=this;
    ...
    //PARA REPORTES
	public DetalleCompra (Long id,Date versionRow,Long id_compra,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_estado_detalle_inventario,Long id_bodega,Long id_producto,Long id_unidad,String descripcion,Long id_novedad_producto,Integer cantidad,Double descuento,Double costo_unitario,Double iva,Double iva_valor,Double costo_total,Integer disponible,Boolean costo_iva,Double ice,Double ice_valor,Double descuento1,Double descuento2,String serie,String lote,Date fecha_elaboracion_lote,Date fecha_caducidad_lote,Long id_centro_costo,Long id_cuenta_contable_costo,String numero_comprobante,String lote_cliente) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public DetalleCompra (Long id_compra,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_estado_detalle_inventario,Long id_bodega,Long id_producto,Long id_unidad,String descripcion,Long id_novedad_producto,Integer cantidad,Double descuento,Double costo_unitario,Double iva,Double iva_valor,Double costo_total,Integer disponible,Boolean costo_iva,Double ice,Double ice_valor,Double descuento1,Double descuento2,String serie,String lote,Date fecha_elaboracion_lote,Date fecha_caducidad_lote,Long id_centro_costo,Long id_cuenta_contable_costo,String numero_comprobante,String lote_cliente) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			detallecompraLocal=(DetalleCompra)object;
			
			if(detallecompraLocal!=null) {
				if(this.getId()!=null && detallecompraLocal.getId()!=null) {
					if(this.getId().equals(detallecompraLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!DetalleCompraConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=DetalleCompraConstantesFunciones.getDetalleCompraDescripcion(this);
		} else {
			sDetalle=DetalleCompraConstantesFunciones.getDetalleCompraDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public DetalleCompra getDetalleCompraOriginal() {
		return this.detallecompraOriginal;
	}
	
	public void setDetalleCompraOriginal(DetalleCompra detallecompra) {
		try {
			this.detallecompraOriginal=detallecompra;
		} catch(Exception e) {
			;
		}
	}
	...
	protected DetalleCompraAdditional detallecompraAdditional=null;
	
	public DetalleCompraAdditional getDetalleCompraAdditional() {
		return this.detallecompraAdditional;
	}
	
	public void setDetalleCompraAdditional(DetalleCompraAdditional detallecompraAdditional) {
		try {
			this.detallecompraAdditional=detallecompraAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>150) {
					newdescripcion=newdescripcion.substring(0,148);
					System.out.println("DetalleCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna descripcion");
				}
		...
		try {
			if(this.cantidad!=newcantidad) {
				if(newcantidad==null) {
					//newcantidad=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna cantidad");
					}
				}
		...
		try {
			if(this.descuento!=newdescuento) {
				if(newdescuento==null) {
					//newdescuento=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna descuento");
					}
				}
		...
		try {
			if(this.costo_unitario!=newcosto_unitario) {
				if(newcosto_unitario==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna costo_unitario");
					}
				}
		...
		try {
			if(this.iva!=newiva) {
				if(newiva==null) {
					//newiva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna iva");
					}
				}
		...
		try {
			if(this.iva_valor!=newiva_valor) {
				if(newiva_valor==null) {
					//newiva_valor=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna iva_valor");
					}
				}
		...
		try {
			if(this.costo_total!=newcosto_total) {
				if(newcosto_total==null) {
					//newcosto_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna costo_total");
					}
				}
		...
		try {
			if(this.disponible!=newdisponible) {
				if(newdisponible==null) {
					//newdisponible=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna disponible");
					}
				}
		...
		try {
			if(this.costo_iva!=newcosto_iva) {
				if(newcosto_iva==null) {
					//newcosto_iva=false;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna costo_iva");
					}
				}
		...
		try {
			if(this.ice!=newice) {
				if(newice==null) {
					//newice=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna ice");
					}
				}
		...
		try {
			if(this.ice_valor!=newice_valor) {
				if(newice_valor==null) {
					//newice_valor=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna ice_valor");
					}
				}
		...
		try {
			if(this.descuento1!=newdescuento1) {
				if(newdescuento1==null) {
					//newdescuento1=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna descuento1");
					}
				}
		...
		try {
			if(this.descuento2!=newdescuento2) {
				if(newdescuento2==null) {
					//newdescuento2=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna descuento2");
					}
				}
		...
		try {
			if(this.serie!=newserie) {
				if(newserie==null) {
					//newserie="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna serie");
					}
				}

				if(newserie!=null&&newserie.length()>50) {
					newserie=newserie.substring(0,48);
					System.out.println("DetalleCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna serie");
				}
		...
		try {
			if(this.lote!=newlote) {
				if(newlote==null) {
					//newlote="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna lote");
					}
				}

				if(newlote!=null&&newlote.length()>50) {
					newlote=newlote.substring(0,48);
					System.out.println("DetalleCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna lote");
				}
		...
		try {
			if(this.fecha_elaboracion_lote!=newfecha_elaboracion_lote) {
				if(newfecha_elaboracion_lote==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna fecha_elaboracion_lote");
					}
				}
		...
		try {
			if(this.fecha_caducidad_lote!=newfecha_caducidad_lote) {
				if(newfecha_caducidad_lote==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna fecha_caducidad_lote");
					}
				}
		...
		try {
			if(this.numero_comprobante!=newnumero_comprobante) {
				if(newnumero_comprobante==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna numero_comprobante");
					}
				}

				if(newnumero_comprobante!=null&&newnumero_comprobante.length()>50) {
					newnumero_comprobante=newnumero_comprobante.substring(0,48);
					System.out.println("DetalleCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_comprobante");
				}
		...
		try {
			if(this.lote_cliente!=newlote_cliente) {
				if(newlote_cliente==null) {
					//newlote_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DetalleCompra:Valor nulo no permitido en columna lote_cliente");
					}
				}

				if(newlote_cliente!=null&&newlote_cliente.length()>50) {
					newlote_cliente=newlote_cliente.substring(0,48);
					System.out.println("DetalleCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna lote_cliente");
				}
	...
	/*PARA REPORTES*/
	String id_compra_descripcion="";String id_empresa_descripcion="";String id_sucursal_descripcion="";String id_ejercicio_descripcion="";String id_periodo_descripcion="";String id_anio_descripcion="";String id_mes_descripcion="";String id_estado_detalle_inventario_descripcion="";String id_bodega_descripcion="";String id_producto_descripcion="";String id_unidad_descripcion="";String id_novedad_producto_descripcion="";String costo_iva_descripcion="";String id_centro_costo_descripcion="";String id_cuenta_contable_costo_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_compra_descripcion="";this.id_empresa_descripcion="";this.id_sucursal_descripcion="";this.id_ejercicio_descripcion="";this.id_periodo_descripcion="";this.id_anio_descripcion="";this.id_mes_descripcion="";this.id_estado_detalle_inventario_descripcion="";this.id_bodega_descripcion="";this.id_producto_descripcion="";this.id_unidad_descripcion="";this.id_novedad_producto_descripcion="";this.costo_iva_descripcion="";this.id_centro_costo_descripcion="";this.id_cuenta_contable_costo_descripcion="";
	}
