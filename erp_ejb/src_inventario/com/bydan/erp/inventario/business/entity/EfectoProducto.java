...
public class EfectoProducto extends EfectoProductoAdditional implements Serializable ,Cloneable {//EfectoProductoAdditional,GeneralEntity
	...
	private EfectoProducto efectoproductoOriginal;
	
	private Map<String, Object> mapEfectoProducto;
			
	public Map<String, Object> getMapEfectoProducto() {
		return mapEfectoProducto;
	}

	public void setMapEfectoProducto(Map<String, Object> mapEfectoProducto) {
		this.mapEfectoProducto = mapEfectoProducto;
	}
	
	public void inicializarMapEfectoProducto() {
		this.mapEfectoProducto = new HashMap<String,Object>();
	}
	
	public void setMapEfectoProductoValue(String sKey,Object oValue) {
		this.mapEfectoProducto.put(sKey, oValue);
	}
	
	public Object getMapEfectoProductoValue(String sKey) {
		return this.mapEfectoProducto.get(sKey);
	}
	...
	@Pattern(regex=EfectoProductoConstantesFunciones.SREGEXCODIGO,message=EfectoProductoConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=EfectoProductoConstantesFunciones.SREGEXNOMBRE,message=EfectoProductoConstantesFunciones.SMENSAJEREGEXNOMBRE)
	...
	public EfectoProducto () throws Exception {
		super();		
		...
		this.efectoproductoOriginal=this;
    ...
    //PARA REPORTES
	public EfectoProducto (Long id,Date versionRow,Long id_empresa,Long id_tipo_producto,String codigo,String nombre) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public EfectoProducto (Long id_empresa,Long id_tipo_producto,String codigo,String nombre) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			efectoproductoLocal=(EfectoProducto)object;
			
			if(efectoproductoLocal!=null) {
				if(this.getId()!=null && efectoproductoLocal.getId()!=null) {
					if(this.getId().equals(efectoproductoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!EfectoProductoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=EfectoProductoConstantesFunciones.getEfectoProductoDescripcion(this);
		} else {
			sDetalle=EfectoProductoConstantesFunciones.getEfectoProductoDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public EfectoProducto getEfectoProductoOriginal() {
		return this.efectoproductoOriginal;
	}
	
	public void setEfectoProductoOriginal(EfectoProducto efectoproducto) {
		try {
			this.efectoproductoOriginal=efectoproducto;
		} catch(Exception e) {
			;
		}
	}
	...
	protected EfectoProductoAdditional efectoproductoAdditional=null;
	
	public EfectoProductoAdditional getEfectoProductoAdditional() {
		return this.efectoproductoAdditional;
	}
	
	public void setEfectoProductoAdditional(EfectoProductoAdditional efectoproductoAdditional) {
		try {
			this.efectoproductoAdditional=efectoproductoAdditional;
		} catch(Exception e) {
			;
		}
	}
