...
public class MarcaProducto extends MarcaProductoAdditional implements Serializable ,Cloneable {//MarcaProductoAdditional,GeneralEntity
	...
	private MarcaProducto marcaproductoOriginal;
	
	private Map<String, Object> mapMarcaProducto;
			
	public Map<String, Object> getMapMarcaProducto() {
		return mapMarcaProducto;
	}

	public void setMapMarcaProducto(Map<String, Object> mapMarcaProducto) {
		this.mapMarcaProducto = mapMarcaProducto;
	}
	
	public void inicializarMapMarcaProducto() {
		this.mapMarcaProducto = new HashMap<String,Object>();
	}
	
	public void setMapMarcaProductoValue(String sKey,Object oValue) {
		this.mapMarcaProducto.put(sKey, oValue);
	}
	
	public Object getMapMarcaProductoValue(String sKey) {
		return this.mapMarcaProducto.get(sKey);
	}
	...
	@Pattern(regex=MarcaProductoConstantesFunciones.SREGEXCODIGO,message=MarcaProductoConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=MarcaProductoConstantesFunciones.SREGEXNOMBRE,message=MarcaProductoConstantesFunciones.SMENSAJEREGEXNOMBRE)
	...
	public MarcaProducto () throws Exception {
		super();		
		...
		this.marcaproductoOriginal=this;
    ...
    //PARA REPORTES
	public MarcaProducto (Long id,Date versionRow,Long id_empresa,Long id_tipo_producto,String codigo,String nombre) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public MarcaProducto (Long id_empresa,Long id_tipo_producto,String codigo,String nombre) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			marcaproductoLocal=(MarcaProducto)object;
			
			if(marcaproductoLocal!=null) {
				if(this.getId()!=null && marcaproductoLocal.getId()!=null) {
					if(this.getId().equals(marcaproductoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!MarcaProductoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=MarcaProductoConstantesFunciones.getMarcaProductoDescripcion(this);
		} else {
			sDetalle=MarcaProductoConstantesFunciones.getMarcaProductoDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public MarcaProducto getMarcaProductoOriginal() {
		return this.marcaproductoOriginal;
	}
	
	public void setMarcaProductoOriginal(MarcaProducto marcaproducto) {
		try {
			this.marcaproductoOriginal=marcaproducto;
		} catch(Exception e) {
			;
		}
	}
	...
	protected MarcaProductoAdditional marcaproductoAdditional=null;
	
	public MarcaProductoAdditional getMarcaProductoAdditional() {
		return this.marcaproductoAdditional;
	}
	
	public void setMarcaProductoAdditional(MarcaProductoAdditional marcaproductoAdditional) {
		try {
			this.marcaproductoAdditional=marcaproductoAdditional;
		} catch(Exception e) {
			;
		}
	}
