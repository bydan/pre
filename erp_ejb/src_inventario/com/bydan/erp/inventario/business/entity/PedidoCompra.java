...
public class PedidoCompra extends PedidoCompraAdditional implements Serializable ,Cloneable {//PedidoCompraAdditional,GeneralEntity
	...
	private PedidoCompra pedidocompraOriginal;
	
	private Map<String, Object> mapPedidoCompra;
			
	public Map<String, Object> getMapPedidoCompra() {
		return mapPedidoCompra;
	}

	public void setMapPedidoCompra(Map<String, Object> mapPedidoCompra) {
		this.mapPedidoCompra = mapPedidoCompra;
	}
	
	public void inicializarMapPedidoCompra() {
		this.mapPedidoCompra = new HashMap<String,Object>();
	}
	
	public void setMapPedidoCompraValue(String sKey,Object oValue) {
		this.mapPedidoCompra.put(sKey, oValue);
	}
	
	public Object getMapPedidoCompraValue(String sKey) {
		return this.mapPedidoCompra.get(sKey);
	}
	...
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXNUMERO_SECUENCIAL,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXNUMERO_SECUENCIAL)
	...
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXRESPONSABLE,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXRESPONSABLE)
	private String responsable;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=100,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXSOLICITADO_POR,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXSOLICITADO_POR)
	private String solicitado_por;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXMOTIVO_SOLICITUD,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXMOTIVO_SOLICITUD)
	private String motivo_solicitud;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=100,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXAREA_SOLICITUD,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXAREA_SOLICITUD)
	private String area_solicitud;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=100,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXPARA_USO_DE,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXPARA_USO_DE)
	private String para_uso_de;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXLUGAR_ENTREGA,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXLUGAR_ENTREGA)
	private String lugar_entrega;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=200,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=PedidoCompraConstantesFunciones.SREGEXDESCRIPCION,message=PedidoCompraConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	public PedidoCompra () throws Exception {
		super();		
		...
		this.pedidocompraOriginal=this;
		...
		this.detallepedidocompras=null;
    ...
    //PARA REPORTES
	public PedidoCompra (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_modulo,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,String numero_secuencial,Long id_cliente,Long id_usuario,Long id_moneda,Long id_estado_pedido_compra,Double total,Date fecha,Long id_empleado,String responsable,String solicitado_por,String motivo_solicitud,String area_solicitud,String para_uso_de,String lugar_entrega,String descripcion,Date fecha_emision,Date fecha_entrega,Long id_formato,Long id_tipo_cambio) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public PedidoCompra (Long id_empresa,Long id_sucursal,Long id_modulo,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,String numero_secuencial,Long id_cliente,Long id_usuario,Long id_moneda,Long id_estado_pedido_compra,Double total,Date fecha,Long id_empleado,String responsable,String solicitado_por,String motivo_solicitud,String area_solicitud,String para_uso_de,String lugar_entrega,String descripcion,Date fecha_emision,Date fecha_entrega,Long id_formato,Long id_tipo_cambio) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			pedidocompraLocal=(PedidoCompra)object;
			
			if(pedidocompraLocal!=null) {
				if(this.getId()!=null && pedidocompraLocal.getId()!=null) {
					if(this.getId().equals(pedidocompraLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!PedidoCompraConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=PedidoCompraConstantesFunciones.getPedidoCompraDescripcion(this);
		} else {
			sDetalle=PedidoCompraConstantesFunciones.getPedidoCompraDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public PedidoCompra getPedidoCompraOriginal() {
		return this.pedidocompraOriginal;
	}
	
	public void setPedidoCompraOriginal(PedidoCompra pedidocompra) {
		try {
			this.pedidocompraOriginal=pedidocompra;
		} catch(Exception e) {
			;
		}
	}
	...
	protected PedidoCompraAdditional pedidocompraAdditional=null;
	
	public PedidoCompraAdditional getPedidoCompraAdditional() {
		return this.pedidocompraAdditional;
	}
	
	public void setPedidoCompraAdditional(PedidoCompraAdditional pedidocompraAdditional) {
		try {
			this.pedidocompraAdditional=pedidocompraAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_modulo!=newid_modulo) {
				if(newid_modulo==null) {
					//newid_modulo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_modulo");
					}
				}
		...
		try {
			if(this.id_ejercicio!=newid_ejercicio) {
				if(newid_ejercicio==null) {
					//newid_ejercicio=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_ejercicio");
					}
				}
		...
		try {
			if(this.id_periodo!=newid_periodo) {
				if(newid_periodo==null) {
					//newid_periodo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_periodo");
					}
				}
		...
		try {
			if(this.numero_secuencial!=newnumero_secuencial) {
				if(newnumero_secuencial==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna numero_secuencial");
					}
				}

				if(newnumero_secuencial!=null&&newnumero_secuencial.length()>50) {
					newnumero_secuencial=newnumero_secuencial.substring(0,48);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_secuencial");
				}
		...
		try {
			if(this.id_cliente!=newid_cliente) {
				if(newid_cliente==null) {
					//newid_cliente=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_cliente");
					}
				}
		...
		try {
			if(this.id_usuario!=newid_usuario) {
				if(newid_usuario==null) {
					//newid_usuario=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_usuario");
					}
				}
		...
		try {
			if(this.id_moneda!=newid_moneda) {
				if(newid_moneda==null) {
					//newid_moneda=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_moneda");
					}
				}
		...
		try {
			if(this.id_estado_pedido_compra!=newid_estado_pedido_compra) {
				if(newid_estado_pedido_compra==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_estado_pedido_compra");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna total");
					}
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna fecha");
					}
				}
		...
		try {
			if(this.id_empleado!=newid_empleado) {
				if(newid_empleado==null) {
					//newid_empleado=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna id_empleado");
					}
				}
		...
		try {
			if(this.responsable!=newresponsable) {
				if(newresponsable==null) {
					//newresponsable="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna responsable");
					}
				}

				if(newresponsable!=null&&newresponsable.length()>150) {
					newresponsable=newresponsable.substring(0,148);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna responsable");
				}
		...
		try {
			if(this.solicitado_por!=newsolicitado_por) {
				if(newsolicitado_por==null) {
					//newsolicitado_por="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna solicitado_por");
					}
				}

				if(newsolicitado_por!=null&&newsolicitado_por.length()>100) {
					newsolicitado_por=newsolicitado_por.substring(0,98);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna solicitado_por");
				}
		...
		try {
			if(this.motivo_solicitud!=newmotivo_solicitud) {
				if(newmotivo_solicitud==null) {
					//newmotivo_solicitud="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna motivo_solicitud");
					}
				}

				if(newmotivo_solicitud!=null&&newmotivo_solicitud.length()>150) {
					newmotivo_solicitud=newmotivo_solicitud.substring(0,148);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna motivo_solicitud");
				}
		...
		try {
			if(this.area_solicitud!=newarea_solicitud) {
				if(newarea_solicitud==null) {
					//newarea_solicitud="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna area_solicitud");
					}
				}

				if(newarea_solicitud!=null&&newarea_solicitud.length()>100) {
					newarea_solicitud=newarea_solicitud.substring(0,98);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna area_solicitud");
				}
		...
		try {
			if(this.para_uso_de!=newpara_uso_de) {
				if(newpara_uso_de==null) {
					//newpara_uso_de="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna para_uso_de");
					}
				}

				if(newpara_uso_de!=null&&newpara_uso_de.length()>100) {
					newpara_uso_de=newpara_uso_de.substring(0,98);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna para_uso_de");
				}
		...
		try {
			if(this.lugar_entrega!=newlugar_entrega) {
				if(newlugar_entrega==null) {
					//newlugar_entrega="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna lugar_entrega");
					}
				}

				if(newlugar_entrega!=null&&newlugar_entrega.length()>50) {
					newlugar_entrega=newlugar_entrega.substring(0,48);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna lugar_entrega");
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>200) {
					newdescripcion=newdescripcion.substring(0,198);
					System.out.println("PedidoCompra:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=200 en columna descripcion");
				}
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.fecha_entrega!=newfecha_entrega) {
				if(newfecha_entrega==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoCompra:Valor nulo no permitido en columna fecha_entrega");
					}
				}
