...
public class Transferencia extends TransferenciaAdditional implements Serializable ,Cloneable {//TransferenciaAdditional,GeneralEntity
	...
	private Map<String, Object> mapTransferencia;
			
	public Map<String, Object> getMapTransferencia() {
		return mapTransferencia;
	}

	public void setMapTransferencia(Map<String, Object> mapTransferencia) {
		this.mapTransferencia = mapTransferencia;
	}
	
	public void inicializarMapTransferencia() {
		this.mapTransferencia = new HashMap<String,Object>();
	}
	
	public void setMapTransferenciaValue(String sKey,Object oValue) {
		this.mapTransferencia.put(sKey, oValue);
	}
	
	public Object getMapTransferenciaValue(String sKey) {
		return this.mapTransferencia.get(sKey);
	}
	...
	@Pattern(regex=TransferenciaConstantesFunciones.SREGEXNUMERO_SECUENCIAL,message=TransferenciaConstantesFunciones.SMENSAJEREGEXNUMERO_SECUENCIAL)
	...
	@Pattern(regex=TransferenciaConstantesFunciones.SREGEXDESCRIPCION,message=TransferenciaConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=TransferenciaConstantesFunciones.SREGEXNUMERO_COMPROBANTE,message=TransferenciaConstantesFunciones.SMENSAJEREGEXNUMERO_COMPROBANTE)
	...
	public Transferencia () throws Exception {
		super();		
		...
		this.transferenciaOriginal=this;
    ...
    //PARA REPORTES
	public Transferencia (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_modulo,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_usuario,Date fecha_emision,Date fecha_entrega,String numero_secuencial,Long id_moneda,Long id_tipo_cambio,Long id_estado_inventario,Long id_formato,Long id_transportista,Long id_empleado,String descripcion,Double porcentaje_descuento,Double suman,Double ice,Double valor_descuento,Double total_descuento,Double iva,Double stock,Double sub_total,Double total_otro,Double ultimo_costo,Double numero_items,Double retencion,Double total,Double flete,Double impuesto,Long id_tipo_transaccion_modulo,Long id_asiento_contable,String numero_comprobante,Date fecha) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public Transferencia (Long id_empresa,Long id_sucursal,Long id_modulo,Long id_ejercicio,Long id_periodo,Long id_anio,Long id_mes,Long id_usuario,Date fecha_emision,Date fecha_entrega,String numero_secuencial,Long id_moneda,Long id_tipo_cambio,Long id_estado_inventario,Long id_formato,Long id_transportista,Long id_empleado,String descripcion,Double porcentaje_descuento,Double suman,Double ice,Double valor_descuento,Double total_descuento,Double iva,Double stock,Double sub_total,Double total_otro,Double ultimo_costo,Double numero_items,Double retencion,Double total,Double flete,Double impuesto,Long id_tipo_transaccion_modulo,Long id_asiento_contable,String numero_comprobante,Date fecha) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			transferenciaLocal=(Transferencia)object;
			
			if(transferenciaLocal!=null) {
				if(this.getId()!=null && transferenciaLocal.getId()!=null) {
					if(this.getId().equals(transferenciaLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!TransferenciaConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=TransferenciaConstantesFunciones.getTransferenciaDescripcion(this);
		} else {
			sDetalle=TransferenciaConstantesFunciones.getTransferenciaDescripcionDetallado(this);
		}
	...
	public Transferencia getTransferenciaOriginal() {
		return this.transferenciaOriginal;
	}
	
	public void setTransferenciaOriginal(Transferencia transferencia) {
		try {
			this.transferenciaOriginal=transferencia;
		} catch(Exception e) {
			;
		}
	}
	...
	protected TransferenciaAdditional transferenciaAdditional=null;
	
	public TransferenciaAdditional getTransferenciaAdditional() {
		return this.transferenciaAdditional;
	}
	
	public void setTransferenciaAdditional(TransferenciaAdditional transferenciaAdditional) {
		try {
			this.transferenciaAdditional=transferenciaAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_modulo!=newid_modulo) {
				if(newid_modulo==null) {
					//newid_modulo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_modulo");
					}
				}
		...
		try {
			if(this.id_ejercicio!=newid_ejercicio) {
				if(newid_ejercicio==null) {
					//newid_ejercicio=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_ejercicio");
					}
				}
		...
		try {
			if(this.id_periodo!=newid_periodo) {
				if(newid_periodo==null) {
					//newid_periodo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_periodo");
					}
				}
		...
		try {
			if(this.id_usuario!=newid_usuario) {
				if(newid_usuario==null) {
					//newid_usuario=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_usuario");
					}
				}
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.fecha_entrega!=newfecha_entrega) {
				if(newfecha_entrega==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna fecha_entrega");
					}
				}
		...
		try {
			if(this.numero_secuencial!=newnumero_secuencial) {
				if(newnumero_secuencial==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna numero_secuencial");
					}
				}

				if(newnumero_secuencial!=null&&newnumero_secuencial.length()>50) {
					newnumero_secuencial=newnumero_secuencial.substring(0,48);
					System.out.println("Transferencia:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_secuencial");
				}
		...
		try {
			if(this.id_moneda!=newid_moneda) {
				if(newid_moneda==null) {
					//newid_moneda=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_moneda");
					}
				}
		...
		try {
			if(this.id_estado_inventario!=newid_estado_inventario) {
				if(newid_estado_inventario==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_estado_inventario");
					}
				}
		...
		try {
			if(this.id_formato!=newid_formato) {
				if(newid_formato==null) {
					//newid_formato=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_formato");
					}
				}
		...
		try {
			if(this.id_empleado!=newid_empleado) {
				if(newid_empleado==null) {
					//newid_empleado=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna id_empleado");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>150) {
					newdescripcion=newdescripcion.substring(0,148);
					System.out.println("Transferencia:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna descripcion");
				}
		...
		try {
			if(this.porcentaje_descuento!=newporcentaje_descuento) {
				if(newporcentaje_descuento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna porcentaje_descuento");
					}
				}
		...
		try {
			if(this.suman!=newsuman) {
				if(newsuman==null) {
					//newsuman=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna suman");
					}
				}
		...
		try {
			if(this.ice!=newice) {
				if(newice==null) {
					//newice=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna ice");
					}
				}
		...
		try {
			if(this.valor_descuento!=newvalor_descuento) {
				if(newvalor_descuento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna valor_descuento");
					}
				}
		...
		try {
			if(this.total_descuento!=newtotal_descuento) {
				if(newtotal_descuento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna total_descuento");
					}
				}
		...
		try {
			if(this.iva!=newiva) {
				if(newiva==null) {
					//newiva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna iva");
					}
				}
		...
		try {
			if(this.stock!=newstock) {
				if(newstock==null) {
					//newstock=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna stock");
					}
				}
		...
		try {
			if(this.sub_total!=newsub_total) {
				if(newsub_total==null) {
					//newsub_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna sub_total");
					}
				}
		...
		try {
			if(this.total_otro!=newtotal_otro) {
				if(newtotal_otro==null) {
					//newtotal_otro=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna total_otro");
					}
				}
		...
		try {
			if(this.ultimo_costo!=newultimo_costo) {
				if(newultimo_costo==null) {
					//newultimo_costo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna ultimo_costo");
					}
				}
		...
		try {
			if(this.numero_items!=newnumero_items) {
				if(newnumero_items==null) {
					//newnumero_items=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna numero_items");
					}
				}
		...
		try {
			if(this.retencion!=newretencion) {
				if(newretencion==null) {
					//newretencion=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna retencion");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna total");
					}
				}
		...
		try {
			if(this.flete!=newflete) {
				if(newflete==null) {
					//newflete=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna flete");
					}
				}
		...
		try {
			if(this.impuesto!=newimpuesto) {
				if(newimpuesto==null) {
					//newimpuesto=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna impuesto");
					}
				}
		...
		try {
			if(this.numero_comprobante!=newnumero_comprobante) {
				if(newnumero_comprobante==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna numero_comprobante");
					}
				}

				if(newnumero_comprobante!=null&&newnumero_comprobante.length()>50) {
					newnumero_comprobante=newnumero_comprobante.substring(0,48);
					System.out.println("Transferencia:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_comprobante");
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("Transferencia:Valor nulo no permitido en columna fecha");
					}
				}
