...
public class ConsumosBodegas extends ConsumosBodegasAdditional implements Serializable ,Cloneable {//ConsumosBodegasAdditional,GeneralEntity
	...
	private ConsumosBodegas consumosbodegasOriginal;
	
	private Map<String, Object> mapConsumosBodegas;
			
	public Map<String, Object> getMapConsumosBodegas() {
		return mapConsumosBodegas;
	}

	public void setMapConsumosBodegas(Map<String, Object> mapConsumosBodegas) {
		this.mapConsumosBodegas = mapConsumosBodegas;
	}
	
	public void inicializarMapConsumosBodegas() {
		this.mapConsumosBodegas = new HashMap<String,Object>();
	}
	
	public void setMapConsumosBodegasValue(String sKey,Object oValue) {
		this.mapConsumosBodegas.put(sKey, oValue);
	}
	
	public Object getMapConsumosBodegasValue(String sKey) {
		return this.mapConsumosBodegas.get(sKey);
	}
	...
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXNOMBRE_PRODUCTO,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXNOMBRE_PRODUCTO)
	private String nombre_producto;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	...
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXNOMBRE_LINEA,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA)
	private String nombre_linea;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXNOMBRE_LINEA_GRUPO,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_GRUPO)
	private String nombre_linea_grupo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXNOMBRE_LINEA_CATEGORIA,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_CATEGORIA)
	private String nombre_linea_categoria;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXNOMBRE_LINEA_MARCA,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_MARCA)
	private String nombre_linea_marca;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosBodegasConstantesFunciones.SREGEXCODIGO,message=ConsumosBodegasConstantesFunciones.SMENSAJEREGEXCODIGO)
	...
	public ConsumosBodegas () throws Exception {
		super();		
		...
		this.consumosbodegasOriginal=this;
    ...
    //PARA REPORTES
	public ConsumosBodegas (Long id,Date versionRow,String nombre_producto,String nombre_unidad,Integer cantidad,Double costo_total,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ConsumosBodegas (String nombre_producto,String nombre_unidad,Integer cantidad,Double costo_total,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo) throws Exception {
		super();		
	...
	public ConsumosBodegas getConsumosBodegasOriginal() {
		return this.consumosbodegasOriginal;
	}
	
	public void setConsumosBodegasOriginal(ConsumosBodegas consumosbodegas) {
		try {
			this.consumosbodegasOriginal=consumosbodegas;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ConsumosBodegasAdditional consumosbodegasAdditional=null;
	
	public ConsumosBodegasAdditional getConsumosBodegasAdditional() {
		return this.consumosbodegasAdditional;
	}
	
	public void setConsumosBodegasAdditional(ConsumosBodegasAdditional consumosbodegasAdditional) {
		try {
			this.consumosbodegasAdditional=consumosbodegasAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_transaccion!=newid_transaccion) {
				if(newid_transaccion==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna id_transaccion");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_linea_categoria!=newid_linea_categoria) {
				if(newid_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna id_linea_categoria");
					}
				}
		...
		try {
			if(this.id_linea_marca!=newid_linea_marca) {
				if(newid_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna id_linea_marca");
					}
				}
		...
		try {
			if(this.fecha_emision_desde!=newfecha_emision_desde) {
				if(newfecha_emision_desde==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna fecha_emision_desde");
					}
				}
		...
		try {
			if(this.fecha_emision_hasta!=newfecha_emision_hasta) {
				if(newfecha_emision_hasta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna fecha_emision_hasta");
					}
				}
		...
		try {
			if(this.nombre_producto!=newnombre_producto) {
				if(newnombre_producto==null) {
					//newnombre_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna nombre_producto");
					}
				}

				if(newnombre_producto!=null&&newnombre_producto.length()>150) {
					newnombre_producto=newnombre_producto.substring(0,148);
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_producto");
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.cantidad!=newcantidad) {
				if(newcantidad==null) {
					//newcantidad=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna cantidad");
					}
				}
		...
		try {
			if(this.costo_total!=newcosto_total) {
				if(newcosto_total==null) {
					//newcosto_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna costo_total");
					}
				}
		...
		try {
			if(this.nombre_linea!=newnombre_linea) {
				if(newnombre_linea==null) {
					//newnombre_linea="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna nombre_linea");
					}
				}

				if(newnombre_linea!=null&&newnombre_linea.length()>150) {
					newnombre_linea=newnombre_linea.substring(0,148);
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea");
				}
		...
		try {
			if(this.nombre_linea_grupo!=newnombre_linea_grupo) {
				if(newnombre_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna nombre_linea_grupo");
					}
				}
				...
				if(newnombre_linea_grupo!=null&&newnombre_linea_grupo.length()>150) {
					...
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_grupo");
				}
		...
		try {
			if(this.nombre_linea_categoria!=newnombre_linea_categoria) {
				if(newnombre_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna nombre_linea_categoria");
					}
				}
				...
				if(newnombre_linea_categoria!=null&&newnombre_linea_categoria.length()>150) {
					...
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_categoria");
				}
		...
		try {
			if(this.nombre_linea_marca!=newnombre_linea_marca) {
				if(newnombre_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna nombre_linea_marca");
					}
				}
				...
				if(newnombre_linea_marca!=null&&newnombre_linea_marca.length()>150) {
					...
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_marca");
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosBodegas:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("ConsumosBodegas:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_transaccion_descripcion="";String id_linea_descripcion="";String id_linea_grupo_descripcion="";String id_linea_categoria_descripcion="";String id_linea_marca_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_transaccion_descripcion="";this.id_linea_descripcion="";this.id_linea_grupo_descripcion="";this.id_linea_categoria_descripcion="";this.id_linea_marca_descripcion="";
	}
