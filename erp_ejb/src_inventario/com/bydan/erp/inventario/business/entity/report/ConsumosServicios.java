...
public class ConsumosServicios extends ConsumosServiciosAdditional implements Serializable ,Cloneable {//ConsumosServiciosAdditional,GeneralEntity
	...
	private ConsumosServicios consumosserviciosOriginal;
	
	private Map<String, Object> mapConsumosServicios;
			
	public Map<String, Object> getMapConsumosServicios() {
		return mapConsumosServicios;
	}

	public void setMapConsumosServicios(Map<String, Object> mapConsumosServicios) {
		this.mapConsumosServicios = mapConsumosServicios;
	}
	
	public void inicializarMapConsumosServicios() {
		this.mapConsumosServicios = new HashMap<String,Object>();
	}
	
	public void setMapConsumosServiciosValue(String sKey,Object oValue) {
		this.mapConsumosServicios.put(sKey, oValue);
	}
	
	public Object getMapConsumosServiciosValue(String sKey) {
		return this.mapConsumosServicios.get(sKey);
	}
	...
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	private String nombre_unidad;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXNOMBRE_PRODUCTO,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXNOMBRE_PRODUCTO)
	...
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXNOMBRE_LINEA,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA)
	private String nombre_linea;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXNOMBRE_LINEA_GRUPO,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_GRUPO)
	private String nombre_linea_grupo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXNOMBRE_LINEA_CATEGORIA,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_CATEGORIA)
	private String nombre_linea_categoria;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXNOMBRE_LINEA_MARCA,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_MARCA)
	private String nombre_linea_marca;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ConsumosServiciosConstantesFunciones.SREGEXCODIGO,message=ConsumosServiciosConstantesFunciones.SMENSAJEREGEXCODIGO)
	...
	public ConsumosServicios () throws Exception {
		super();		
		...
		this.consumosserviciosOriginal=this;
    ...
    //PARA REPORTES
	public ConsumosServicios (Long id,Date versionRow,String nombre_unidad,String nombre_producto,Integer cantidad,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,Double total) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ConsumosServicios (String nombre_unidad,String nombre_producto,Integer cantidad,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,Double total) throws Exception {
		super();		
	...
	public ConsumosServicios getConsumosServiciosOriginal() {
		return this.consumosserviciosOriginal;
	}
	
	public void setConsumosServiciosOriginal(ConsumosServicios consumosservicios) {
		try {
			this.consumosserviciosOriginal=consumosservicios;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ConsumosServiciosAdditional consumosserviciosAdditional=null;
	
	public ConsumosServiciosAdditional getConsumosServiciosAdditional() {
		return this.consumosserviciosAdditional;
	}
	
	public void setConsumosServiciosAdditional(ConsumosServiciosAdditional consumosserviciosAdditional) {
		try {
			this.consumosserviciosAdditional=consumosserviciosAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_transaccion!=newid_transaccion) {
				if(newid_transaccion==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_transaccion");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_linea_categoria!=newid_linea_categoria) {
				if(newid_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_linea_categoria");
					}
				}
		...
		try {
			if(this.id_linea_marca!=newid_linea_marca) {
				if(newid_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_linea_marca");
					}
				}
		...
		try {
			if(this.id_tipo_producto_servicio!=newid_tipo_producto_servicio) {
				if(newid_tipo_producto_servicio==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna id_tipo_producto_servicio");
					}
				}
		...
		try {
			if(this.fecha_emision_desde!=newfecha_emision_desde) {
				if(newfecha_emision_desde==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna fecha_emision_desde");
					}
				}
		...
		try {
			if(this.fecha_emision_hasta!=newfecha_emision_hasta) {
				if(newfecha_emision_hasta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna fecha_emision_hasta");
					}
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.nombre_producto!=newnombre_producto) {
				if(newnombre_producto==null) {
					//newnombre_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna nombre_producto");
					}
				}

				if(newnombre_producto!=null&&newnombre_producto.length()>150) {
					newnombre_producto=newnombre_producto.substring(0,148);
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_producto");
				}
		...
		try {
			if(this.cantidad!=newcantidad) {
				if(newcantidad==null) {
					//newcantidad=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna cantidad");
					}
				}
		...
		try {
			if(this.nombre_linea!=newnombre_linea) {
				if(newnombre_linea==null) {
					//newnombre_linea="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna nombre_linea");
					}
				}

				if(newnombre_linea!=null&&newnombre_linea.length()>150) {
					newnombre_linea=newnombre_linea.substring(0,148);
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea");
				}
		...
		try {
			if(this.nombre_linea_grupo!=newnombre_linea_grupo) {
				if(newnombre_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna nombre_linea_grupo");
					}
				}
				...
				if(newnombre_linea_grupo!=null&&newnombre_linea_grupo.length()>150) {
					...
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_grupo");
				}
		...
		try {
			if(this.nombre_linea_categoria!=newnombre_linea_categoria) {
				if(newnombre_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna nombre_linea_categoria");
					}
				}
				...
				if(newnombre_linea_categoria!=null&&newnombre_linea_categoria.length()>150) {
					...
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_categoria");
				}
		...
		try {
			if(this.nombre_linea_marca!=newnombre_linea_marca) {
				if(newnombre_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna nombre_linea_marca");
					}
				}
				...
				if(newnombre_linea_marca!=null&&newnombre_linea_marca.length()>150) {
					...
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_marca");
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("ConsumosServicios:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ConsumosServicios:Valor nulo no permitido en columna total");
					}
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_transaccion_descripcion="";String id_linea_descripcion="";String id_linea_grupo_descripcion="";String id_linea_categoria_descripcion="";String id_linea_marca_descripcion="";String id_tipo_producto_servicio_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_transaccion_descripcion="";this.id_linea_descripcion="";this.id_linea_grupo_descripcion="";this.id_linea_categoria_descripcion="";this.id_linea_marca_descripcion="";this.id_tipo_producto_servicio_descripcion="";
	}
