...
public class DemandaProductos extends DemandaProductosAdditional implements Serializable ,Cloneable {//DemandaProductosAdditional,GeneralEntity
	...
	private DemandaProductos demandaproductosOriginal;
	
	private Map<String, Object> mapDemandaProductos;
			
	public Map<String, Object> getMapDemandaProductos() {
		return mapDemandaProductos;
	}

	public void setMapDemandaProductos(Map<String, Object> mapDemandaProductos) {
		this.mapDemandaProductos = mapDemandaProductos;
	}
	
	public void inicializarMapDemandaProductos() {
		this.mapDemandaProductos = new HashMap<String,Object>();
	}
	
	public void setMapDemandaProductosValue(String sKey,Object oValue) {
		this.mapDemandaProductos.put(sKey, oValue);
	}
	
	public Object getMapDemandaProductosValue(String sKey) {
		return this.mapDemandaProductos.get(sKey);
	}
	...
	//@Pattern(regex=DemandaProductosConstantesFunciones.SREGEXCODIGO,message=DemandaProductosConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=DemandaProductosConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=DemandaProductosConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	...
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=DemandaProductosConstantesFunciones.SREGEXCODIGO_PRODUCTO,message=DemandaProductosConstantesFunciones.SMENSAJEREGEXCODIGO_PRODUCTO)
	private String codigo_producto;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=DemandaProductosConstantesFunciones.SREGEXNOMBRE,message=DemandaProductosConstantesFunciones.SMENSAJEREGEXNOMBRE)
	private String nombre;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Digits(integerDigits=18,fractionalDigits=2,message=ConstantesValidacion.SVALIDACIONDECIMAL)
	private Double dem_tri;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Digits(integerDigits=18,fractionalDigits=2,message=ConstantesValidacion.SVALIDACIONDECIMAL)
	private Double dem_bi;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Digits(integerDigits=18,fractionalDigits=2,message=ConstantesValidacion.SVALIDACIONDECIMAL)
	private Double dem_men;
	...
	public DemandaProductos () throws Exception {
		super();		
		...
		this.demandaproductosOriginal=this;
    ...
    //PARA REPORTES
	public DemandaProductos (Long id,Date versionRow,String codigo,String nombre_unidad,Integer cantidad_disponible,Integer stock_minimo,String codigo_producto,String nombre,Double dem_tri,Double dem_bi,Double dem_men,Double ingresos,Double egresos,Double existencia,Double costo) throws Exception {
		super();		
		...
		this.demandaproductosOriginal=this;
 		...
 		this.nombre=nombre;
 		this.dem_tri=dem_tri;
 		this.dem_bi=dem_bi;
 		this.dem_men=dem_men;
	 ...
	 //PARA REPORTES
	public DemandaProductos (String codigo,String nombre_unidad,Integer cantidad_disponible,Integer stock_minimo,String codigo_producto,String nombre,Double dem_tri,Double dem_bi,Double dem_men,Double ingresos,Double egresos,Double existencia,Double costo) throws Exception {
		super();		
	...
	public DemandaProductos getDemandaProductosOriginal() {
		return this.demandaproductosOriginal;
	}
	
	public void setDemandaProductosOriginal(DemandaProductos demandaproductos) {
		try {
			this.demandaproductosOriginal=demandaproductos;
		} catch(Exception e) {
			;
		}
	}
	...
	protected DemandaProductosAdditional demandaproductosAdditional=null;
	
	public DemandaProductosAdditional getDemandaProductosAdditional() {
		return this.demandaproductosAdditional;
	}
	
	public void setDemandaProductosAdditional(DemandaProductosAdditional demandaproductosAdditional) {
		try {
			this.demandaproductosAdditional=demandaproductosAdditional;
		} catch(Exception e) {
			;
		}
	}
	...
	public Double getdem_tri() {
		return this.dem_tri;
	}
    
	
	public Double getdem_bi() {
		return this.dem_bi;
	}
    
	
	public Double getdem_men() {
		return this.dem_men;
	}
			...
			if(this.id_bodega!=newid_bodega) {
				if(newid_bodega==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_bodega");
					}
				}
		...
		try {
			if(this.id_producto!=newid_producto) {
				if(newid_producto==null) {
					//newid_producto=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_producto");
					}
				}
		...
		try {
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					//newid_empresa=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_linea_categoria!=newid_linea_categoria) {
				if(newid_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_linea_categoria");
					}
				}
		...
		try {
			if(this.id_linea_marca!=newid_linea_marca) {
				if(newid_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna id_linea_marca");
					}
				}
		...
		try {
			if(this.fecha_ultima_venta_hasta!=newfecha_ultima_venta_hasta) {
				if(newfecha_ultima_venta_hasta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna fecha_ultima_venta_hasta");
					}
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>100) {
					newcodigo=newcodigo.substring(0,98);
					System.out.println("DemandaProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna codigo");
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("DemandaProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.cantidad_disponible!=newcantidad_disponible) {
				if(newcantidad_disponible==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna cantidad_disponible");
					}
				}
		...
		try {
			if(this.stock_minimo!=newstock_minimo) {
				if(newstock_minimo==null) {
					//newstock_minimo=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna stock_minimo");
					}
				}
		...
		try {
			if(this.codigo_producto!=newcodigo_producto) {
				if(newcodigo_producto==null) {
					//newcodigo_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna codigo_producto");
					}
				}

				if(newcodigo_producto!=null&&newcodigo_producto.length()>50) {
					newcodigo_producto=newcodigo_producto.substring(0,48);
					System.out.println("DemandaProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo_producto");
				}
		...
		try {
			if(this.nombre!=newnombre) {
				if(newnombre==null) {
					//newnombre="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna nombre");
					}
				}

				if(newnombre!=null&&newnombre.length()>150) {
					newnombre=newnombre.substring(0,148);
					System.out.println("DemandaProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre");
				}
	...
	public void setdem_tri(Double newdem_tri)throws Exception
	{
		try {
			if(this.dem_tri!=newdem_tri) {
				if(newdem_tri==null) {
					//newdem_tri=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna dem_tri");
					}
				}

				this.dem_tri=newdem_tri;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
	...
	public void setdem_bi(Double newdem_bi)throws Exception
	{
		try {
			if(this.dem_bi!=newdem_bi) {
				if(newdem_bi==null) {
					//newdem_bi=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna dem_bi");
					}
				}

				this.dem_bi=newdem_bi;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
	...
	public void setdem_men(Double newdem_men)throws Exception
	{
		try {
			if(this.dem_men!=newdem_men) {
				if(newdem_men==null) {
					//newdem_men=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna dem_men");
					}
				}

				this.dem_men=newdem_men;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
		...
		try {
			if(this.ingresos!=newingresos) {
				if(newingresos==null) {
					//newingresos=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna ingresos");
					}
				}
		...
		try {
			if(this.egresos!=newegresos) {
				if(newegresos==null) {
					//newegresos=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna egresos");
					}
				}
	...
	public void setexistencia(Double newexistencia)throws Exception
	{
		try {
			if(this.existencia!=newexistencia) {
				if(newexistencia==null) {
					//newexistencia=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna existencia");
					}
				}
		...
		try {
			if(this.costo!=newcosto) {
				if(newcosto==null) {
					//newcosto=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DemandaProductos:Valor nulo no permitido en columna costo");
					}
				}
