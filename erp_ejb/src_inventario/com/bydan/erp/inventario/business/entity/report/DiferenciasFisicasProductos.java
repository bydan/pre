...
public class DiferenciasFisicasProductos extends DiferenciasFisicasProductosAdditional implements Serializable ,Cloneable {//DiferenciasFisicasProductosAdditional,GeneralEntity
	...
	private DiferenciasFisicasProductos diferenciasfisicasproductosOriginal;
	
	private Map<String, Object> mapDiferenciasFisicasProductos;
			
	public Map<String, Object> getMapDiferenciasFisicasProductos() {
		return mapDiferenciasFisicasProductos;
	}

	public void setMapDiferenciasFisicasProductos(Map<String, Object> mapDiferenciasFisicasProductos) {
		this.mapDiferenciasFisicasProductos = mapDiferenciasFisicasProductos;
	}
	
	public void inicializarMapDiferenciasFisicasProductos() {
		this.mapDiferenciasFisicasProductos = new HashMap<String,Object>();
	}
	
	public void setMapDiferenciasFisicasProductosValue(String sKey,Object oValue) {
		this.mapDiferenciasFisicasProductos.put(sKey, oValue);
	}
	
	public Object getMapDiferenciasFisicasProductosValue(String sKey) {
		return this.mapDiferenciasFisicasProductos.get(sKey);
	}
	...
	//@Pattern(regex=DiferenciasFisicasProductosConstantesFunciones.SREGEXCODIGO,message=DiferenciasFisicasProductosConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=DiferenciasFisicasProductosConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=DiferenciasFisicasProductosConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	...
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=DiferenciasFisicasProductosConstantesFunciones.SREGEXCODIGO_PRODUCTO,message=DiferenciasFisicasProductosConstantesFunciones.SMENSAJEREGEXCODIGO_PRODUCTO)
	private String codigo_producto;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=DiferenciasFisicasProductosConstantesFunciones.SREGEXNOMBRE,message=DiferenciasFisicasProductosConstantesFunciones.SMENSAJEREGEXNOMBRE)
	...
	public DiferenciasFisicasProductos () throws Exception {
		super();		
		...
		this.diferenciasfisicasproductosOriginal=this;
    ...
    //PARA REPORTES
	public DiferenciasFisicasProductos (Long id,Date versionRow,String codigo,String nombre_unidad,Integer cantidad_disponible,Integer cantidad_fisica,String codigo_producto,String nombre,Double ingresos,Double egresos,Double disponible_corte,Double diferencia,Double costo,Double total) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public DiferenciasFisicasProductos (String codigo,String nombre_unidad,Integer cantidad_disponible,Integer cantidad_fisica,String codigo_producto,String nombre,Double ingresos,Double egresos,Double disponible_corte,Double diferencia,Double costo,Double total) throws Exception {
		super();		
	...
	public DiferenciasFisicasProductos getDiferenciasFisicasProductosOriginal() {
		return this.diferenciasfisicasproductosOriginal;
	}
	
	public void setDiferenciasFisicasProductosOriginal(DiferenciasFisicasProductos diferenciasfisicasproductos) {
		try {
			this.diferenciasfisicasproductosOriginal=diferenciasfisicasproductos;
		} catch(Exception e) {
			;
		}
	}
	...
	protected DiferenciasFisicasProductosAdditional diferenciasfisicasproductosAdditional=null;
	
	public DiferenciasFisicasProductosAdditional getDiferenciasFisicasProductosAdditional() {
		return this.diferenciasfisicasproductosAdditional;
	}
	
	public void setDiferenciasFisicasProductosAdditional(DiferenciasFisicasProductosAdditional diferenciasfisicasproductosAdditional) {
		try {
			this.diferenciasfisicasproductosAdditional=diferenciasfisicasproductosAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>100) {
					newcodigo=newcodigo.substring(0,98);
					System.out.println("DiferenciasFisicasProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna codigo");
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("DiferenciasFisicasProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.cantidad_disponible!=newcantidad_disponible) {
				if(newcantidad_disponible==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna cantidad_disponible");
					}
				}
		...
		try {
			if(this.cantidad_fisica!=newcantidad_fisica) {
				if(newcantidad_fisica==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna cantidad_fisica");
					}
				}
		...
		try {
			if(this.codigo_producto!=newcodigo_producto) {
				if(newcodigo_producto==null) {
					//newcodigo_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna codigo_producto");
					}
				}

				if(newcodigo_producto!=null&&newcodigo_producto.length()>50) {
					newcodigo_producto=newcodigo_producto.substring(0,48);
					System.out.println("DiferenciasFisicasProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo_producto");
				}
		...
		try {
			if(this.nombre!=newnombre) {
				if(newnombre==null) {
					//newnombre="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna nombre");
					}
				}

				if(newnombre!=null&&newnombre.length()>150) {
					newnombre=newnombre.substring(0,148);
					System.out.println("DiferenciasFisicasProductos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre");
				}
		...
		try {
			if(this.ingresos!=newingresos) {
				if(newingresos==null) {
					//newingresos=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna ingresos");
					}
				}
		...
		try {
			if(this.egresos!=newegresos) {
				if(newegresos==null) {
					//newegresos=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna egresos");
					}
				}
		...
		try {
			if(this.disponible_corte!=newdisponible_corte) {
				if(newdisponible_corte==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna disponible_corte");
					}
				}
	...
	public void setdiferencia(Double newdiferencia)throws Exception
	{
		try {
			if(this.diferencia!=newdiferencia) {
				if(newdiferencia==null) {
					//newdiferencia=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna diferencia");
					}
				}
		...
		try {
			if(this.costo!=newcosto) {
				if(newcosto==null) {
					//newcosto=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna costo");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("DiferenciasFisicasProductos:Valor nulo no permitido en columna total");
					}
				}
