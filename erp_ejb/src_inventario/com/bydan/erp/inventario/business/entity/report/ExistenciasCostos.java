...
public class ExistenciasCostos extends ExistenciasCostosAdditional implements Serializable ,Cloneable {//ExistenciasCostosAdditional,GeneralEntity
	...
	private ExistenciasCostos existenciascostosOriginal;
	
	private Map<String, Object> mapExistenciasCostos;
			
	public Map<String, Object> getMapExistenciasCostos() {
		return mapExistenciasCostos;
	}

	public void setMapExistenciasCostos(Map<String, Object> mapExistenciasCostos) {
		this.mapExistenciasCostos = mapExistenciasCostos;
	}
	
	public void inicializarMapExistenciasCostos() {
		this.mapExistenciasCostos = new HashMap<String,Object>();
	}
	
	public void setMapExistenciasCostosValue(String sKey,Object oValue) {
		this.mapExistenciasCostos.put(sKey, oValue);
	}
	
	public Object getMapExistenciasCostosValue(String sKey) {
		return this.mapExistenciasCostos.get(sKey);
	}
	...
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXNOMBRE_PRODUCTO,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXNOMBRE_PRODUCTO)
	private String nombre_producto;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	private String nombre_unidad;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXNOMBRE_LINEA,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA)
	private String nombre_linea;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXNOMBRE_LINEA_GRUPO,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_GRUPO)
	private String nombre_linea_grupo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXNOMBRE_LINEA_CATEGORIA,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_CATEGORIA)
	private String nombre_linea_categoria;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXNOMBRE_LINEA_MARCA,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_MARCA)
	private String nombre_linea_marca;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ExistenciasCostosConstantesFunciones.SREGEXCODIGO,message=ExistenciasCostosConstantesFunciones.SMENSAJEREGEXCODIGO)
	...
	public ExistenciasCostos () throws Exception {
		super();		
		...
		this.existenciascostosOriginal=this;
    ...
    //PARA REPORTES
	public ExistenciasCostos (Long id,Date versionRow,String nombre_producto,String nombre_unidad,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,Double costo_total) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ExistenciasCostos (String nombre_producto,String nombre_unidad,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,Double costo_total) throws Exception {
		super();		
	...
	public ExistenciasCostos getExistenciasCostosOriginal() {
		return this.existenciascostosOriginal;
	}
	
	public void setExistenciasCostosOriginal(ExistenciasCostos existenciascostos) {
		try {
			this.existenciascostosOriginal=existenciascostos;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ExistenciasCostosAdditional existenciascostosAdditional=null;
	
	public ExistenciasCostosAdditional getExistenciasCostosAdditional() {
		return this.existenciascostosAdditional;
	}
	
	public void setExistenciasCostosAdditional(ExistenciasCostosAdditional existenciascostosAdditional) {
		try {
			this.existenciascostosAdditional=existenciascostosAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_linea_categoria!=newid_linea_categoria) {
				if(newid_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna id_linea_categoria");
					}
				}
		...
		try {
			if(this.id_linea_marca!=newid_linea_marca) {
				if(newid_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna id_linea_marca");
					}
				}
		...
		try {
			if(this.fecha_emision_hasta!=newfecha_emision_hasta) {
				if(newfecha_emision_hasta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna fecha_emision_hasta");
					}
				}
		...
		try {
			if(this.nombre_producto!=newnombre_producto) {
				if(newnombre_producto==null) {
					//newnombre_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna nombre_producto");
					}
				}

				if(newnombre_producto!=null&&newnombre_producto.length()>150) {
					newnombre_producto=newnombre_producto.substring(0,148);
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_producto");
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.nombre_linea!=newnombre_linea) {
				if(newnombre_linea==null) {
					//newnombre_linea="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna nombre_linea");
					}
				}

				if(newnombre_linea!=null&&newnombre_linea.length()>150) {
					newnombre_linea=newnombre_linea.substring(0,148);
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea");
				}
		...
		try {
			if(this.nombre_linea_grupo!=newnombre_linea_grupo) {
				if(newnombre_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna nombre_linea_grupo");
					}
				}
				...
				if(newnombre_linea_grupo!=null&&newnombre_linea_grupo.length()>150) {
					...
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_grupo");
				}
		...
		try {
			if(this.nombre_linea_categoria!=newnombre_linea_categoria) {
				if(newnombre_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna nombre_linea_categoria");
					}
				}
				...
				if(newnombre_linea_categoria!=null&&newnombre_linea_categoria.length()>150) {
					...
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_categoria");
				}
		...
		try {
			if(this.nombre_linea_marca!=newnombre_linea_marca) {
				if(newnombre_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna nombre_linea_marca");
					}
				}
				...
				if(newnombre_linea_marca!=null&&newnombre_linea_marca.length()>150) {
					...
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_marca");
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("ExistenciasCostos:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
		...
		try {
			if(this.costo_total!=newcosto_total) {
				if(newcosto_total==null) {
					//newcosto_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ExistenciasCostos:Valor nulo no permitido en columna costo_total");
					}
				}
