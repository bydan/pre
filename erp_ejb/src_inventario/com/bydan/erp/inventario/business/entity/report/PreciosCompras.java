...
public class PreciosCompras extends PreciosComprasAdditional implements Serializable ,Cloneable {//PreciosComprasAdditional,GeneralEntity
	...
	private PreciosCompras precioscomprasOriginal;
	
	private Map<String, Object> mapPreciosCompras;
			
	public Map<String, Object> getMapPreciosCompras() {
		return mapPreciosCompras;
	}

	public void setMapPreciosCompras(Map<String, Object> mapPreciosCompras) {
		this.mapPreciosCompras = mapPreciosCompras;
	}
	
	public void inicializarMapPreciosCompras() {
		this.mapPreciosCompras = new HashMap<String,Object>();
	}
	
	public void setMapPreciosComprasValue(String sKey,Object oValue) {
		this.mapPreciosCompras.put(sKey, oValue);
	}
	
	public Object getMapPreciosComprasValue(String sKey) {
		return this.mapPreciosCompras.get(sKey);
	}
	...
	//@Pattern(regex=PreciosComprasConstantesFunciones.SREGEXNOMBRE_COMPLETO_CLIENTE,message=PreciosComprasConstantesFunciones.SMENSAJEREGEXNOMBRE_COMPLETO_CLIENTE)
	private String nombre_completo_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=PreciosComprasConstantesFunciones.SREGEXNUMERO_COMPROBANTE,message=PreciosComprasConstantesFunciones.SMENSAJEREGEXNUMERO_COMPROBANTE)
	...
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=PreciosComprasConstantesFunciones.SREGEXNOMBRE_PRODUCTO,message=PreciosComprasConstantesFunciones.SMENSAJEREGEXNOMBRE_PRODUCTO)
	...
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=PreciosComprasConstantesFunciones.SREGEXCODIGO_PRODUCTO,message=PreciosComprasConstantesFunciones.SMENSAJEREGEXCODIGO_PRODUCTO)
	...
	public PreciosCompras () throws Exception {
		super();		
		...
		this.precioscomprasOriginal=this;
    ...
    //PARA REPORTES
	public PreciosCompras (Long id,Date versionRow,String nombre_completo_cliente,String numero_comprobante,Date fecha_emision,String nombre_producto,Double costo_unitario,String codigo_producto) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public PreciosCompras (String nombre_completo_cliente,String numero_comprobante,Date fecha_emision,String nombre_producto,Double costo_unitario,String codigo_producto) throws Exception {
		super();		
	...
	public PreciosCompras getPreciosComprasOriginal() {
		return this.precioscomprasOriginal;
	}
	
	public void setPreciosComprasOriginal(PreciosCompras precioscompras) {
		try {
			this.precioscomprasOriginal=precioscompras;
		} catch(Exception e) {
			;
		}
	}
	...
	protected PreciosComprasAdditional precioscomprasAdditional=null;
	
	public PreciosComprasAdditional getPreciosComprasAdditional() {
		return this.precioscomprasAdditional;
	}
	
	public void setPreciosComprasAdditional(PreciosComprasAdditional precioscomprasAdditional) {
		try {
			this.precioscomprasAdditional=precioscomprasAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_bodega!=newid_bodega) {
				if(newid_bodega==null) {
					//newid_bodega=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_bodega");
					}
				}
		...
		try {
			if(this.id_producto!=newid_producto) {
				if(newid_producto==null) {
					//newid_producto=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_producto");
					}
				}
		...
		try {
			if(this.id_transaccion!=newid_transaccion) {
				if(newid_transaccion==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_transaccion");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_linea_categoria!=newid_linea_categoria) {
				if(newid_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_linea_categoria");
					}
				}
		...
		try {
			if(this.id_linea_marca!=newid_linea_marca) {
				if(newid_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna id_linea_marca");
					}
				}
		...
		try {
			if(this.fecha_emision_desde!=newfecha_emision_desde) {
				if(newfecha_emision_desde==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna fecha_emision_desde");
					}
				}
		...
		try {
			if(this.fecha_emision_hasta!=newfecha_emision_hasta) {
				if(newfecha_emision_hasta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna fecha_emision_hasta");
					}
				}
		...
		try {
			if(this.nombre_completo_cliente!=newnombre_completo_cliente) {
				if(newnombre_completo_cliente==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna nombre_completo_cliente");
					}
				}
				...
				if(newnombre_completo_cliente!=null&&newnombre_completo_cliente.length()>150) {
					...
					System.out.println("PreciosCompras:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_completo_cliente");
				}
		...
		try {
			if(this.numero_comprobante!=newnumero_comprobante) {
				if(newnumero_comprobante==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna numero_comprobante");
					}
				}

				if(newnumero_comprobante!=null&&newnumero_comprobante.length()>50) {
					newnumero_comprobante=newnumero_comprobante.substring(0,48);
					System.out.println("PreciosCompras:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_comprobante");
				}
		...
		try {
			if(this.fecha_emision!=newfecha_emision) {
				if(newfecha_emision==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna fecha_emision");
					}
				}
		...
		try {
			if(this.nombre_producto!=newnombre_producto) {
				if(newnombre_producto==null) {
					//newnombre_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna nombre_producto");
					}
				}

				if(newnombre_producto!=null&&newnombre_producto.length()>150) {
					newnombre_producto=newnombre_producto.substring(0,148);
					System.out.println("PreciosCompras:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_producto");
				}
		...
		try {
			if(this.costo_unitario!=newcosto_unitario) {
				if(newcosto_unitario==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna costo_unitario");
					}
				}
		...
		try {
			if(this.codigo_producto!=newcodigo_producto) {
				if(newcodigo_producto==null) {
					//newcodigo_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PreciosCompras:Valor nulo no permitido en columna codigo_producto");
					}
				}

				if(newcodigo_producto!=null&&newcodigo_producto.length()>50) {
					newcodigo_producto=newcodigo_producto.substring(0,48);
					System.out.println("PreciosCompras:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo_producto");
				}
