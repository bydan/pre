...
public class ProcesoPreciosPorcentaje extends ProcesoPreciosPorcentajeAdditional implements Serializable ,Cloneable {//ProcesoPreciosPorcentajeAdditional,GeneralEntity
	...
	private ProcesoPreciosPorcentaje procesopreciosporcentajeOriginal;
	
	private Map<String, Object> mapProcesoPreciosPorcentaje;
			
	public Map<String, Object> getMapProcesoPreciosPorcentaje() {
		return mapProcesoPreciosPorcentaje;
	}

	public void setMapProcesoPreciosPorcentaje(Map<String, Object> mapProcesoPreciosPorcentaje) {
		this.mapProcesoPreciosPorcentaje = mapProcesoPreciosPorcentaje;
	}
	
	public void inicializarMapProcesoPreciosPorcentaje() {
		this.mapProcesoPreciosPorcentaje = new HashMap<String,Object>();
	}
	
	public void setMapProcesoPreciosPorcentajeValue(String sKey,Object oValue) {
		this.mapProcesoPreciosPorcentaje.put(sKey, oValue);
	}
	
	public Object getMapProcesoPreciosPorcentajeValue(String sKey) {
		return this.mapProcesoPreciosPorcentaje.get(sKey);
	}
	...
	//@Pattern(regex=ProcesoPreciosPorcentajeConstantesFunciones.SREGEXCODIGO,message=ProcesoPreciosPorcentajeConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProcesoPreciosPorcentajeConstantesFunciones.SREGEXNOMBRE,message=ProcesoPreciosPorcentajeConstantesFunciones.SMENSAJEREGEXNOMBRE)
	private String nombre;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProcesoPreciosPorcentajeConstantesFunciones.SREGEXCODIGO_PRODUCTO,message=ProcesoPreciosPorcentajeConstantesFunciones.SMENSAJEREGEXCODIGO_PRODUCTO)
	private String codigo_producto;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProcesoPreciosPorcentajeConstantesFunciones.SREGEXNOMBRE_PRODUCTO,message=ProcesoPreciosPorcentajeConstantesFunciones.SMENSAJEREGEXNOMBRE_PRODUCTO)
	...
	public ProcesoPreciosPorcentaje () throws Exception {
		super();		
		...
		this.procesopreciosporcentajeOriginal=this;
    ...
    //PARA REPORTES
	public ProcesoPreciosPorcentaje (Long id,Date versionRow,String codigo,String nombre,String codigo_producto,String nombre_producto,Double precio,Double porcentaje) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ProcesoPreciosPorcentaje (String codigo,String nombre,String codigo_producto,String nombre_producto,Double precio,Double porcentaje) throws Exception {
		super();		
	...
	public ProcesoPreciosPorcentaje getProcesoPreciosPorcentajeOriginal() {
		return this.procesopreciosporcentajeOriginal;
	}
	
	public void setProcesoPreciosPorcentajeOriginal(ProcesoPreciosPorcentaje procesopreciosporcentaje) {
		try {
			this.procesopreciosporcentajeOriginal=procesopreciosporcentaje;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ProcesoPreciosPorcentajeAdditional procesopreciosporcentajeAdditional=null;
	
	public ProcesoPreciosPorcentajeAdditional getProcesoPreciosPorcentajeAdditional() {
		return this.procesopreciosporcentajeAdditional;
	}
	
	public void setProcesoPreciosPorcentajeAdditional(ProcesoPreciosPorcentajeAdditional procesopreciosporcentajeAdditional) {
		try {
			this.procesopreciosporcentajeAdditional=procesopreciosporcentajeAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_bodega!=newid_bodega) {
				if(newid_bodega==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_bodega");
					}
				}
		...
		try {
			if(this.id_producto!=newid_producto) {
				if(newid_producto==null) {
					//newid_producto=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_producto");
					}
				}
		...
		try {
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					//newid_empresa=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_linea!=newid_linea) {
				if(newid_linea==null) {
					//newid_linea=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_linea");
					}
				}
		...
		try {
			if(this.id_linea_grupo!=newid_linea_grupo) {
				if(newid_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_linea_grupo");
					}
				}
		...
		try {
			if(this.id_linea_categoria!=newid_linea_categoria) {
				if(newid_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_linea_categoria");
					}
				}
		...
		try {
			if(this.id_linea_marca!=newid_linea_marca) {
				if(newid_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna id_linea_marca");
					}
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>100) {
					newcodigo=newcodigo.substring(0,98);
					System.out.println("ProcesoPreciosPorcentaje:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna codigo");
				}
		...
		try {
			if(this.nombre!=newnombre) {
				if(newnombre==null) {
					//newnombre="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna nombre");
					}
				}

				if(newnombre!=null&&newnombre.length()>150) {
					newnombre=newnombre.substring(0,148);
					System.out.println("ProcesoPreciosPorcentaje:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre");
				}
		...
		try {
			if(this.codigo_producto!=newcodigo_producto) {
				if(newcodigo_producto==null) {
					//newcodigo_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna codigo_producto");
					}
				}

				if(newcodigo_producto!=null&&newcodigo_producto.length()>50) {
					newcodigo_producto=newcodigo_producto.substring(0,48);
					System.out.println("ProcesoPreciosPorcentaje:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo_producto");
				}
		...
		try {
			if(this.nombre_producto!=newnombre_producto) {
				if(newnombre_producto==null) {
					//newnombre_producto="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna nombre_producto");
					}
				}

				if(newnombre_producto!=null&&newnombre_producto.length()>150) {
					newnombre_producto=newnombre_producto.substring(0,148);
					System.out.println("ProcesoPreciosPorcentaje:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_producto");
				}
		...
		try {
			if(this.precio!=newprecio) {
				if(newprecio==null) {
					//newprecio=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna precio");
					}
				}
		...
		try {
			if(this.porcentaje!=newporcentaje) {
				if(newporcentaje==null) {
					//newporcentaje=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProcesoPreciosPorcentaje:Valor nulo no permitido en columna porcentaje");
					}
				}
