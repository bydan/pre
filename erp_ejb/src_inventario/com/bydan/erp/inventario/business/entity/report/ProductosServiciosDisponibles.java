...
public class ProductosServiciosDisponibles extends ProductosServiciosDisponiblesAdditional implements Serializable ,Cloneable {//ProductosServiciosDisponiblesAdditional,GeneralEntity
	...
	private ProductosServiciosDisponibles productosserviciosdisponiblesOriginal;
	
	private Map<String, Object> mapProductosServiciosDisponibles;
			
	public Map<String, Object> getMapProductosServiciosDisponibles() {
		return mapProductosServiciosDisponibles;
	}

	public void setMapProductosServiciosDisponibles(Map<String, Object> mapProductosServiciosDisponibles) {
		this.mapProductosServiciosDisponibles = mapProductosServiciosDisponibles;
	}
	
	public void inicializarMapProductosServiciosDisponibles() {
		this.mapProductosServiciosDisponibles = new HashMap<String,Object>();
	}
	
	public void setMapProductosServiciosDisponiblesValue(String sKey,Object oValue) {
		this.mapProductosServiciosDisponibles.put(sKey, oValue);
	}
	
	public Object getMapProductosServiciosDisponiblesValue(String sKey) {
		return this.mapProductosServiciosDisponibles.get(sKey);
	}
	...
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_SUCURSAL,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_SUCURSAL)
	private String nombre_sucursal;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_LINEA,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA)
	private String nombre_linea;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_LINEA_GRUPO,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_GRUPO)
	private String nombre_linea_grupo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_LINEA_CATEGORIA,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_CATEGORIA)
	private String nombre_linea_categoria;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_LINEA_MARCA,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_MARCA)
	private String nombre_linea_marca;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXCODIGO,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE)
	private String nombre;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_TIPO_PRODUCTO_SERVICIO,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_TIPO_PRODUCTO_SERVICIO)
	private String nombre_tipo_producto_servicio;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_BODEGA,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_BODEGA)
	private String nombre_bodega;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosDisponiblesConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=ProductosServiciosDisponiblesConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	...
	public ProductosServiciosDisponibles () throws Exception {
		super();		
		...
		this.productosserviciosdisponiblesOriginal=this;
    ...
    //PARA REPORTES
	public ProductosServiciosDisponibles (Long id,Date versionRow,String nombre_sucursal,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,String nombre,String nombre_tipo_producto_servicio,String nombre_bodega,String nombre_unidad,Integer cantidad_disponible,Integer cantidad_maximo,Integer cantidad_minimo,Double precio_compra,Double precio_venta,Double costo_ultimo) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ProductosServiciosDisponibles (String nombre_sucursal,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,String nombre,String nombre_tipo_producto_servicio,String nombre_bodega,String nombre_unidad,Integer cantidad_disponible,Integer cantidad_maximo,Integer cantidad_minimo,Double precio_compra,Double precio_venta,Double costo_ultimo) throws Exception {
		super();		
	...
	public ProductosServiciosDisponibles getProductosServiciosDisponiblesOriginal() {
		return this.productosserviciosdisponiblesOriginal;
	}
	
	public void setProductosServiciosDisponiblesOriginal(ProductosServiciosDisponibles productosserviciosdisponibles) {
		try {
			this.productosserviciosdisponiblesOriginal=productosserviciosdisponibles;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ProductosServiciosDisponiblesAdditional productosserviciosdisponiblesAdditional=null;
	
	public ProductosServiciosDisponiblesAdditional getProductosServiciosDisponiblesAdditional() {
		return this.productosserviciosdisponiblesAdditional;
	}
	
	public void setProductosServiciosDisponiblesAdditional(ProductosServiciosDisponiblesAdditional productosserviciosdisponiblesAdditional) {
		try {
			this.productosserviciosdisponiblesAdditional=productosserviciosdisponiblesAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.nombre_sucursal!=newnombre_sucursal) {
				if(newnombre_sucursal==null) {
					//newnombre_sucursal="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_sucursal");
					}
				}

				if(newnombre_sucursal!=null&&newnombre_sucursal.length()>150) {
					newnombre_sucursal=newnombre_sucursal.substring(0,148);
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_sucursal");
				}
		...
		try {
			if(this.nombre_linea!=newnombre_linea) {
				if(newnombre_linea==null) {
					//newnombre_linea="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_linea");
					}
				}

				if(newnombre_linea!=null&&newnombre_linea.length()>150) {
					newnombre_linea=newnombre_linea.substring(0,148);
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea");
				}
		...
		try {
			if(this.nombre_linea_grupo!=newnombre_linea_grupo) {
				if(newnombre_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_linea_grupo");
					}
				}
				...
				if(newnombre_linea_grupo!=null&&newnombre_linea_grupo.length()>150) {
					...
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_grupo");
				}
		...
		try {
			if(this.nombre_linea_categoria!=newnombre_linea_categoria) {
				if(newnombre_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_linea_categoria");
					}
				}
				...
				if(newnombre_linea_categoria!=null&&newnombre_linea_categoria.length()>150) {
					...
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_categoria");
				}
		...
		try {
			if(this.nombre_linea_marca!=newnombre_linea_marca) {
				if(newnombre_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_linea_marca");
					}
				}
				...
				if(newnombre_linea_marca!=null&&newnombre_linea_marca.length()>150) {
					...
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_marca");
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
		...
		try {
			if(this.nombre!=newnombre) {
				if(newnombre==null) {
					//newnombre="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre");
					}
				}

				if(newnombre!=null&&newnombre.length()>150) {
					newnombre=newnombre.substring(0,148);
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre");
				}
		...
		try {
			if(this.nombre_tipo_producto_servicio!=newnombre_tipo_producto_servicio) {
				if(newnombre_tipo_producto_servicio==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_tipo_producto_servicio");
					}
				}
				...
				if(newnombre_tipo_producto_servicio!=null&&newnombre_tipo_producto_servicio.length()>150) {
					...
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_tipo_producto_servicio");
				}
		...
		try {
			if(this.nombre_bodega!=newnombre_bodega) {
				if(newnombre_bodega==null) {
					//newnombre_bodega="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_bodega");
					}
				}

				if(newnombre_bodega!=null&&newnombre_bodega.length()>150) {
					newnombre_bodega=newnombre_bodega.substring(0,148);
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_bodega");
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("ProductosServiciosDisponibles:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.cantidad_disponible!=newcantidad_disponible) {
				if(newcantidad_disponible==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna cantidad_disponible");
					}
				}
		...
		try {
			if(this.cantidad_maximo!=newcantidad_maximo) {
				if(newcantidad_maximo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna cantidad_maximo");
					}
				}
		...
		try {
			if(this.cantidad_minimo!=newcantidad_minimo) {
				if(newcantidad_minimo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna cantidad_minimo");
					}
				}
	...
	public void setprecio_compra(Double newprecio_compra)throws Exception
	{
		try {
			if(this.precio_compra!=newprecio_compra) {
				if(newprecio_compra==null) {
					//newprecio_compra=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna precio_compra");
					}
				}
		...
		try {
			if(this.precio_venta!=newprecio_venta) {
				if(newprecio_venta==null) {
					//newprecio_venta=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna precio_venta");
					}
				}
		...
		try {
			if(this.costo_ultimo!=newcosto_ultimo) {
				if(newcosto_ultimo==null) {
					//newcosto_ultimo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosDisponibles:Valor nulo no permitido en columna costo_ultimo");
					}
				}
