...
public class ProductosServiciosExistencias extends ProductosServiciosExistenciasAdditional implements Serializable ,Cloneable {//ProductosServiciosExistenciasAdditional,GeneralEntity
	...
	private ProductosServiciosExistencias productosserviciosexistenciasOriginal;
	
	private Map<String, Object> mapProductosServiciosExistencias;
			
	public Map<String, Object> getMapProductosServiciosExistencias() {
		return mapProductosServiciosExistencias;
	}

	public void setMapProductosServiciosExistencias(Map<String, Object> mapProductosServiciosExistencias) {
		this.mapProductosServiciosExistencias = mapProductosServiciosExistencias;
	}
	
	public void inicializarMapProductosServiciosExistencias() {
		this.mapProductosServiciosExistencias = new HashMap<String,Object>();
	}
	
	public void setMapProductosServiciosExistenciasValue(String sKey,Object oValue) {
		this.mapProductosServiciosExistencias.put(sKey, oValue);
	}
	
	public Object getMapProductosServiciosExistenciasValue(String sKey) {
		return this.mapProductosServiciosExistencias.get(sKey);
	}
	...
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_SUCURSAL,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_SUCURSAL)
	private String nombre_sucursal;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_LINEA,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA)
	private String nombre_linea;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_LINEA_GRUPO,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_GRUPO)
	private String nombre_linea_grupo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_LINEA_CATEGORIA,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_CATEGORIA)
	private String nombre_linea_categoria;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_LINEA_MARCA,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_LINEA_MARCA)
	private String nombre_linea_marca;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXCODIGO,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE)
	private String nombre;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_TIPO_PRODUCTO_SERVICIO,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_TIPO_PRODUCTO_SERVICIO)
	private String nombre_tipo_producto_servicio;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_BODEGA,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_BODEGA)
	private String nombre_bodega;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=ProductosServiciosExistenciasConstantesFunciones.SREGEXNOMBRE_UNIDAD,message=ProductosServiciosExistenciasConstantesFunciones.SMENSAJEREGEXNOMBRE_UNIDAD)
	...
	public ProductosServiciosExistencias () throws Exception {
		super();		
		...
		this.productosserviciosexistenciasOriginal=this;
    ...
    //PARA REPORTES
	public ProductosServiciosExistencias (Long id,Date versionRow,String nombre_sucursal,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,String nombre,String nombre_tipo_producto_servicio,String nombre_bodega,String nombre_unidad,Integer cantidad_disponible,Double cantidad_reservada,Double cantidad_pedida,Double total_egreso,Double total_compra,Double total_devuelto) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public ProductosServiciosExistencias (String nombre_sucursal,String nombre_linea,String nombre_linea_grupo,String nombre_linea_categoria,String nombre_linea_marca,String codigo,String nombre,String nombre_tipo_producto_servicio,String nombre_bodega,String nombre_unidad,Integer cantidad_disponible,Double cantidad_reservada,Double cantidad_pedida,Double total_egreso,Double total_compra,Double total_devuelto) throws Exception {
		super();		
	...
	public ProductosServiciosExistencias getProductosServiciosExistenciasOriginal() {
		return this.productosserviciosexistenciasOriginal;
	}
	
	public void setProductosServiciosExistenciasOriginal(ProductosServiciosExistencias productosserviciosexistencias) {
		try {
			this.productosserviciosexistenciasOriginal=productosserviciosexistencias;
		} catch(Exception e) {
			;
		}
	}
	...
	protected ProductosServiciosExistenciasAdditional productosserviciosexistenciasAdditional=null;
	
	public ProductosServiciosExistenciasAdditional getProductosServiciosExistenciasAdditional() {
		return this.productosserviciosexistenciasAdditional;
	}
	
	public void setProductosServiciosExistenciasAdditional(ProductosServiciosExistenciasAdditional productosserviciosexistenciasAdditional) {
		try {
			this.productosserviciosexistenciasAdditional=productosserviciosexistenciasAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.nombre_sucursal!=newnombre_sucursal) {
				if(newnombre_sucursal==null) {
					//newnombre_sucursal="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_sucursal");
					}
				}

				if(newnombre_sucursal!=null&&newnombre_sucursal.length()>150) {
					newnombre_sucursal=newnombre_sucursal.substring(0,148);
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_sucursal");
				}
		...
		try {
			if(this.nombre_linea!=newnombre_linea) {
				if(newnombre_linea==null) {
					//newnombre_linea="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_linea");
					}
				}

				if(newnombre_linea!=null&&newnombre_linea.length()>150) {
					newnombre_linea=newnombre_linea.substring(0,148);
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea");
				}
		...
		try {
			if(this.nombre_linea_grupo!=newnombre_linea_grupo) {
				if(newnombre_linea_grupo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_linea_grupo");
					}
				}
				...
				if(newnombre_linea_grupo!=null&&newnombre_linea_grupo.length()>150) {
					...
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_grupo");
				}
		...
		try {
			if(this.nombre_linea_categoria!=newnombre_linea_categoria) {
				if(newnombre_linea_categoria==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_linea_categoria");
					}
				}
				...
				if(newnombre_linea_categoria!=null&&newnombre_linea_categoria.length()>150) {
					...
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_categoria");
				}
		...
		try {
			if(this.nombre_linea_marca!=newnombre_linea_marca) {
				if(newnombre_linea_marca==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_linea_marca");
					}
				}
				...
				if(newnombre_linea_marca!=null&&newnombre_linea_marca.length()>150) {
					...
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_linea_marca");
				}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
		...
		try {
			if(this.nombre!=newnombre) {
				if(newnombre==null) {
					//newnombre="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre");
					}
				}

				if(newnombre!=null&&newnombre.length()>150) {
					newnombre=newnombre.substring(0,148);
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre");
				}
		...
		try {
			if(this.nombre_tipo_producto_servicio!=newnombre_tipo_producto_servicio) {
				if(newnombre_tipo_producto_servicio==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_tipo_producto_servicio");
					}
				}
				...
				if(newnombre_tipo_producto_servicio!=null&&newnombre_tipo_producto_servicio.length()>150) {
					...
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_tipo_producto_servicio");
				}
		...
		try {
			if(this.nombre_bodega!=newnombre_bodega) {
				if(newnombre_bodega==null) {
					//newnombre_bodega="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_bodega");
					}
				}

				if(newnombre_bodega!=null&&newnombre_bodega.length()>150) {
					newnombre_bodega=newnombre_bodega.substring(0,148);
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna nombre_bodega");
				}
		...
		try {
			if(this.nombre_unidad!=newnombre_unidad) {
				if(newnombre_unidad==null) {
					//newnombre_unidad="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna nombre_unidad");
					}
				}

				if(newnombre_unidad!=null&&newnombre_unidad.length()>50) {
					newnombre_unidad=newnombre_unidad.substring(0,48);
					System.out.println("ProductosServiciosExistencias:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna nombre_unidad");
				}
		...
		try {
			if(this.cantidad_disponible!=newcantidad_disponible) {
				if(newcantidad_disponible==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna cantidad_disponible");
					}
				}
		...
		try {
			if(this.cantidad_reservada!=newcantidad_reservada) {
				if(newcantidad_reservada==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna cantidad_reservada");
					}
				}
		...
		try {
			if(this.cantidad_pedida!=newcantidad_pedida) {
				if(newcantidad_pedida==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna cantidad_pedida");
					}
				}
		...
		try {
			if(this.total_egreso!=newtotal_egreso) {
				if(newtotal_egreso==null) {
					//newtotal_egreso=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna total_egreso");
					}
				}
		...
		try {
			if(this.total_compra!=newtotal_compra) {
				if(newtotal_compra==null) {
					//newtotal_compra=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna total_compra");
					}
				}
		...
		try {
			if(this.total_devuelto!=newtotal_devuelto) {
				if(newtotal_devuelto==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("ProductosServiciosExistencias:Valor nulo no permitido en columna total_devuelto");
					}
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_sucursal_descripcion="";String id_bodega_descripcion="";String id_producto_descripcion="";String id_linea_descripcion="";String id_linea_grupo_descripcion="";String id_linea_categoria_descripcion="";String id_linea_marca_descripcion="";String id_tipo_producto_servicio_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_sucursal_descripcion="";this.id_bodega_descripcion="";this.id_producto_descripcion="";this.id_linea_descripcion="";this.id_linea_grupo_descripcion="";this.id_linea_categoria_descripcion="";this.id_linea_marca_descripcion="";this.id_tipo_producto_servicio_descripcion="";
	}
