...
public class BodegaSucursalParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public BodegaSucursalParameterReturnGeneral () throws Exception {						
		super();
