...
public class CostoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CostoParameterReturnGeneral () throws Exception {						
		super();
