...
public class DetalleOrdenCompraParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public DetalleOrdenCompraParameterReturnGeneral () throws Exception {						
		super();
	...
	public List<EstadoDetalleOrdenCompra> getestadodetalleordencomprasForeignKey() {
		return this.estadodetalleordencomprasForeignKey;
	}
