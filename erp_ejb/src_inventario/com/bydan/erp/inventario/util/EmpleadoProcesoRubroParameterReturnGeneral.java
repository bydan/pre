...
public class EmpleadoProcesoRubroParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EmpleadoProcesoRubroParameterReturnGeneral () throws Exception {						
		super();
