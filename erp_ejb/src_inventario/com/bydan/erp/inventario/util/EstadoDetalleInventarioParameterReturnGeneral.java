...
public class EstadoDetalleInventarioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoDetalleInventarioParameterReturnGeneral () throws Exception {						
		super();
