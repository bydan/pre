...
public class EstadoDetalleMovimientoInventarioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoDetalleMovimientoInventarioParameterReturnGeneral () throws Exception {						
		super();
