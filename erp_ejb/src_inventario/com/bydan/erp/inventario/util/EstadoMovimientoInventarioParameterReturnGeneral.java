...
public class EstadoMovimientoInventarioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoMovimientoInventarioParameterReturnGeneral () throws Exception {						
		super();
