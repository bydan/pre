...
public class EstadoNovedadSeguimientoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoNovedadSeguimientoParameterReturnGeneral () throws Exception {						
		super();
