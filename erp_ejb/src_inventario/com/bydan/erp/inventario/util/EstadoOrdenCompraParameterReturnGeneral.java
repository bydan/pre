...
public class EstadoOrdenCompraParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoOrdenCompraParameterReturnGeneral () throws Exception {						
		super();
