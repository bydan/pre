...
public class InventarioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public InventarioParameterReturnGeneral () throws Exception {						
		super();
