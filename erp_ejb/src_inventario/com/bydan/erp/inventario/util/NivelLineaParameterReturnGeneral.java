...
public class NivelLineaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public NivelLineaParameterReturnGeneral () throws Exception {						
		super();
