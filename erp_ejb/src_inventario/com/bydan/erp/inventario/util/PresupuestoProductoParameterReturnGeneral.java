...
public class PresupuestoProductoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PresupuestoProductoParameterReturnGeneral () throws Exception {						
		super();
