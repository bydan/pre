...
public class ProductoUnidadParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProductoUnidadParameterReturnGeneral () throws Exception {						
		super();
