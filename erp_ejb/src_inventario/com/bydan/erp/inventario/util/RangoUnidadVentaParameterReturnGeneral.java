...
public class RangoUnidadVentaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public RangoUnidadVentaParameterReturnGeneral () throws Exception {						
		super();
