...
public class TipoCosteoDefinicionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoCosteoDefinicionParameterReturnGeneral () throws Exception {						
		super();
