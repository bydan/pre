...
public class TipoDetalleMovimientoInventarioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoDetalleMovimientoInventarioParameterReturnGeneral () throws Exception {						
		super();
