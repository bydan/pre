...
public class TipoListaPrecioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoListaPrecioParameterReturnGeneral () throws Exception {						
		super();
