...
public class UbicacionProduParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public UbicacionProduParameterReturnGeneral () throws Exception {						
		super();
