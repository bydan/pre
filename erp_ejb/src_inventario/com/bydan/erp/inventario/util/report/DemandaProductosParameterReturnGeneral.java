...
public class DemandaProductosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public DemandaProductosParameterReturnGeneral () throws Exception {						
		super();
