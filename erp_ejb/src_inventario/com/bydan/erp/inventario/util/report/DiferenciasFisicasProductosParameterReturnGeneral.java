...
public class DiferenciasFisicasProductosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public DiferenciasFisicasProductosParameterReturnGeneral () throws Exception {						
		super();
