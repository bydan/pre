...
public class DisponiblesCostosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public DisponiblesCostosParameterReturnGeneral () throws Exception {						
		super();
