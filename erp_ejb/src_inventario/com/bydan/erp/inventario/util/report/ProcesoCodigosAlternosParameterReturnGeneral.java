...
public class ProcesoCodigosAlternosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProcesoCodigosAlternosParameterReturnGeneral () throws Exception {						
		super();
