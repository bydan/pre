...
public class ProcesoPreciosFactorParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProcesoPreciosFactorParameterReturnGeneral () throws Exception {						
		super();
