...
public class ProcesoPreciosPorcentajeParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProcesoPreciosPorcentajeParameterReturnGeneral () throws Exception {						
		super();
