...
public class ProductosServiciosDisponiblesParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProductosServiciosDisponiblesParameterReturnGeneral () throws Exception {						
		super();
