...
public class SolicitudReemplazo extends SolicitudReemplazoAdditional implements Serializable ,Cloneable {//SolicitudReemplazoAdditional,GeneralEntity
	...
	private SolicitudReemplazo solicitudreemplazoOriginal;
	
	private Map<String, Object> mapSolicitudReemplazo;
			
	public Map<String, Object> getMapSolicitudReemplazo() {
		return mapSolicitudReemplazo;
	}

	public void setMapSolicitudReemplazo(Map<String, Object> mapSolicitudReemplazo) {
		this.mapSolicitudReemplazo = mapSolicitudReemplazo;
	}
	
	public void inicializarMapSolicitudReemplazo() {
		this.mapSolicitudReemplazo = new HashMap<String,Object>();
	}
	
	public void setMapSolicitudReemplazoValue(String sKey,Object oValue) {
		this.mapSolicitudReemplazo.put(sKey, oValue);
	}
	
	public Object getMapSolicitudReemplazoValue(String sKey) {
		return this.mapSolicitudReemplazo.get(sKey);
	}
	...
	@Pattern(regex=SolicitudReemplazoConstantesFunciones.SREGEXSECUENCIAL,message=SolicitudReemplazoConstantesFunciones.SMENSAJEREGEXSECUENCIAL)
	...
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=SolicitudReemplazoConstantesFunciones.SREGEXDESCRIPCION,message=SolicitudReemplazoConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	public SolicitudReemplazo () throws Exception {
		super();		
		...
		this.solicitudreemplazoOriginal=this;
    ...
    //PARA REPORTES
	public SolicitudReemplazo (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_empleado_jefe,Long id_empleado,Long id_empleado_reemplazo,Long id_estructura,Long id_estado_solicitud_nomi,String secuencial,Date fecha_solicita,Date fecha_ejecuta,Integer numero_horas,Double costo_unitario,Double costo_total,String descripcion) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public SolicitudReemplazo (Long id_empresa,Long id_sucursal,Long id_empleado_jefe,Long id_empleado,Long id_empleado_reemplazo,Long id_estructura,Long id_estado_solicitud_nomi,String secuencial,Date fecha_solicita,Date fecha_ejecuta,Integer numero_horas,Double costo_unitario,Double costo_total,String descripcion) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			solicitudreemplazoLocal=(SolicitudReemplazo)object;
			
			if(solicitudreemplazoLocal!=null) {
				if(this.getId()!=null && solicitudreemplazoLocal.getId()!=null) {
					if(this.getId().equals(solicitudreemplazoLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!SolicitudReemplazoConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=SolicitudReemplazoConstantesFunciones.getSolicitudReemplazoDescripcion(this);
		} else {
			sDetalle=SolicitudReemplazoConstantesFunciones.getSolicitudReemplazoDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public SolicitudReemplazo getSolicitudReemplazoOriginal() {
		return this.solicitudreemplazoOriginal;
	}
	
	public void setSolicitudReemplazoOriginal(SolicitudReemplazo solicitudreemplazo) {
		try {
			this.solicitudreemplazoOriginal=solicitudreemplazo;
		} catch(Exception e) {
			;
		}
	}
	...
	protected SolicitudReemplazoAdditional solicitudreemplazoAdditional=null;
	
	public SolicitudReemplazoAdditional getSolicitudReemplazoAdditional() {
		return this.solicitudreemplazoAdditional;
	}
	
	public void setSolicitudReemplazoAdditional(SolicitudReemplazoAdditional solicitudreemplazoAdditional) {
		try {
			this.solicitudreemplazoAdditional=solicitudreemplazoAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_empleado_jefe!=newid_empleado_jefe) {
				if(newid_empleado_jefe==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_empleado_jefe");
					}
				}
		...
		try {
			if(this.id_empleado!=newid_empleado) {
				if(newid_empleado==null) {
					//newid_empleado=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_empleado");
					}
				}
		...
		try {
			if(this.id_empleado_reemplazo!=newid_empleado_reemplazo) {
				if(newid_empleado_reemplazo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_empleado_reemplazo");
					}
				}
		...
		try {
			if(this.id_estructura!=newid_estructura) {
				if(newid_estructura==null) {
					//newid_estructura=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_estructura");
					}
				}
		...
		try {
			if(this.id_estado_solicitud_nomi!=newid_estado_solicitud_nomi) {
				if(newid_estado_solicitud_nomi==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna id_estado_solicitud_nomi");
					}
				}
		...
		try {
			if(this.secuencial!=newsecuencial) {
				if(newsecuencial==null) {
					//newsecuencial="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna secuencial");
					}
				}

				if(newsecuencial!=null&&newsecuencial.length()>50) {
					newsecuencial=newsecuencial.substring(0,48);
					System.out.println("SolicitudReemplazo:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna secuencial");
				}
		...
		try {
			if(this.fecha_solicita!=newfecha_solicita) {
				if(newfecha_solicita==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna fecha_solicita");
					}
				}
		...
		try {
			if(this.fecha_ejecuta!=newfecha_ejecuta) {
				if(newfecha_ejecuta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna fecha_ejecuta");
					}
				}
		...
		try {
			if(this.numero_horas!=newnumero_horas) {
				if(newnumero_horas==null) {
					//newnumero_horas=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna numero_horas");
					}
				}
		...
		try {
			if(this.costo_unitario!=newcosto_unitario) {
				if(newcosto_unitario==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna costo_unitario");
					}
				}
		...
		try {
			if(this.costo_total!=newcosto_total) {
				if(newcosto_total==null) {
					//newcosto_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna costo_total");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("SolicitudReemplazo:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>250) {
					newdescripcion=newdescripcion.substring(0,248);
					System.out.println("SolicitudReemplazo:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=250 en columna descripcion");
				}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_sucursal_descripcion="";String id_empleado_jefe_descripcion="";String id_empleado_descripcion="";String id_empleado_reemplazo_descripcion="";String id_estructura_descripcion="";String id_estado_solicitud_nomi_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_sucursal_descripcion="";this.id_empleado_jefe_descripcion="";this.id_empleado_descripcion="";this.id_empleado_reemplazo_descripcion="";this.id_estructura_descripcion="";this.id_estado_solicitud_nomi_descripcion="";
	}
