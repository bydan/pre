...
public class CreditosDetallados extends CreditosDetalladosAdditional implements Serializable ,Cloneable {//CreditosDetalladosAdditional,GeneralEntity
	...
	private CreditosDetallados creditosdetalladosOriginal;
	
	private Map<String, Object> mapCreditosDetallados;
			
	public Map<String, Object> getMapCreditosDetallados() {
		return mapCreditosDetallados;
	}

	public void setMapCreditosDetallados(Map<String, Object> mapCreditosDetallados) {
		this.mapCreditosDetallados = mapCreditosDetallados;
	}
	
	public void inicializarMapCreditosDetallados() {
		this.mapCreditosDetallados = new HashMap<String,Object>();
	}
	
	public void setMapCreditosDetalladosValue(String sKey,Object oValue) {
		this.mapCreditosDetallados.put(sKey, oValue);
	}
	
	public Object getMapCreditosDetalladosValue(String sKey) {
		return this.mapCreditosDetallados.get(sKey);
	}
	...
	//@Pattern(regex=CreditosDetalladosConstantesFunciones.SREGEXCODIGO,message=CreditosDetalladosConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=200,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=CreditosDetalladosConstantesFunciones.SREGEXNOMBRE_COMPLETO,message=CreditosDetalladosConstantesFunciones.SMENSAJEREGEXNOMBRE_COMPLETO)
	private String nombre_completo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=CreditosDetalladosConstantesFunciones.SREGEXCODIGO_TIPO_PRESTAMO,message=CreditosDetalladosConstantesFunciones.SMENSAJEREGEXCODIGO_TIPO_PRESTAMO)
	private String codigo_tipo_prestamo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	//@Pattern(regex=CreditosDetalladosConstantesFunciones.SREGEXCODIGO_PRESTAMO,message=CreditosDetalladosConstantesFunciones.SMENSAJEREGEXCODIGO_PRESTAMO)
	...
	public CreditosDetallados () throws Exception {
		super();		
		...
		this.creditosdetalladosOriginal=this;
    ...
    //PARA REPORTES
	public CreditosDetallados (Long id,Date versionRow,String codigo,String nombre_completo,String codigo_tipo_prestamo,String codigo_prestamo,Date fecha,Double monto,Integer numero_cuotas,Integer numero,Double monto_capital,Double monto_interes,Double valor,Double saldo) throws Exception {
		super();		
	 ...
	 //PARA REPORTES
	public CreditosDetallados (String codigo,String nombre_completo,String codigo_tipo_prestamo,String codigo_prestamo,Date fecha,Double monto,Integer numero_cuotas,Integer numero,Double monto_capital,Double monto_interes,Double valor,Double saldo) throws Exception {
		super();		
	...
	public CreditosDetallados getCreditosDetalladosOriginal() {
		return this.creditosdetalladosOriginal;
	}
	
	public void setCreditosDetalladosOriginal(CreditosDetallados creditosdetallados) {
		try {
			this.creditosdetalladosOriginal=creditosdetallados;
		} catch(Exception e) {
			;
		}
	}
	...
	protected CreditosDetalladosAdditional creditosdetalladosAdditional=null;
	
	public CreditosDetalladosAdditional getCreditosDetalladosAdditional() {
		return this.creditosdetalladosAdditional;
	}
	
	public void setCreditosDetalladosAdditional(CreditosDetalladosAdditional creditosdetalladosAdditional) {
		try {
			this.creditosdetalladosAdditional=creditosdetalladosAdditional;
		} catch(Exception e) {
			;
		}
	}
		...
		try {
			if(this.codigo!=newcodigo) {
				if(newcodigo==null) {
					//newcodigo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna codigo");
					}
				}

				if(newcodigo!=null&&newcodigo.length()>50) {
					newcodigo=newcodigo.substring(0,48);
					System.out.println("CreditosDetallados:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo");
				}
		...
		try {
			if(this.nombre_completo!=newnombre_completo) {
				if(newnombre_completo==null) {
					//newnombre_completo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna nombre_completo");
					}
				}

				if(newnombre_completo!=null&&newnombre_completo.length()>200) {
					newnombre_completo=newnombre_completo.substring(0,198);
					System.out.println("CreditosDetallados:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=200 en columna nombre_completo");
				}
		...
		try {
			if(this.codigo_tipo_prestamo!=newcodigo_tipo_prestamo) {
				if(newcodigo_tipo_prestamo==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna codigo_tipo_prestamo");
					}
				}
				...
				if(newcodigo_tipo_prestamo!=null&&newcodigo_tipo_prestamo.length()>50) {
					...
					System.out.println("CreditosDetallados:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo_tipo_prestamo");
				}
		...
		try {
			if(this.codigo_prestamo!=newcodigo_prestamo) {
				if(newcodigo_prestamo==null) {
					//newcodigo_prestamo="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna codigo_prestamo");
					}
				}

				if(newcodigo_prestamo!=null&&newcodigo_prestamo.length()>50) {
					newcodigo_prestamo=newcodigo_prestamo.substring(0,48);
					System.out.println("CreditosDetallados:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna codigo_prestamo");
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna fecha");
					}
				}
		...
		try {
			if(this.monto!=newmonto) {
				if(newmonto==null) {
					//newmonto=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna monto");
					}
				}
		...
		try {
			if(this.numero_cuotas!=newnumero_cuotas) {
				if(newnumero_cuotas==null) {
					//newnumero_cuotas=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna numero_cuotas");
					}
				}
		...
		try {
			if(this.numero!=newnumero) {
				if(newnumero==null) {
					//newnumero=0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna numero");
					}
				}
		...
		try {
			if(this.monto_capital!=newmonto_capital) {
				if(newmonto_capital==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna monto_capital");
					}
				}
		...
		try {
			if(this.monto_interes!=newmonto_interes) {
				if(newmonto_interes==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna monto_interes");
					}
				}
		...
		try {
			if(this.valor!=newvalor) {
				if(newvalor==null) {
					//newvalor=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna valor");
					}
				}
		...
		try {
			if(this.saldo!=newsaldo) {
				if(newsaldo==null) {
					//newsaldo=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("CreditosDetallados:Valor nulo no permitido en columna saldo");
					}
				}
	...
	/*PARA REPORTES*/
	String id_cargo_descripcion="";String id_estructura_descripcion="";String id_empresa_descripcion="";String id_empleado_descripcion="";String id_tipo_prestamo_descripcion="";
	...
	public void inicializarVariablesParaReporte() {
		this.id_cargo_descripcion="";this.id_estructura_descripcion="";this.id_empresa_descripcion="";this.id_empleado_descripcion="";this.id_tipo_prestamo_descripcion="";
	}
