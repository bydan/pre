...
public class AsistenciaPorCentroCostoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public AsistenciaPorCentroCostoParameterReturnGeneral () throws Exception {						
		super();
