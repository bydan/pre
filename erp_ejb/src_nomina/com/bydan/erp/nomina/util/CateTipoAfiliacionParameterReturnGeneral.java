...
public class CateTipoAfiliacionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CateTipoAfiliacionParameterReturnGeneral () throws Exception {						
		super();
