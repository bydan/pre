...
public class EmpleadoDiscaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EmpleadoDiscaParameterReturnGeneral () throws Exception {						
		super();
	...
	public List<TipoDiscapacidad> gettipodiscapacidadsForeignKey() {
		return this.tipodiscapacidadsForeignKey;
	}
