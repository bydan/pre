...
public class EmpleadoEMailParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EmpleadoEMailParameterReturnGeneral () throws Exception {						
		super();
