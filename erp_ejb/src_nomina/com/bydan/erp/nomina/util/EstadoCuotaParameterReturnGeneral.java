...
public class EstadoCuotaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoCuotaParameterReturnGeneral () throws Exception {						
		super();
