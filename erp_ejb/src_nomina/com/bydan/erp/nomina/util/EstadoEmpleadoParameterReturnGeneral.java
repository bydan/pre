...
public class EstadoEmpleadoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoEmpleadoParameterReturnGeneral () throws Exception {						
		super();
