...
public class FactorNomiParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public FactorNomiParameterReturnGeneral () throws Exception {						
		super();
