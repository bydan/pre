...
public class FuncionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public FuncionParameterReturnGeneral () throws Exception {						
		super();
