...
public class NominaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public NominaParameterReturnGeneral () throws Exception {						
		super();
