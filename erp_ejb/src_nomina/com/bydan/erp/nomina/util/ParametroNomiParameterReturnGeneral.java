...
public class ParametroNomiParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ParametroNomiParameterReturnGeneral () throws Exception {						
		super();
