...
public class ParentezcoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ParentezcoParameterReturnGeneral () throws Exception {						
		super();
