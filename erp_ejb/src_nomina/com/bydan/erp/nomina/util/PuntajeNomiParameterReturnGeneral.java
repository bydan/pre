...
public class PuntajeNomiParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PuntajeNomiParameterReturnGeneral () throws Exception {						
		super();
