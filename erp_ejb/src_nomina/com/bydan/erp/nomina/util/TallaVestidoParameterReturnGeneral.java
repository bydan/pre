...
public class TallaVestidoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TallaVestidoParameterReturnGeneral () throws Exception {						
		super();
