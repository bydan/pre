...
public class TelefonoReferenciaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TelefonoReferenciaParameterReturnGeneral () throws Exception {						
		super();
	...
	public List<Referencia> getreferenciasForeignKey() {
		return this.referenciasForeignKey;
	}
