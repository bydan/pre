...
public class TipoAsistenciaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoAsistenciaParameterReturnGeneral () throws Exception {						
		super();
