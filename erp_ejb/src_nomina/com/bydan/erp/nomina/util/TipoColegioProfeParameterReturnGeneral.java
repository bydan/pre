...
public class TipoColegioProfeParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoColegioProfeParameterReturnGeneral () throws Exception {						
		super();
