...
public class TipoDiscapacidadParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoDiscapacidadParameterReturnGeneral () throws Exception {						
		super();
