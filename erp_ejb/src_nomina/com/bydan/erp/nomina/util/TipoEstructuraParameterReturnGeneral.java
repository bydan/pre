...
public class TipoEstructuraParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoEstructuraParameterReturnGeneral () throws Exception {						
		super();
