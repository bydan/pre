...
public class TipoInstruccionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoInstruccionParameterReturnGeneral () throws Exception {						
		super();
