...
public class TipoLibretaMiliParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoLibretaMiliParameterReturnGeneral () throws Exception {						
		super();
