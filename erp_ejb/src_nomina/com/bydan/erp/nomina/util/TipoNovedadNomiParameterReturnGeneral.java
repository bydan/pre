...
public class TipoNovedadNomiParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoNovedadNomiParameterReturnGeneral () throws Exception {						
		super();
