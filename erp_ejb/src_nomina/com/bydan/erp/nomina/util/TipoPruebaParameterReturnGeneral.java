...
public class TipoPruebaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoPruebaParameterReturnGeneral () throws Exception {						
		super();
