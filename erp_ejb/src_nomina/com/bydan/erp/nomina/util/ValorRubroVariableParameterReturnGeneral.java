...
public class ValorRubroVariableParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ValorRubroVariableParameterReturnGeneral () throws Exception {						
		super();
