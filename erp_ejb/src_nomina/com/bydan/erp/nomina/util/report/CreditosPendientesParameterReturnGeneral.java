...
public class CreditosPendientesParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CreditosPendientesParameterReturnGeneral () throws Exception {						
		super();
