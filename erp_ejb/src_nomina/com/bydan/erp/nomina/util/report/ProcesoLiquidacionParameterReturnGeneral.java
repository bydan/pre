...
public class ProcesoLiquidacionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProcesoLiquidacionParameterReturnGeneral () throws Exception {						
		super();
