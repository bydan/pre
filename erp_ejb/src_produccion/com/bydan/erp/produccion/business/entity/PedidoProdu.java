...
public class PedidoProdu extends PedidoProduAdditional implements Serializable ,Cloneable {//PedidoProduAdditional,GeneralEntity
	...
	private PedidoProdu pedidoproduOriginal;
	
	private Map<String, Object> mapPedidoProdu;
			
	public Map<String, Object> getMapPedidoProdu() {
		return mapPedidoProdu;
	}

	public void setMapPedidoProdu(Map<String, Object> mapPedidoProdu) {
		this.mapPedidoProdu = mapPedidoProdu;
	}
	
	public void inicializarMapPedidoProdu() {
		this.mapPedidoProdu = new HashMap<String,Object>();
	}
	
	public void setMapPedidoProduValue(String sKey,Object oValue) {
		this.mapPedidoProdu.put(sKey, oValue);
	}
	
	public Object getMapPedidoProduValue(String sKey) {
		return this.mapPedidoProdu.get(sKey);
	}
	...
	@Pattern(regex=PedidoProduConstantesFunciones.SREGEXSECUENCIAL,message=PedidoProduConstantesFunciones.SMENSAJEREGEXSECUENCIAL)
	...
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoProduConstantesFunciones.SREGEXDIRECCION_CLIENTE,message=PedidoProduConstantesFunciones.SMENSAJEREGEXDIRECCION_CLIENTE)
	private String direccion_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoProduConstantesFunciones.SREGEXTELEFONO_CLIENTE,message=PedidoProduConstantesFunciones.SMENSAJEREGEXTELEFONO_CLIENTE)
	private String telefono_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=20,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoProduConstantesFunciones.SREGEXRUC_CLIENTE,message=PedidoProduConstantesFunciones.SMENSAJEREGEXRUC_CLIENTE)
	private String ruc_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoProduConstantesFunciones.SREGEXLOTE,message=PedidoProduConstantesFunciones.SMENSAJEREGEXLOTE)
	private String lote;
	...
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=PedidoProduConstantesFunciones.SREGEXDESCRIPCION,message=PedidoProduConstantesFunciones.SMENSAJEREGEXDESCRIPCION)
	...
	public PedidoProdu () throws Exception {
		super();		
	...
	public PedidoProdu (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_formato,Long id_tipo_prioridad_empresa_produ,Long id_empleado_responsable,String secuencial,Long id_cliente,String direccion_cliente,String telefono_cliente,String ruc_cliente,String lote,Date fecha_pedido,Date fecha_entrega,Boolean es_uso_interno,Date fecha,String descripcion,Long id_estado_orden_produ) throws Exception {
	 ...
	 //PARA REPORTES
	public PedidoProdu (Long id_empresa,Long id_sucursal,Long id_ejercicio,Long id_periodo,Long id_formato,Long id_tipo_prioridad_empresa_produ,Long id_empleado_responsable,String secuencial,Long id_cliente,String direccion_cliente,String telefono_cliente,String ruc_cliente,String lote,Date fecha_pedido,Date fecha_entrega,Boolean es_uso_interno,Date fecha,String descripcion,Long id_estado_orden_produ) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			pedidoproduLocal=(PedidoProdu)object;
			
			if(pedidoproduLocal!=null) {
				if(this.getId()!=null && pedidoproduLocal.getId()!=null) {
					if(this.getId().equals(pedidoproduLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!PedidoProduConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=PedidoProduConstantesFunciones.getPedidoProduDescripcion(this);
		} else {
			sDetalle=PedidoProduConstantesFunciones.getPedidoProduDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public PedidoProdu getPedidoProduOriginal() {
		return this.pedidoproduOriginal;
	}
	
	public void setPedidoProduOriginal(PedidoProdu pedidoprodu) {
		try {
			this.pedidoproduOriginal=pedidoprodu;
		} catch(Exception e) {
			;
		}
	}
	...
	protected PedidoProduAdditional pedidoproduAdditional=null;
	
	public PedidoProduAdditional getPedidoProduAdditional() {
		return this.pedidoproduAdditional;
	}
	
	public void setPedidoProduAdditional(PedidoProduAdditional pedidoproduAdditional) {
		try {
			this.pedidoproduAdditional=pedidoproduAdditional;
		} catch(Exception e) {
			;
		}
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_ejercicio!=newid_ejercicio) {
				if(newid_ejercicio==null) {
					//newid_ejercicio=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_ejercicio");
					}
				}
		...
		try {
			if(this.id_periodo!=newid_periodo) {
				if(newid_periodo==null) {
					//newid_periodo=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_periodo");
					}
				}
		...
		try {
			if(this.id_tipo_prioridad_empresa_produ!=newid_tipo_prioridad_empresa_produ) {
				if(newid_tipo_prioridad_empresa_produ==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_tipo_prioridad_empresa_produ");
					}
				}
		...
		try {
			if(this.id_empleado_responsable!=newid_empleado_responsable) {
				if(newid_empleado_responsable==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_empleado_responsable");
					}
				}
		...
		try {
			if(this.secuencial!=newsecuencial) {
				if(newsecuencial==null) {
					//newsecuencial="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna secuencial");
					}
				}

				if(newsecuencial!=null&&newsecuencial.length()>50) {
					newsecuencial=newsecuencial.substring(0,48);
					System.out.println("PedidoProdu:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna secuencial");
				}
		...
		try {
			if(this.id_cliente!=newid_cliente) {
				if(newid_cliente==null) {
					//newid_cliente=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_cliente");
					}
				}
		...
		try {
			if(this.direccion_cliente!=newdireccion_cliente) {
				if(newdireccion_cliente==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna direccion_cliente");
					}
				}

				if(newdireccion_cliente!=null&&newdireccion_cliente.length()>150) {
					newdireccion_cliente=newdireccion_cliente.substring(0,148);
					System.out.println("PedidoProdu:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna direccion_cliente");
				}
		...
		try {
			if(this.telefono_cliente!=newtelefono_cliente) {
				if(newtelefono_cliente==null) {
					//newtelefono_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna telefono_cliente");
					}
				}

				if(newtelefono_cliente!=null&&newtelefono_cliente.length()>50) {
					newtelefono_cliente=newtelefono_cliente.substring(0,48);
					System.out.println("PedidoProdu:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna telefono_cliente");
				}
		...
		try {
			if(this.ruc_cliente!=newruc_cliente) {
				if(newruc_cliente==null) {
					//newruc_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna ruc_cliente");
					}
				}

				if(newruc_cliente!=null&&newruc_cliente.length()>20) {
					newruc_cliente=newruc_cliente.substring(0,18);
					System.out.println("PedidoProdu:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna ruc_cliente");
				}
		...
		try {
			if(this.lote!=newlote) {
				if(newlote==null) {
					//newlote="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna lote");
					}
				}

				if(newlote!=null&&newlote.length()>50) {
					newlote=newlote.substring(0,48);
					System.out.println("PedidoProdu:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna lote");
				}
		...
		try {
			if(this.fecha_pedido!=newfecha_pedido) {
				if(newfecha_pedido==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna fecha_pedido");
					}
				}
		...
		try {
			if(this.fecha_entrega!=newfecha_entrega) {
				if(newfecha_entrega==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna fecha_entrega");
					}
				}
		...
		try {
			if(this.es_uso_interno!=newes_uso_interno) {
				if(newes_uso_interno==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna es_uso_interno");
					}
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna fecha");
					}
				}
		...
		try {
			if(this.descripcion!=newdescripcion) {
				if(newdescripcion==null) {
					//newdescripcion="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna descripcion");
					}
				}

				if(newdescripcion!=null&&newdescripcion.length()>200) {
					newdescripcion=newdescripcion.substring(0,198);
					System.out.println("PedidoProdu:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=200 en columna descripcion");
				}
		...
		try {
			if(this.id_estado_orden_produ!=newid_estado_orden_produ) {
				if(newid_estado_orden_produ==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("PedidoProdu:Valor nulo no permitido en columna id_estado_orden_produ");
					}
				}
