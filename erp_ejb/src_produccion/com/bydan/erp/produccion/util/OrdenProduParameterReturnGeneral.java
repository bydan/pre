...
public class OrdenProduParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public OrdenProduParameterReturnGeneral () throws Exception {						
		super();
