...
public class ProduccionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProduccionParameterReturnGeneral () throws Exception {						
		super();
