...
public class ProductoDefiProduParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ProductoDefiProduParameterReturnGeneral () throws Exception {						
		super();
