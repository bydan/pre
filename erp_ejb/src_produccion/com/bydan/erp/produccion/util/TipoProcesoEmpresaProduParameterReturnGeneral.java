...
public class TipoProcesoEmpresaProduParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoProcesoEmpresaProduParameterReturnGeneral () throws Exception {						
		super();
