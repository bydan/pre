...
public class FacturaPuntoVenta extends FacturaPuntoVentaAdditional implements Serializable ,Cloneable {//FacturaPuntoVentaAdditional,GeneralEntity
	...
	private FacturaPuntoVenta facturapuntoventaOriginal;
	
	private Map<String, Object> mapFacturaPuntoVenta;
			
	public Map<String, Object> getMapFacturaPuntoVenta() {
		return mapFacturaPuntoVenta;
	}

	public void setMapFacturaPuntoVenta(Map<String, Object> mapFacturaPuntoVenta) {
		this.mapFacturaPuntoVenta = mapFacturaPuntoVenta;
	}
	
	public void inicializarMapFacturaPuntoVenta() {
		this.mapFacturaPuntoVenta = new HashMap<String,Object>();
	}
	
	public void setMapFacturaPuntoVentaValue(String sKey,Object oValue) {
		this.mapFacturaPuntoVenta.put(sKey, oValue);
	}
	
	public Object getMapFacturaPuntoVentaValue(String sKey) {
		return this.mapFacturaPuntoVenta.get(sKey);
	}
	...
	@Digits(integerDigits=19,fractionalDigits=0,message=ConstantesValidacion.SVALIDACIONBIGINT)
	@Min(value=0,message=ConstantesValidacion.SVALIDACIONNOVACIO)
	private Long id_estado_factura_punto_venta;
	...
	@Pattern(regex=FacturaPuntoVentaConstantesFunciones.SREGEXNUMERO_SECUENCIAL,message=FacturaPuntoVentaConstantesFunciones.SMENSAJEREGEXNUMERO_SECUENCIAL)
	private String numero_secuencial;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=20,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=FacturaPuntoVentaConstantesFunciones.SREGEXCODIGO_CLIENTE,message=FacturaPuntoVentaConstantesFunciones.SMENSAJEREGEXCODIGO_CLIENTE)
	private String codigo_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=100,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=FacturaPuntoVentaConstantesFunciones.SREGEXNOMBRE_CLIENTE,message=FacturaPuntoVentaConstantesFunciones.SMENSAJEREGEXNOMBRE_CLIENTE)
	private String nombre_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=50,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=FacturaPuntoVentaConstantesFunciones.SREGEXTARJETA_CLIENTE,message=FacturaPuntoVentaConstantesFunciones.SMENSAJEREGEXTARJETA_CLIENTE)
	private String tarjeta_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=FacturaPuntoVentaConstantesFunciones.SREGEXDIRECCION_CLIENTE,message=FacturaPuntoVentaConstantesFunciones.SMENSAJEREGEXDIRECCION_CLIENTE)
	private String direccion_cliente;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=100,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@Pattern(regex=FacturaPuntoVentaConstantesFunciones.SREGEXTELEFONO_CLIENTE,message=FacturaPuntoVentaConstantesFunciones.SMENSAJEREGEXTELEFONO_CLIENTE)
	...
	private String estadofacturapuntoventa_descripcion;
	...
	public FacturaPuntoVenta () throws Exception {
		super();		
		...
		this.facturapuntoventaOriginal=this;
 		...
 		this.id_estado_factura_punto_venta=-1L;
		...
		this.estadofacturapuntoventa_descripcion="";
		this.asientocontable_descripcion="";
		
		
		this.formapagopuntoventas=null;
		this.detallefacturapuntoventas=null;
    ...
    //PARA REPORTES
	public FacturaPuntoVenta (Long id,Date versionRow,Long id_empresa,Long id_sucursal,Long id_usuario,Long id_vendedor,Long id_cliente,Long id_caja,Long id_tipo_precio,Long id_mesa,Long id_formato,Long id_tipo_factura_punto_venta,Long id_estado_factura_punto_venta,Long id_asiento_contable,String numero_secuencial,String codigo_cliente,String nombre_cliente,String tarjeta_cliente,String direccion_cliente,String telefono_cliente,Date fecha,Time hora,Double total_iva,Double total_sin_iva,Double iva,Double descuento,Double financiamiento,Double flete,Double ice,Double otros,Double sub_total,Double total) throws Exception {
		super();		
		...
		this.facturapuntoventaOriginal=this;
 		...
 		this.id_estado_factura_punto_venta=id_estado_factura_punto_venta;
	 ...
	 //PARA REPORTES
	public FacturaPuntoVenta (Long id_empresa,Long id_sucursal,Long id_usuario,Long id_vendedor,Long id_cliente,Long id_caja,Long id_tipo_precio,Long id_mesa,Long id_formato,Long id_tipo_factura_punto_venta,Long id_estado_factura_punto_venta,Long id_asiento_contable,String numero_secuencial,String codigo_cliente,String nombre_cliente,String tarjeta_cliente,String direccion_cliente,String telefono_cliente,Date fecha,Time hora,Double total_iva,Double total_sin_iva,Double iva,Double descuento,Double financiamiento,Double flete,Double ice,Double otros,Double sub_total,Double total) throws Exception {
		super();		
	...
	public boolean equals(Object object) {
		...
		if(object!=null) {
			facturapuntoventaLocal=(FacturaPuntoVenta)object;
			
			if(facturapuntoventaLocal!=null) {
				if(this.getId()!=null && facturapuntoventaLocal.getId()!=null) {
					if(this.getId().equals(facturapuntoventaLocal.getId())) {
						equal=true;
					}
				}
			}
	...
	public String toString() {
		...
		if(!FacturaPuntoVentaConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=FacturaPuntoVentaConstantesFunciones.getFacturaPuntoVentaDescripcion(this);
		} else {
			sDetalle=FacturaPuntoVentaConstantesFunciones.getFacturaPuntoVentaDescripcionDetallado(this);
		}
		
		return sDetalle;
    }
	
	public FacturaPuntoVenta getFacturaPuntoVentaOriginal() {
		return this.facturapuntoventaOriginal;
	}
	
	public void setFacturaPuntoVentaOriginal(FacturaPuntoVenta facturapuntoventa) {
		try {
			this.facturapuntoventaOriginal=facturapuntoventa;
		} catch(Exception e) {
			;
		}
	}
	...
	protected FacturaPuntoVentaAdditional facturapuntoventaAdditional=null;
	
	public FacturaPuntoVentaAdditional getFacturaPuntoVentaAdditional() {
		return this.facturapuntoventaAdditional;
	}
	
	public void setFacturaPuntoVentaAdditional(FacturaPuntoVentaAdditional facturapuntoventaAdditional) {
		try {
			this.facturapuntoventaAdditional=facturapuntoventaAdditional;
		} catch(Exception e) {
			;
		}
	}
	...
	public Long getid_estado_factura_punto_venta() {
		return this.id_estado_factura_punto_venta;
	}
			...
			if(this.id_empresa!=newid_empresa) {
				if(newid_empresa==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_empresa");
					}
				}
		...
		try {
			if(this.id_sucursal!=newid_sucursal) {
				if(newid_sucursal==null) {
					//newid_sucursal=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_sucursal");
					}
				}
		...
		try {
			if(this.id_usuario!=newid_usuario) {
				if(newid_usuario==null) {
					//newid_usuario=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_usuario");
					}
				}
		...
		try {
			if(this.id_vendedor!=newid_vendedor) {
				if(newid_vendedor==null) {
					//newid_vendedor=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_vendedor");
					}
				}
		...
		try {
			if(this.id_cliente!=newid_cliente) {
				if(newid_cliente==null) {
					//newid_cliente=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_cliente");
					}
				}
		...
		try {
			if(this.id_caja!=newid_caja) {
				if(newid_caja==null) {
					//newid_caja=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_caja");
					}
				}
		...
		try {
			if(this.id_tipo_precio!=newid_tipo_precio) {
				if(newid_tipo_precio==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_tipo_precio");
					}
				}
		...
		try {
			if(this.id_mesa!=newid_mesa) {
				if(newid_mesa==null) {
					//newid_mesa=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_mesa");
					}
				}
		...
		try {
			if(this.id_formato!=newid_formato) {
				if(newid_formato==null) {
					//newid_formato=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_formato");
					}
				}
		...
		try {
			if(this.id_tipo_factura_punto_venta!=newid_tipo_factura_punto_venta) {
				if(newid_tipo_factura_punto_venta==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_tipo_factura_punto_venta");
					}
				}
	...
	public void setid_estado_factura_punto_venta(Long newid_estado_factura_punto_venta)throws Exception
	{
		try {
			if(this.id_estado_factura_punto_venta!=newid_estado_factura_punto_venta) {
				if(newid_estado_factura_punto_venta==null) {
					//newid_estado_factura_punto_venta=-1L;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna id_estado_factura_punto_venta");
					}
				}

				this.id_estado_factura_punto_venta=newid_estado_factura_punto_venta;
				this.setIsChanged(true);
			}
		} catch(Exception e) {
			throw e;
		...
		try {
			if(this.numero_secuencial!=newnumero_secuencial) {
				if(newnumero_secuencial==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna numero_secuencial");
					}
				}

				if(newnumero_secuencial!=null&&newnumero_secuencial.length()>50) {
					newnumero_secuencial=newnumero_secuencial.substring(0,48);
					System.out.println("FacturaPuntoVenta:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna numero_secuencial");
				}
		...
		try {
			if(this.codigo_cliente!=newcodigo_cliente) {
				if(newcodigo_cliente==null) {
					//newcodigo_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna codigo_cliente");
					}
				}

				if(newcodigo_cliente!=null&&newcodigo_cliente.length()>20) {
					newcodigo_cliente=newcodigo_cliente.substring(0,18);
					System.out.println("FacturaPuntoVenta:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=20 en columna codigo_cliente");
				}
		...
		try {
			if(this.nombre_cliente!=newnombre_cliente) {
				if(newnombre_cliente==null) {
					//newnombre_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna nombre_cliente");
					}
				}

				if(newnombre_cliente!=null&&newnombre_cliente.length()>100) {
					newnombre_cliente=newnombre_cliente.substring(0,98);
					System.out.println("FacturaPuntoVenta:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna nombre_cliente");
				}
		...
		try {
			if(this.tarjeta_cliente!=newtarjeta_cliente) {
				if(newtarjeta_cliente==null) {
					//newtarjeta_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna tarjeta_cliente");
					}
				}

				if(newtarjeta_cliente!=null&&newtarjeta_cliente.length()>50) {
					newtarjeta_cliente=newtarjeta_cliente.substring(0,48);
					System.out.println("FacturaPuntoVenta:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna tarjeta_cliente");
				}
		...
		try {
			if(this.direccion_cliente!=newdireccion_cliente) {
				if(newdireccion_cliente==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna direccion_cliente");
					}
				}

				if(newdireccion_cliente!=null&&newdireccion_cliente.length()>150) {
					newdireccion_cliente=newdireccion_cliente.substring(0,148);
					System.out.println("FacturaPuntoVenta:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=150 en columna direccion_cliente");
				}
		...
		try {
			if(this.telefono_cliente!=newtelefono_cliente) {
				if(newtelefono_cliente==null) {
					//newtelefono_cliente="";
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna telefono_cliente");
					}
				}

				if(newtelefono_cliente!=null&&newtelefono_cliente.length()>100) {
					newtelefono_cliente=newtelefono_cliente.substring(0,98);
					System.out.println("FacturaPuntoVenta:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=100 en columna telefono_cliente");
				}
		...
		try {
			if(this.fecha!=newfecha) {
				if(newfecha==null) {
					//newfecha=new Date();
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna fecha");
					}
				}
		...
		try {
			if(this.hora!=newhora) {
				if(newhora==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna hora");
					}
				}
		...
		try {
			if(this.total_iva!=newtotal_iva) {
				if(newtotal_iva==null) {
					//newtotal_iva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna total_iva");
					}
				}
		...
		try {
			if(this.total_sin_iva!=newtotal_sin_iva) {
				if(newtotal_sin_iva==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna total_sin_iva");
					}
				}
		...
		try {
			if(this.iva!=newiva) {
				if(newiva==null) {
					//newiva=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna iva");
					}
				}
		...
		try {
			if(this.descuento!=newdescuento) {
				if(newdescuento==null) {
					//newdescuento=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna descuento");
					}
				}
		...
		try {
			if(this.financiamiento!=newfinanciamiento) {
				if(newfinanciamiento==null) {
					...
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna financiamiento");
					}
				}
		...
		try {
			if(this.flete!=newflete) {
				if(newflete==null) {
					//newflete=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna flete");
					}
				}
		...
		try {
			if(this.ice!=newice) {
				if(newice==null) {
					//newice=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna ice");
					}
				}
		...
		try {
			if(this.otros!=newotros) {
				if(newotros==null) {
					//newotros=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna otros");
					}
				}
		...
		try {
			if(this.sub_total!=newsub_total) {
				if(newsub_total==null) {
					//newsub_total=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna sub_total");
					}
				}
		...
		try {
			if(this.total!=newtotal) {
				if(newtotal==null) {
					//newtotal=0.0;
					if(Constantes.ISDEVELOPING) {
						System.out.println("FacturaPuntoVenta:Valor nulo no permitido en columna total");
					}
				}
	...
	public String getestadofacturapuntoventa_descripcion() {
		return this.estadofacturapuntoventa_descripcion;
	}
	...
	public  void  setestadofacturapuntoventa_descripcion(String estadofacturapuntoventa_descripcion) {
		try {
			this.estadofacturapuntoventa_descripcion=estadofacturapuntoventa_descripcion;
		} catch(Exception e) {
			;
		}
	}
	...
	/*PARA REPORTES*/
	String id_empresa_descripcion="";String id_sucursal_descripcion="";String id_usuario_descripcion="";String id_vendedor_descripcion="";String id_cliente_descripcion="";String id_caja_descripcion="";String id_tipo_precio_descripcion="";String id_mesa_descripcion="";String id_formato_descripcion="";String id_tipo_factura_punto_venta_descripcion="";String id_estado_factura_punto_venta_descripcion="";String id_asiento_contable_descripcion="";
	...
	public String getid_estado_factura_punto_venta_descripcion() {
		return id_estado_factura_punto_venta_descripcion;
	}
	...
	public void setid_estado_factura_punto_venta_descripcion(String newid_estado_factura_punto_venta_descripcion)throws Exception {
		try {
			this.id_estado_factura_punto_venta_descripcion=newid_estado_factura_punto_venta_descripcion;
		} catch(Exception ex) {
			throw ex;
		}
	}
	...
	public void inicializarVariablesParaReporte() {
		this.id_empresa_descripcion="";this.id_sucursal_descripcion="";this.id_usuario_descripcion="";this.id_vendedor_descripcion="";this.id_cliente_descripcion="";this.id_caja_descripcion="";this.id_tipo_precio_descripcion="";this.id_mesa_descripcion="";this.id_formato_descripcion="";this.id_tipo_factura_punto_venta_descripcion="";this.id_estado_factura_punto_venta_descripcion="";this.id_asiento_contable_descripcion="";
	}
	
	
	Object historialformapagopuntoventasDescripcionReporte;
	Object formapagopuntoventasDescripcionReporte;
	Object detallefacturapuntoventasDescripcionReporte;
	
	
	public Object gethistorialformapagopuntoventasDescripcionReporte() {
		return historialformapagopuntoventasDescripcionReporte;
	}
	...
	public Object getdetallefacturapuntoventasDescripcionReporte() {
		return detallefacturapuntoventasDescripcionReporte;
	}

	
	
	public  void  sethistorialformapagopuntoventasDescripcionReporte(Object historialformapagopuntoventas) {
		try {
			this.historialformapagopuntoventasDescripcionReporte=historialformapagopuntoventas;
		} catch(Exception ex) {
			;
		}
	}
	...
	public  void  setdetallefacturapuntoventasDescripcionReporte(Object detallefacturapuntoventas) {
		try {
			this.detallefacturapuntoventasDescripcionReporte=detallefacturapuntoventas;
		} catch(Exception ex) {
			;
		}
	}
