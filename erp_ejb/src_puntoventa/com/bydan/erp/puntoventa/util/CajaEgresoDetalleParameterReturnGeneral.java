...
public class CajaEgresoDetalleParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CajaEgresoDetalleParameterReturnGeneral () throws Exception {						
		super();
