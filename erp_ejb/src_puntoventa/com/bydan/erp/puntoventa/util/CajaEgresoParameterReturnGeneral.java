...
public class CajaEgresoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public CajaEgresoParameterReturnGeneral () throws Exception {						
		super();
