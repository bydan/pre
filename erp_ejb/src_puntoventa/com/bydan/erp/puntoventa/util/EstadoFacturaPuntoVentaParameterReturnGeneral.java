...
public class EstadoFacturaPuntoVentaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoFacturaPuntoVentaParameterReturnGeneral () throws Exception {						
		super();
