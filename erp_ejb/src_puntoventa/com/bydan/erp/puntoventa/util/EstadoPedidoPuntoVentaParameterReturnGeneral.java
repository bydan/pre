...
public class EstadoPedidoPuntoVentaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoPedidoPuntoVentaParameterReturnGeneral () throws Exception {						
		super();
