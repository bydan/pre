...
public class PresupuestoVentasPunVenParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PresupuestoVentasPunVenParameterReturnGeneral () throws Exception {						
		super();
