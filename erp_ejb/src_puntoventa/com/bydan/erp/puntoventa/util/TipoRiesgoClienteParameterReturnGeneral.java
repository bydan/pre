...
public class TipoRiesgoClienteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoRiesgoClienteParameterReturnGeneral () throws Exception {						
		super();
