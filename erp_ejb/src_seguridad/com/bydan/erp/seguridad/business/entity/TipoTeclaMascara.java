...
public class TipoTeclaMascara extends GeneralEntitySinIdGenerated implements Serializable ,Cloneable {//TipoTeclaMascaraAdditional,GeneralEntity
	...
	private TipoTeclaMascara tipoteclamascaraOriginal;
	
	private Map<String, Object> mapTipoTeclaMascara;
			
	public Map<String, Object> getMapTipoTeclaMascara() {
		return mapTipoTeclaMascara;
	}

	public void setMapTipoTeclaMascara(Map<String, Object> mapTipoTeclaMascara) {
		this.mapTipoTeclaMascara = mapTipoTeclaMascara;
	}
	
	public void inicializarMapTipoTeclaMascara() {
		this.mapTipoTeclaMascara = new HashMap<String,Object>();
	}
	
	public void setMapTipoTeclaMascaraValue(String sKey,Object oValue) {
		this.mapTipoTeclaMascara.put(sKey, oValue);
	}
	
	public Object getMapTipoTeclaMascaraValue(String sKey) {
		return this.mapTipoTeclaMascara.get(sKey);
	}
	...
	@Pattern(regex=TipoTeclaMascaraConstantesFunciones.SREGEXCODIGO,message=TipoTeclaMascaraConstantesFunciones.SMENSAJEREGEXCODIGO)
	private String codigo;
	
	@NotNull(message=ConstantesValidacion.SVALIDACIONNOTNULL)
	@Length(min=0,max=150,message=ConstantesValidacion.SVALIDACIONLENGTH)
	@NotEmpty(message=ConstantesValidacion.SVALIDACIONNOVACIO)
	@Pattern(regex=TipoTeclaMascaraConstantesFunciones.SREGEXNOMBRE,message=TipoTeclaMascaraConstantesFunciones.SMENSAJEREGEXNOMBRE)
	...
	public String toString() {
		...
		if(!TipoTeclaMascaraConstantesFunciones.CON_DESCRIPCION_DETALLADO) {
        	sDetalle=TipoTeclaMascaraConstantesFunciones.getTipoTeclaMascaraDescripcion(this);
		} else {
			sDetalle=TipoTeclaMascaraConstantesFunciones.getTipoTeclaMascaraDescripcionDetallado(this);
		}
