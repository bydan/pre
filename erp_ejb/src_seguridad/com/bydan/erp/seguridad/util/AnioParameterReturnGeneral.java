...
public class AnioParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public AnioParameterReturnGeneral () throws Exception {						
		super();
