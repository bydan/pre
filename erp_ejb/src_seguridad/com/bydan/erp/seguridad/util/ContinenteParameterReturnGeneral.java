...
public class ContinenteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ContinenteParameterReturnGeneral () throws Exception {						
		super();
