...
public class DiaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public DiaParameterReturnGeneral () throws Exception {						
		super();
