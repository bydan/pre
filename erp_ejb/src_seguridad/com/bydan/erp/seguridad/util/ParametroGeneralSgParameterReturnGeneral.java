...
public class ParametroGeneralSgParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ParametroGeneralSgParameterReturnGeneral () throws Exception {						
		super();
