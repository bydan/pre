...
public class ParametroSeguridadParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ParametroSeguridadParameterReturnGeneral () throws Exception {						
		super();
