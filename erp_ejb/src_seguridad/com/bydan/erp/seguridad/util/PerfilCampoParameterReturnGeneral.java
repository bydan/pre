...
public class PerfilCampoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PerfilCampoParameterReturnGeneral () throws Exception {						
		super();
