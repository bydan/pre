...
public class TipoFuenteParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoFuenteParameterReturnGeneral () throws Exception {						
		super();
