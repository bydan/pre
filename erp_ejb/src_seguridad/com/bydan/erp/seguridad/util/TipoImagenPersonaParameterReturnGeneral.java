...
public class TipoImagenPersonaParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoImagenPersonaParameterReturnGeneral () throws Exception {						
		super();
