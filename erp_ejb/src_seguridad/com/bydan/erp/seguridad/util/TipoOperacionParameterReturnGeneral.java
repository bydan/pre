...
public class TipoOperacionParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoOperacionParameterReturnGeneral () throws Exception {						
		super();
