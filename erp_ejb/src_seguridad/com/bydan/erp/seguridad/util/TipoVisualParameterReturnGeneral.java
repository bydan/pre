...
public class TipoVisualParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoVisualParameterReturnGeneral () throws Exception {						
		super();
