...
public class TrimestreParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TrimestreParameterReturnGeneral () throws Exception {						
		super();
