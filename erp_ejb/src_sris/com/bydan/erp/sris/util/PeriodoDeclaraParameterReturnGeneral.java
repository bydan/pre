...
public class PeriodoDeclaraParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PeriodoDeclaraParameterReturnGeneral () throws Exception {						
		super();
