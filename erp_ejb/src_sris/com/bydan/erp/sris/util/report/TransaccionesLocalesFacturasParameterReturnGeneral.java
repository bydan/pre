...
public class TransaccionesLocalesFacturasParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TransaccionesLocalesFacturasParameterReturnGeneral () throws Exception {						
		super();
