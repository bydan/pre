...
import com.bydan.erp.tesoreria.business.logic.report.ComprobantesAnuladosLogicAdditional;
...
public class ComprobantesAnuladosLogic extends GeneralEntityLogic {	
	...
	*/
    ...
    {		
        try {     	  
			entity.settipo_movimiento(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.TIPOMOVIMIENTO));
			entity.setvalor(resultSet.getDouble(strPrefijo+ComprobantesAnuladosConstantesFunciones.VALOR));
			entity.setnumero_mayor(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.NUMEROMAYOR));
			entity.setbeneficiario(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.BENEFICIARIO));
			entity.setfecha(new Date(resultSet.getDate(strPrefijo+ComprobantesAnuladosConstantesFunciones.FECHA).getTime()));
			...
			entity.setfecha_finalizacion(new Date(resultSet.getDate(strPrefijo+ComprobantesAnuladosConstantesFunciones.FECHAFINALIZACION).getTime()));
			entity.setnombre_usuario(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.NOMBREUSUARIO));
			entity.setdetalle(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.DETALLE));
			entity.setnumero_cheque(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.NUMEROCHEQUE));
			entity.setnombre_empresa(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.NOMBREEMPRESA));
			entity.setruc_empresa(resultSet.getString(strPrefijo+ComprobantesAnuladosConstantesFunciones.RUCEMPRESA));
      	} catch(Exception e) {
			throw e;
      	}
	...
	public  static void setFieldReflectionComprobantesAnulados(Field field,String strPrefijo,String sColumn,ComprobantesAnulados entity,ResultSet resultSet) throws Exception {		
        try {    
        	...
        	switch(sColumn) {
				...
				case ComprobantesAnuladosConstantesFunciones.TIPOMOVIMIENTO:
					field.set(entity,resultSet.getString(sCampo));
					break;
				
				case ComprobantesAnuladosConstantesFunciones.VALOR:
					field.set(entity,resultSet.getDouble(sCampo));
					break;
				
				case ComprobantesAnuladosConstantesFunciones.NUMEROMAYOR:
					field.set(entity,resultSet.getString(sCampo));
					break;
				...
				case ComprobantesAnuladosConstantesFunciones.FECHA:
				...
				case ComprobantesAnuladosConstantesFunciones.FECHAFINALIZACION:
					field.set(entity,new Date(resultSet.getDate(sCampo).getTime()));
					break;
				
				case ComprobantesAnuladosConstantesFunciones.NOMBREUSUARIO:
					field.set(entity,resultSet.getString(sCampo));
					break;
				...
				case ComprobantesAnuladosConstantesFunciones.NUMEROCHEQUE:
					field.set(entity,resultSet.getString(sCampo));
					break;
				
				case ComprobantesAnuladosConstantesFunciones.NOMBREEMPRESA:
					field.set(entity,resultSet.getString(sCampo));
					break;
				
				case ComprobantesAnuladosConstantesFunciones.RUCEMPRESA:
					field.set(entity,resultSet.getString(sCampo));
					break;
	...
	public Modulo getModulo(Connexion connexion,ComprobantesAnulados relcomprobantesanulados)throws SQLException,Exception {
		...
		try {
			...
			modulo=moduloDataAccess.getEntity(connexion,relcomprobantesanulados.getid_modulo());
		} catch(SQLException e) {
			throw e;
		} catch(Exception e) {
			throw e;
	...
	public void getComprobantesAnuladossBusquedaComprobantesAnuladosWithConnection(String sFinalQuery,Pagination pagination,ParametroGeneralUsuario parametroGeneralUsuario,Modulo moduloActual,Opcion opcionActual,Usuario usuarioActual,Long id_ejercicio,Long id_modulo,Long id_tipo_movimiento,Date fecha_desde,Date fecha_hasta)throws Exception {
		try {
			...
			sQuerySelect=ComprobantesAnuladosLogic.GetSelecSqlComprobantesAnulados(this.connexion,this.connexionType,this.parameterDbType,sFinalQuery,pagination,parametroGeneralUsuario,moduloActual,opcionActual,usuarioActual,id_ejercicio,id_modulo,id_tipo_movimiento,fecha_desde,fecha_hasta);
...
if(!isDeep) {
	...
	if(deepLoadType.equals(DeepLoadType.NONE)) {
		...
		comprobantesanulados.setModulo(comprobantesanuladosDataAccess.getModulo(connexion,comprobantesanulados));
	...
	if(deepLoadType.equals(DeepLoadType.NONE)) {
		...
		moduloLogic.deepLoad(comprobantesanulados.getModulo(),isDeep,deepLoadType,clases);
