...
public class ChequePostFechadoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ChequePostFechadoParameterReturnGeneral () throws Exception {						
		super();
