...
public class EstadoCuentaBancoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public EstadoCuentaBancoParameterReturnGeneral () throws Exception {						
		super();
