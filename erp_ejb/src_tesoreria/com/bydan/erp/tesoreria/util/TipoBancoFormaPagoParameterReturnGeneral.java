...
public class TipoBancoFormaPagoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoBancoFormaPagoParameterReturnGeneral () throws Exception {						
		super();
