...
public class TipoCuentaBancoParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public TipoCuentaBancoParameterReturnGeneral () throws Exception {						
		super();
