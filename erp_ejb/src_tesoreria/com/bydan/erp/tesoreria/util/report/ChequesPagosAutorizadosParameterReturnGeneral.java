...
public class ChequesPagosAutorizadosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public ChequesPagosAutorizadosParameterReturnGeneral () throws Exception {						
		super();
