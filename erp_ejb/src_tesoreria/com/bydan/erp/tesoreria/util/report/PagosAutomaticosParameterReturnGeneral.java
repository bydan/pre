...
public class PagosAutomaticosParameterReturnGeneral extends GeneralEntityParameterReturnGeneral implements Serializable {
	...
	public PagosAutomaticosParameterReturnGeneral () throws Exception {						
		super();
